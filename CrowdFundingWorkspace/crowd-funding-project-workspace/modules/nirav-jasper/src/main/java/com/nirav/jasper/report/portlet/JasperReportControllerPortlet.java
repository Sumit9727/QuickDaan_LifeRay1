package com.nirav.jasper.report.portlet;
...
import com.nirav.jasper.report.api.NiravJasperReportApi;
import com.nirav.jasper.report.api.bean.ParameterDetail;
import com.nirav.jasper.report.api.constant.JasperConstants;
import com.nirav.jasper.report.portlet.config.action.ReportConfiguration;
 ...
 */
@Component(
		configurationPid="com.nirav.jasper.report.portlet.config.action.ReportConfiguration",
		immediate = true, 
		property = { 
			...
			"javax.portlet.name=com_nirav_jasper_report_portlet_JasperReportPortlet",
			"javax.portlet.init-param.config-template=/configuration.jsp" 
		},
		service = Portlet.class
	)

public class JasperReportControllerPortlet extends MVCPortlet {
	
	private volatile ReportConfiguration reportConfiguration;
	private static final Log _log = LogFactoryUtil.getLog(JasperReportControllerPortlet.class);
	private long definitionId;
	private NiravJasperReportApi jasperReportApi;
	
	@Reference
	public void setHrmsClientAPI(NiravJasperReportApi jasperReportApi) {
