...
import com.crowd.funding.database.model.PostionRegistrationModel;
import com.crowd.funding.database.model.PostionRegistrationSoap;
...
/**
 * The base model implementation for the PostionRegistration service. Represents a row in the &quot;cf_position_details&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link PostionRegistrationModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link PostionRegistrationImpl}.
 * </p>
 *
...
@JSON(strict = true)
@ProviderType
public class PostionRegistrationModelImpl extends BaseModelImpl<PostionRegistration>
	implements PostionRegistrationModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static final String ORDER_BY_JPQL = " ORDER BY postionRegistration.POSITION_ID ASC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.crowd.funding.database.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.crowd.funding.database.model.PostionRegistration"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.crowd.funding.database.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.crowd.funding.database.model.PostionRegistration"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.crowd.funding.database.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.crowd.funding.database.model.PostionRegistration"),
			true);
	 ...
	 */
	public static PostionRegistration toModel(PostionRegistrationSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		PostionRegistration model = new PostionRegistrationImpl();
	 ...
	 */
	public static List<PostionRegistration> toModels(
		PostionRegistrationSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<PostionRegistration> models = new ArrayList<PostionRegistration>(soapModels.length);

		for (PostionRegistrationSoap soapModel : soapModels) {
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.crowd.funding.database.service.util.ServiceProps.get(
				"lock.expiration.time.com.crowd.funding.database.model.PostionRegistration"));

	public PostionRegistrationModelImpl() {
	}
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(0,
			PostionRegistration.class.getName(), getPrimaryKey());
	}
	...
	public PostionRegistration toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (PostionRegistration)ProxyUtil.newProxyInstance(_classLoader,
	...
	public Object clone() {
		...
		postionRegistrationImpl.setUuid(getUuid());
		postionRegistrationImpl.setPOSITION_ID(getPOSITION_ID());
		postionRegistrationImpl.setADVERTISMENT_NUM(getADVERTISMENT_NUM());
		postionRegistrationImpl.setPOSITION_NAME(getPOSITION_NAME());
		postionRegistrationImpl.setDESCRIPTION(getDESCRIPTION());
		postionRegistrationImpl.setEXPERIENCE_LEVEL(getEXPERIENCE_LEVEL());
		postionRegistrationImpl.setSALARY(getSALARY());
		postionRegistrationImpl.setINDUSTRY_TYPE(getINDUSTRY_TYPE());
		postionRegistrationImpl.setFUNCTIONAL_AREA(getFUNCTIONAL_AREA());
		postionRegistrationImpl.setROLE_CATEGORY(getROLE_CATEGORY());
		postionRegistrationImpl.setEMPLOYMENT_TYPE(getEMPLOYMENT_TYPE());
		postionRegistrationImpl.setLOCATION(getLOCATION());
		postionRegistrationImpl.setDATE(getDATE());
		postionRegistrationImpl.setSTATUS(getSTATUS());
	...
	public int compareTo(PostionRegistration postionRegistration) {
		long primaryKey = postionRegistration.getPrimaryKey();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PostionRegistration)) {
			return false;
		}

		PostionRegistration postionRegistration = (PostionRegistration)obj;
	...
	public void resetOriginalValues() {
		PostionRegistrationModelImpl postionRegistrationModelImpl = this;

		postionRegistrationModelImpl._originalUuid = postionRegistrationModelImpl._uuid;

		postionRegistrationModelImpl._originalPOSITION_ID = postionRegistrationModelImpl._POSITION_ID;

		postionRegistrationModelImpl._setOriginalPOSITION_ID = false;

		postionRegistrationModelImpl._originalSTATUS = postionRegistrationModelImpl._STATUS;

		postionRegistrationModelImpl._setOriginalSTATUS = false;

		postionRegistrationModelImpl._columnBitmask = 0;
	}

	@Override
	public CacheModel<PostionRegistration> toCacheModel() {
		PostionRegistrationCacheModel postionRegistrationCacheModel = new PostionRegistrationCacheModel();

		postionRegistrationCacheModel.uuid = getUuid();

		String uuid = postionRegistrationCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			postionRegistrationCacheModel.uuid = null;
		}

		postionRegistrationCacheModel.POSITION_ID = getPOSITION_ID();

		postionRegistrationCacheModel.ADVERTISMENT_NUM = getADVERTISMENT_NUM();

		String ADVERTISMENT_NUM = postionRegistrationCacheModel.ADVERTISMENT_NUM;

		if ((ADVERTISMENT_NUM != null) && (ADVERTISMENT_NUM.length() == 0)) {
			postionRegistrationCacheModel.ADVERTISMENT_NUM = null;
		}

		postionRegistrationCacheModel.POSITION_NAME = getPOSITION_NAME();

		String POSITION_NAME = postionRegistrationCacheModel.POSITION_NAME;

		if ((POSITION_NAME != null) && (POSITION_NAME.length() == 0)) {
			postionRegistrationCacheModel.POSITION_NAME = null;
		}

		postionRegistrationCacheModel.DESCRIPTION = getDESCRIPTION();

		String DESCRIPTION = postionRegistrationCacheModel.DESCRIPTION;

		if ((DESCRIPTION != null) && (DESCRIPTION.length() == 0)) {
			postionRegistrationCacheModel.DESCRIPTION = null;
		}

		postionRegistrationCacheModel.EXPERIENCE_LEVEL = getEXPERIENCE_LEVEL();

		String EXPERIENCE_LEVEL = postionRegistrationCacheModel.EXPERIENCE_LEVEL;

		if ((EXPERIENCE_LEVEL != null) && (EXPERIENCE_LEVEL.length() == 0)) {
			postionRegistrationCacheModel.EXPERIENCE_LEVEL = null;
		}

		postionRegistrationCacheModel.SALARY = getSALARY();

		String SALARY = postionRegistrationCacheModel.SALARY;

		if ((SALARY != null) && (SALARY.length() == 0)) {
			postionRegistrationCacheModel.SALARY = null;
		}

		postionRegistrationCacheModel.INDUSTRY_TYPE = getINDUSTRY_TYPE();

		String INDUSTRY_TYPE = postionRegistrationCacheModel.INDUSTRY_TYPE;

		if ((INDUSTRY_TYPE != null) && (INDUSTRY_TYPE.length() == 0)) {
			postionRegistrationCacheModel.INDUSTRY_TYPE = null;
		}

		postionRegistrationCacheModel.FUNCTIONAL_AREA = getFUNCTIONAL_AREA();

		String FUNCTIONAL_AREA = postionRegistrationCacheModel.FUNCTIONAL_AREA;

		if ((FUNCTIONAL_AREA != null) && (FUNCTIONAL_AREA.length() == 0)) {
			postionRegistrationCacheModel.FUNCTIONAL_AREA = null;
		}

		postionRegistrationCacheModel.ROLE_CATEGORY = getROLE_CATEGORY();

		String ROLE_CATEGORY = postionRegistrationCacheModel.ROLE_CATEGORY;

		if ((ROLE_CATEGORY != null) && (ROLE_CATEGORY.length() == 0)) {
			postionRegistrationCacheModel.ROLE_CATEGORY = null;
		}

		postionRegistrationCacheModel.EMPLOYMENT_TYPE = getEMPLOYMENT_TYPE();

		String EMPLOYMENT_TYPE = postionRegistrationCacheModel.EMPLOYMENT_TYPE;

		if ((EMPLOYMENT_TYPE != null) && (EMPLOYMENT_TYPE.length() == 0)) {
			postionRegistrationCacheModel.EMPLOYMENT_TYPE = null;
		}

		postionRegistrationCacheModel.LOCATION = getLOCATION();

		String LOCATION = postionRegistrationCacheModel.LOCATION;

		if ((LOCATION != null) && (LOCATION.length() == 0)) {
			postionRegistrationCacheModel.LOCATION = null;
		}

		Date DATE = getDATE();

		if (DATE != null) {
			postionRegistrationCacheModel.DATE = DATE.getTime();
		}
		else {
			postionRegistrationCacheModel.DATE = Long.MIN_VALUE;
		}

		postionRegistrationCacheModel.STATUS = getSTATUS();

		return postionRegistrationCacheModel;
	}
	...
	public String toXmlString() {
		...
		sb.append("com.crowd.funding.database.model.PostionRegistration");
	...
	private static final ClassLoader _classLoader = PostionRegistration.class.getClassLoader();
	private static final Class<?>[] _escapedModelInterfaces = new Class[] {
			PostionRegistration.class, ModelWrapper.class
		};
	...
	private PostionRegistration _escapedModel;
}