...
import com.crowd.funding.database.service.FeedbackRegistrationLocalService;
...
/**
 * Provides the base implementation for the feedback registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.FeedbackRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class FeedbackRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FeedbackRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.FeedbackRegistrationLocalServiceUtil} to access the feedback registration local service.
	 */
	...
	public FeedbackRegistration addFeedbackRegistration(
		...
		return feedbackRegistrationPersistence.update(feedbackRegistration);
	}
	...
	public FeedbackRegistration createFeedbackRegistration(
		...
		return feedbackRegistrationPersistence.create(PROJECT_FEEDBACK_ID);
	}
	...
	public FeedbackRegistration deleteFeedbackRegistration(
		...
		return feedbackRegistrationPersistence.remove(PROJECT_FEEDBACK_ID);
	}
	...
	public FeedbackRegistration deleteFeedbackRegistration(
		FeedbackRegistration feedbackRegistration) {
		return feedbackRegistrationPersistence.remove(feedbackRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FeedbackRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return feedbackRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return feedbackRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public FeedbackRegistration fetchFeedbackRegistration(
		long PROJECT_FEEDBACK_ID) {
		return feedbackRegistrationPersistence.fetchByPrimaryKey(PROJECT_FEEDBACK_ID);
	}
	...
	public FeedbackRegistration getFeedbackRegistration(
		long PROJECT_FEEDBACK_ID) throws PortalException {
		return feedbackRegistrationPersistence.findByPrimaryKey(PROJECT_FEEDBACK_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(feedbackRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FeedbackRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PROJECT_FEEDBACK_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(feedbackRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FeedbackRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return feedbackRegistrationLocalService.deleteFeedbackRegistration((FeedbackRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return feedbackRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<FeedbackRegistration> getFeedbackRegistrations(int start,
		int end) {
		return feedbackRegistrationPersistence.findAll(start, end);
	}
	...
	public int getFeedbackRegistrationsCount() {
		return feedbackRegistrationPersistence.countAll();
	}
	 ...
	 */
	public FeedbackRegistrationLocalService getFeedbackRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.FeedbackRegistration",
			feedbackRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.FeedbackRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FeedbackRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = feedbackRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = FeedbackRegistrationLocalService.class)
	protected FeedbackRegistrationLocalService feedbackRegistrationLocalService;
