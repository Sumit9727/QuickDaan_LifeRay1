...
import com.crowd.funding.database.service.ProjectRegistrationLocalService;
...
/**
 * Provides the base implementation for the project registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.ProjectRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class ProjectRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProjectRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.ProjectRegistrationLocalServiceUtil} to access the project registration local service.
	 */
	...
	public ProjectRegistration addProjectRegistration(
		...
		return projectRegistrationPersistence.update(projectRegistration);
	}
	...
	public ProjectRegistration createProjectRegistration(long PROJECT_ID) {
		return projectRegistrationPersistence.create(PROJECT_ID);
	}
	...
	public ProjectRegistration deleteProjectRegistration(long PROJECT_ID)
		...
		return projectRegistrationPersistence.remove(PROJECT_ID);
	}
	...
	public ProjectRegistration deleteProjectRegistration(
		ProjectRegistration projectRegistration) {
		return projectRegistrationPersistence.remove(projectRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProjectRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return projectRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return projectRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ProjectRegistration fetchProjectRegistration(long PROJECT_ID) {
		return projectRegistrationPersistence.fetchByPrimaryKey(PROJECT_ID);
	}
	...
	public ProjectRegistration getProjectRegistration(long PROJECT_ID)
		throws PortalException {
		return projectRegistrationPersistence.findByPrimaryKey(PROJECT_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(projectRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProjectRegistration.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(projectRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProjectRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return projectRegistrationLocalService.deleteProjectRegistration((ProjectRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return projectRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProjectRegistration> getProjectRegistrations(int start, int end) {
		return projectRegistrationPersistence.findAll(start, end);
	}
	...
	public int getProjectRegistrationsCount() {
		return projectRegistrationPersistence.countAll();
	}
	...
	public ProjectRegistrationVIDEOBlobModel getVIDEOBlobModel(
		...
		try {
			session = projectRegistrationPersistence.openSession();

			return (ProjectRegistrationVIDEOBlobModel)session.get(ProjectRegistrationVIDEOBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw projectRegistrationPersistence.processException(e);
		}
		finally {
			projectRegistrationPersistence.closeSession(session);
		}
	}
	 ...
	 */
	public ProjectRegistrationLocalService getProjectRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.ProjectRegistration",
			projectRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.ProjectRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProjectRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = projectRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = ProjectRegistrationLocalService.class)
	protected ProjectRegistrationLocalService projectRegistrationLocalService;
