...
import com.crowd.funding.database.service.ProjectUpdateRegistrationLocalService;
...
/**
 * Provides the base implementation for the project update registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.ProjectUpdateRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class ProjectUpdateRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ProjectUpdateRegistrationLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.ProjectUpdateRegistrationLocalServiceUtil} to access the project update registration local service.
	 */
	...
	public ProjectUpdateRegistration addProjectUpdateRegistration(
		...
		return projectUpdateRegistrationPersistence.update(projectUpdateRegistration);
	}
	...
	public ProjectUpdateRegistration createProjectUpdateRegistration(
		...
		return projectUpdateRegistrationPersistence.create(PROJECT_UPDATE_ID);
	}
	...
	public ProjectUpdateRegistration deleteProjectUpdateRegistration(
		...
		return projectUpdateRegistrationPersistence.remove(PROJECT_UPDATE_ID);
	}
	...
	public ProjectUpdateRegistration deleteProjectUpdateRegistration(
		ProjectUpdateRegistration projectUpdateRegistration) {
		return projectUpdateRegistrationPersistence.remove(projectUpdateRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProjectUpdateRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return projectUpdateRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return projectUpdateRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ProjectUpdateRegistration fetchProjectUpdateRegistration(
		long PROJECT_UPDATE_ID) {
		return projectUpdateRegistrationPersistence.fetchByPrimaryKey(PROJECT_UPDATE_ID);
	}
	...
	public ProjectUpdateRegistration getProjectUpdateRegistration(
		long PROJECT_UPDATE_ID) throws PortalException {
		return projectUpdateRegistrationPersistence.findByPrimaryKey(PROJECT_UPDATE_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(projectUpdateRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProjectUpdateRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PROJECT_UPDATE_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(projectUpdateRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProjectUpdateRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return projectUpdateRegistrationLocalService.deleteProjectUpdateRegistration((ProjectUpdateRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return projectUpdateRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProjectUpdateRegistration> getProjectUpdateRegistrations(
		int start, int end) {
		return projectUpdateRegistrationPersistence.findAll(start, end);
	}
	...
	public int getProjectUpdateRegistrationsCount() {
		return projectUpdateRegistrationPersistence.countAll();
	}
	 ...
	 */
	public ProjectUpdateRegistrationLocalService getProjectUpdateRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.ProjectUpdateRegistration",
			projectUpdateRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.ProjectUpdateRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProjectUpdateRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = projectUpdateRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = ProjectUpdateRegistrationLocalService.class)
	protected ProjectUpdateRegistrationLocalService projectUpdateRegistrationLocalService;
