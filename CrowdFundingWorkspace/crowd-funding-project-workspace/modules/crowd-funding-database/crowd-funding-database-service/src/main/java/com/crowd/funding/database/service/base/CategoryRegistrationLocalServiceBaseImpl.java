...
import com.crowd.funding.database.service.CategoryRegistrationLocalService;
...
/**
 * Provides the base implementation for the category registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.CategoryRegistrationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.crowd.funding.database.service.impl.CategoryRegistrationLocalServiceImpl
 * @see com.crowd.funding.database.service.CategoryRegistrationLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CategoryRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CategoryRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.CategoryRegistrationLocalServiceUtil} to access the category registration local service.
	 */
	...
	@Override
	public CategoryRegistration addCategoryRegistration(
		CategoryRegistration categoryRegistration) {
		categoryRegistration.setNew(true);

		return categoryRegistrationPersistence.update(categoryRegistration);
	}
	...
	public CategoryRegistration createCategoryRegistration(long CATEGORY_ID) {
		return categoryRegistrationPersistence.create(CATEGORY_ID);
	}
	...
	@Override
	public CategoryRegistration deleteCategoryRegistration(long CATEGORY_ID)
		throws PortalException {
		return categoryRegistrationPersistence.remove(CATEGORY_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CategoryRegistration deleteCategoryRegistration(
		CategoryRegistration categoryRegistration) {
		return categoryRegistrationPersistence.remove(categoryRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CategoryRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return categoryRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return categoryRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CategoryRegistration fetchCategoryRegistration(long CATEGORY_ID) {
		return categoryRegistrationPersistence.fetchByPrimaryKey(CATEGORY_ID);
	}
	 ...
	 */
	@Override
	public CategoryRegistration getCategoryRegistration(long CATEGORY_ID)
		throws PortalException {
		return categoryRegistrationPersistence.findByPrimaryKey(CATEGORY_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(categoryRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CategoryRegistration.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(categoryRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CategoryRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return categoryRegistrationLocalService.deleteCategoryRegistration((CategoryRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return categoryRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CategoryRegistration> getCategoryRegistrations(int start,
		int end) {
		return categoryRegistrationPersistence.findAll(start, end);
	}
	...
	public int getCategoryRegistrationsCount() {
		return categoryRegistrationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CategoryRegistration updateCategoryRegistration(
		CategoryRegistration categoryRegistration) {
		return categoryRegistrationPersistence.update(categoryRegistration);
	}
	 ...
	 */
	public CategoryRegistrationLocalService getCategoryRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.CategoryRegistration",
			categoryRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.CategoryRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CategoryRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = categoryRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = CategoryRegistrationLocalService.class)
	protected CategoryRegistrationLocalService categoryRegistrationLocalService;
