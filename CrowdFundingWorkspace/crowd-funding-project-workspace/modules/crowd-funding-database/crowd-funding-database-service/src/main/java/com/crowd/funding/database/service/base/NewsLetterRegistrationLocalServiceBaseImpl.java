...
import com.crowd.funding.database.service.NewsLetterRegistrationLocalService;
...
/**
 * Provides the base implementation for the news letter registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.NewsLetterRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class NewsLetterRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NewsLetterRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.NewsLetterRegistrationLocalServiceUtil} to access the news letter registration local service.
	 */
	...
	@Override
	public NewsLetterRegistration addNewsLetterRegistration(
		NewsLetterRegistration newsLetterRegistration) {
		newsLetterRegistration.setNew(true);

		return newsLetterRegistrationPersistence.update(newsLetterRegistration);
	}
	...
	public NewsLetterRegistration createNewsLetterRegistration(
		long NEWS_LETTER_ID) {
		return newsLetterRegistrationPersistence.create(NEWS_LETTER_ID);
	}
	...
	@Override
	public NewsLetterRegistration deleteNewsLetterRegistration(
		long NEWS_LETTER_ID) throws PortalException {
		return newsLetterRegistrationPersistence.remove(NEWS_LETTER_ID);
	}
	...
	public NewsLetterRegistration deleteNewsLetterRegistration(
		NewsLetterRegistration newsLetterRegistration) {
		return newsLetterRegistrationPersistence.remove(newsLetterRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NewsLetterRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return newsLetterRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return newsLetterRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NewsLetterRegistration fetchNewsLetterRegistration(
		long NEWS_LETTER_ID) {
		return newsLetterRegistrationPersistence.fetchByPrimaryKey(NEWS_LETTER_ID);
	}
	 ...
	 */
	@Override
	public NewsLetterRegistration getNewsLetterRegistration(long NEWS_LETTER_ID)
		throws PortalException {
		return newsLetterRegistrationPersistence.findByPrimaryKey(NEWS_LETTER_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(newsLetterRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NewsLetterRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("NEWS_LETTER_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(newsLetterRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(NewsLetterRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return newsLetterRegistrationLocalService.deleteNewsLetterRegistration((NewsLetterRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return newsLetterRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NewsLetterRegistration> getNewsLetterRegistrations(int start,
		int end) {
		return newsLetterRegistrationPersistence.findAll(start, end);
	}
	...
	public int getNewsLetterRegistrationsCount() {
		return newsLetterRegistrationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NewsLetterRegistration updateNewsLetterRegistration(
		NewsLetterRegistration newsLetterRegistration) {
		return newsLetterRegistrationPersistence.update(newsLetterRegistration);
	}

	@Override
	public NewsLetterRegistrationDOCUMENTBlobModel getDOCUMENTBlobModel(
		Serializable primaryKey) {
		Session session = null;

		try {
			session = newsLetterRegistrationPersistence.openSession();

			return (NewsLetterRegistrationDOCUMENTBlobModel)session.get(NewsLetterRegistrationDOCUMENTBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw newsLetterRegistrationPersistence.processException(e);
		}
		finally {
			newsLetterRegistrationPersistence.closeSession(session);
		}
	}
	 ...
	 */
	public NewsLetterRegistrationLocalService getNewsLetterRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.NewsLetterRegistration",
			newsLetterRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.NewsLetterRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return NewsLetterRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = newsLetterRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = NewsLetterRegistrationLocalService.class)
	protected NewsLetterRegistrationLocalService newsLetterRegistrationLocalService;
