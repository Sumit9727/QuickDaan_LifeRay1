...
import com.crowd.funding.database.service.UserFollowRegistrationLocalService;
...
/**
 * Provides the base implementation for the user follow registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.UserFollowRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class UserFollowRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserFollowRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.UserFollowRegistrationLocalServiceUtil} to access the user follow registration local service.
	 */
	...
	@Override
	public UserFollowRegistration addUserFollowRegistration(
		UserFollowRegistration userFollowRegistration) {
		userFollowRegistration.setNew(true);

		return userFollowRegistrationPersistence.update(userFollowRegistration);
	}
	...
	public UserFollowRegistration createUserFollowRegistration(
		long USER_FOLLOW_ID) {
		return userFollowRegistrationPersistence.create(USER_FOLLOW_ID);
	}
	...
	@Override
	public UserFollowRegistration deleteUserFollowRegistration(
		long USER_FOLLOW_ID) throws PortalException {
		return userFollowRegistrationPersistence.remove(USER_FOLLOW_ID);
	}
	...
	public UserFollowRegistration deleteUserFollowRegistration(
		UserFollowRegistration userFollowRegistration) {
		return userFollowRegistrationPersistence.remove(userFollowRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserFollowRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return userFollowRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return userFollowRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UserFollowRegistration fetchUserFollowRegistration(
		long USER_FOLLOW_ID) {
		return userFollowRegistrationPersistence.fetchByPrimaryKey(USER_FOLLOW_ID);
	}
	 ...
	 */
	@Override
	public UserFollowRegistration getUserFollowRegistration(long USER_FOLLOW_ID)
		throws PortalException {
		return userFollowRegistrationPersistence.findByPrimaryKey(USER_FOLLOW_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(userFollowRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(UserFollowRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("USER_FOLLOW_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(userFollowRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(UserFollowRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return userFollowRegistrationLocalService.deleteUserFollowRegistration((UserFollowRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return userFollowRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UserFollowRegistration> getUserFollowRegistrations(int start,
		int end) {
		return userFollowRegistrationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUserFollowRegistrationsCount() {
		return userFollowRegistrationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UserFollowRegistration updateUserFollowRegistration(
		UserFollowRegistration userFollowRegistration) {
		return userFollowRegistrationPersistence.update(userFollowRegistration);
	}
	 ...
	 */
	public UserFollowRegistrationLocalService getUserFollowRegistrationLocalService() {
	...
	public void setUserFollowRegistrationLocalService(
		UserFollowRegistrationLocalService userFollowRegistrationLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.UserFollowRegistration",
			userFollowRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.UserFollowRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return UserFollowRegistrationLocalService.class.getName();
	}
	...
	@BeanReference(type = UserFollowRegistrationLocalService.class)
	protected UserFollowRegistrationLocalService userFollowRegistrationLocalService;
