...
import com.crowd.funding.database.service.FundReleaseRegistrationLocalService;
...
/**
 * Provides the base implementation for the fund release registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.FundReleaseRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class FundReleaseRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FundReleaseRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.FundReleaseRegistrationLocalServiceUtil} to access the fund release registration local service.
	 */
	...
	public FundReleaseRegistration addFundReleaseRegistration(
		...
		return fundReleaseRegistrationPersistence.update(fundReleaseRegistration);
	}
	...
	public FundReleaseRegistration createFundReleaseRegistration(
		...
		return fundReleaseRegistrationPersistence.create(FUND_RELEASE_ID);
	}
	...
	public FundReleaseRegistration deleteFundReleaseRegistration(
		...
		return fundReleaseRegistrationPersistence.remove(FUND_RELEASE_ID);
	}
	...
	public FundReleaseRegistration deleteFundReleaseRegistration(
		FundReleaseRegistration fundReleaseRegistration) {
		return fundReleaseRegistrationPersistence.remove(fundReleaseRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FundReleaseRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fundReleaseRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fundReleaseRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public FundReleaseRegistration fetchFundReleaseRegistration(
		long FUND_RELEASE_ID) {
		return fundReleaseRegistrationPersistence.fetchByPrimaryKey(FUND_RELEASE_ID);
	}
	...
	public FundReleaseRegistration getFundReleaseRegistration(
		long FUND_RELEASE_ID) throws PortalException {
		return fundReleaseRegistrationPersistence.findByPrimaryKey(FUND_RELEASE_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(fundReleaseRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FundReleaseRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("FUND_RELEASE_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(fundReleaseRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FundReleaseRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return fundReleaseRegistrationLocalService.deleteFundReleaseRegistration((FundReleaseRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return fundReleaseRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<FundReleaseRegistration> getFundReleaseRegistrations(
		int start, int end) {
		return fundReleaseRegistrationPersistence.findAll(start, end);
	}
	...
	public int getFundReleaseRegistrationsCount() {
		return fundReleaseRegistrationPersistence.countAll();
	}
	 ...
	 */
	public FundReleaseRegistrationLocalService getFundReleaseRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.FundReleaseRegistration",
			fundReleaseRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.FundReleaseRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FundReleaseRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = fundReleaseRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = FundReleaseRegistrationLocalService.class)
	protected FundReleaseRegistrationLocalService fundReleaseRegistrationLocalService;
