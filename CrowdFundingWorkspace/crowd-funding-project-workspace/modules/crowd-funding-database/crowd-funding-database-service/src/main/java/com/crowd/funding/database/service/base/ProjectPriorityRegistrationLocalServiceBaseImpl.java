...
/**
 * Provides the base implementation for the project priority registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.ProjectPriorityRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class ProjectPriorityRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ProjectPriorityRegistrationLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.ProjectPriorityRegistrationLocalServiceUtil} to access the project priority registration local service.
	 */
	...
	@Override
	public ProjectPriorityRegistration addProjectPriorityRegistration(
		ProjectPriorityRegistration projectPriorityRegistration) {
		projectPriorityRegistration.setNew(true);

		return projectPriorityRegistrationPersistence.update(projectPriorityRegistration);
	}
	...
	public ProjectPriorityRegistration createProjectPriorityRegistration(
		long PROJECT_PRIORITY_ID) {
		return projectPriorityRegistrationPersistence.create(PROJECT_PRIORITY_ID);
	}
	...
	@Override
	public ProjectPriorityRegistration deleteProjectPriorityRegistration(
		long PROJECT_PRIORITY_ID) throws PortalException {
		return projectPriorityRegistrationPersistence.remove(PROJECT_PRIORITY_ID);
	}
	...
	public ProjectPriorityRegistration deleteProjectPriorityRegistration(
		ProjectPriorityRegistration projectPriorityRegistration) {
		return projectPriorityRegistrationPersistence.remove(projectPriorityRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProjectPriorityRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return projectPriorityRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return projectPriorityRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ProjectPriorityRegistration fetchProjectPriorityRegistration(
		long PROJECT_PRIORITY_ID) {
		return projectPriorityRegistrationPersistence.fetchByPrimaryKey(PROJECT_PRIORITY_ID);
	}
	 ...
	 */
	@Override
	public ProjectPriorityRegistration getProjectPriorityRegistration(
		long PROJECT_PRIORITY_ID) throws PortalException {
		return projectPriorityRegistrationPersistence.findByPrimaryKey(PROJECT_PRIORITY_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(projectPriorityRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProjectPriorityRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PROJECT_PRIORITY_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(projectPriorityRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProjectPriorityRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return projectPriorityRegistrationLocalService.deleteProjectPriorityRegistration((ProjectPriorityRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return projectPriorityRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProjectPriorityRegistration> getProjectPriorityRegistrations(
		int start, int end) {
		return projectPriorityRegistrationPersistence.findAll(start, end);
	}
	...
	public int getProjectPriorityRegistrationsCount() {
		return projectPriorityRegistrationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ProjectPriorityRegistration updateProjectPriorityRegistration(
		ProjectPriorityRegistration projectPriorityRegistration) {
		return projectPriorityRegistrationPersistence.update(projectPriorityRegistration);
	}
	 ...
	 */
	public ProjectPriorityRegistrationLocalService getProjectPriorityRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.ProjectPriorityRegistration",
			projectPriorityRegistrationLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProjectPriorityRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = projectPriorityRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = ProjectPriorityRegistrationLocalService.class)
	protected ProjectPriorityRegistrationLocalService projectPriorityRegistrationLocalService;
