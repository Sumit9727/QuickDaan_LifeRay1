...
import com.crowd.funding.database.service.SubscriptionRegistrationLocalService;
...
/**
 * Provides the base implementation for the subscription registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.SubscriptionRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class SubscriptionRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SubscriptionRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.SubscriptionRegistrationLocalServiceUtil} to access the subscription registration local service.
	 */
	...
	@Override
	public SubscriptionRegistration addSubscriptionRegistration(
		SubscriptionRegistration subscriptionRegistration) {
		subscriptionRegistration.setNew(true);

		return subscriptionRegistrationPersistence.update(subscriptionRegistration);
	}
	...
	public SubscriptionRegistration createSubscriptionRegistration(
		long SUSCRIBER_ID) {
		return subscriptionRegistrationPersistence.create(SUSCRIBER_ID);
	}
	...
	@Override
	public SubscriptionRegistration deleteSubscriptionRegistration(
		long SUSCRIBER_ID) throws PortalException {
		return subscriptionRegistrationPersistence.remove(SUSCRIBER_ID);
	}
	...
	public SubscriptionRegistration deleteSubscriptionRegistration(
		SubscriptionRegistration subscriptionRegistration) {
		return subscriptionRegistrationPersistence.remove(subscriptionRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SubscriptionRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return subscriptionRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return subscriptionRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SubscriptionRegistration fetchSubscriptionRegistration(
		long SUSCRIBER_ID) {
		return subscriptionRegistrationPersistence.fetchByPrimaryKey(SUSCRIBER_ID);
	}
	 ...
	 */
	@Override
	public SubscriptionRegistration getSubscriptionRegistration(
		long SUSCRIBER_ID) throws PortalException {
		return subscriptionRegistrationPersistence.findByPrimaryKey(SUSCRIBER_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(subscriptionRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SubscriptionRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("SUSCRIBER_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(subscriptionRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SubscriptionRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return subscriptionRegistrationLocalService.deleteSubscriptionRegistration((SubscriptionRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return subscriptionRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SubscriptionRegistration> getSubscriptionRegistrations(
		int start, int end) {
		return subscriptionRegistrationPersistence.findAll(start, end);
	}
	...
	public int getSubscriptionRegistrationsCount() {
		return subscriptionRegistrationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SubscriptionRegistration updateSubscriptionRegistration(
		SubscriptionRegistration subscriptionRegistration) {
		return subscriptionRegistrationPersistence.update(subscriptionRegistration);
	}
	 ...
	 */
	public SubscriptionRegistrationLocalService getSubscriptionRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.SubscriptionRegistration",
			subscriptionRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.SubscriptionRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return SubscriptionRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = subscriptionRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = SubscriptionRegistrationLocalService.class)
	protected SubscriptionRegistrationLocalService subscriptionRegistrationLocalService;
