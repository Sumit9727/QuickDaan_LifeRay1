...
import com.crowd.funding.database.service.DocumentRegistrationLocalService;
...
/**
 * Provides the base implementation for the document registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.DocumentRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class DocumentRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DocumentRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.DocumentRegistrationLocalServiceUtil} to access the document registration local service.
	 */
	...
	@Override
	public DocumentRegistration addDocumentRegistration(
		DocumentRegistration documentRegistration) {
		documentRegistration.setNew(true);

		return documentRegistrationPersistence.update(documentRegistration);
	}
	...
	public DocumentRegistration createDocumentRegistration(
		long PROJECT_DOCUMENT_ID) {
		return documentRegistrationPersistence.create(PROJECT_DOCUMENT_ID);
	}
	...
	@Override
	public DocumentRegistration deleteDocumentRegistration(
		long PROJECT_DOCUMENT_ID) throws PortalException {
		return documentRegistrationPersistence.remove(PROJECT_DOCUMENT_ID);
	}
	...
	public DocumentRegistration deleteDocumentRegistration(
		DocumentRegistration documentRegistration) {
		return documentRegistrationPersistence.remove(documentRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DocumentRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return documentRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return documentRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DocumentRegistration fetchDocumentRegistration(
		long PROJECT_DOCUMENT_ID) {
		return documentRegistrationPersistence.fetchByPrimaryKey(PROJECT_DOCUMENT_ID);
	}
	 ...
	 */
	@Override
	public DocumentRegistration getDocumentRegistration(
		long PROJECT_DOCUMENT_ID) throws PortalException {
		return documentRegistrationPersistence.findByPrimaryKey(PROJECT_DOCUMENT_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(documentRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DocumentRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PROJECT_DOCUMENT_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(documentRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DocumentRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return documentRegistrationLocalService.deleteDocumentRegistration((DocumentRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return documentRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DocumentRegistration> getDocumentRegistrations(int start,
		int end) {
		return documentRegistrationPersistence.findAll(start, end);
	}
	...
	public int getDocumentRegistrationsCount() {
		return documentRegistrationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DocumentRegistration updateDocumentRegistration(
		DocumentRegistration documentRegistration) {
		return documentRegistrationPersistence.update(documentRegistration);
	}

	@Override
	public DocumentRegistrationDOCUMENTBlobModel getDOCUMENTBlobModel(
		Serializable primaryKey) {
		Session session = null;

		try {
			session = documentRegistrationPersistence.openSession();

			return (DocumentRegistrationDOCUMENTBlobModel)session.get(DocumentRegistrationDOCUMENTBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw documentRegistrationPersistence.processException(e);
		}
		finally {
			documentRegistrationPersistence.closeSession(session);
		}
	}
	 ...
	 */
	public DocumentRegistrationLocalService getDocumentRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.DocumentRegistration",
			documentRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.DocumentRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DocumentRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = documentRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = DocumentRegistrationLocalService.class)
	protected DocumentRegistrationLocalService documentRegistrationLocalService;
