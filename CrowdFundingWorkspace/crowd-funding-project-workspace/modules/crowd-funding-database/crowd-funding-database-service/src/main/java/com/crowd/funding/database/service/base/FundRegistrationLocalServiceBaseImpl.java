...
import com.crowd.funding.database.service.FundRegistrationLocalService;
...
/**
 * Provides the base implementation for the fund registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.FundRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class FundRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FundRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.FundRegistrationLocalServiceUtil} to access the fund registration local service.
	 */
	...
	@Override
	public FundRegistration addFundRegistration(
		FundRegistration fundRegistration) {
		fundRegistration.setNew(true);

		return fundRegistrationPersistence.update(fundRegistration);
	}
	...
	public FundRegistration createFundRegistration(long PROJECT_FUND_ID) {
		return fundRegistrationPersistence.create(PROJECT_FUND_ID);
	}
	...
	@Override
	public FundRegistration deleteFundRegistration(long PROJECT_FUND_ID)
		throws PortalException {
		return fundRegistrationPersistence.remove(PROJECT_FUND_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FundRegistration deleteFundRegistration(
		FundRegistration fundRegistration) {
		return fundRegistrationPersistence.remove(fundRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FundRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fundRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fundRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FundRegistration fetchFundRegistration(long PROJECT_FUND_ID) {
		return fundRegistrationPersistence.fetchByPrimaryKey(PROJECT_FUND_ID);
	}
	 ...
	 */
	@Override
	public FundRegistration getFundRegistration(long PROJECT_FUND_ID)
		throws PortalException {
		return fundRegistrationPersistence.findByPrimaryKey(PROJECT_FUND_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(fundRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FundRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PROJECT_FUND_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(fundRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FundRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return fundRegistrationLocalService.deleteFundRegistration((FundRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return fundRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FundRegistration> getFundRegistrations(int start, int end) {
		return fundRegistrationPersistence.findAll(start, end);
	}
	...
	public int getFundRegistrationsCount() {
		return fundRegistrationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FundRegistration updateFundRegistration(
		FundRegistration fundRegistration) {
		return fundRegistrationPersistence.update(fundRegistration);
	}
	 ...
	 */
	public FundRegistrationLocalService getFundRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.FundRegistration",
			fundRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.FundRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FundRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = fundRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = FundRegistrationLocalService.class)
	protected FundRegistrationLocalService fundRegistrationLocalService;
