...
import com.crowd.funding.database.service.DonorRegistrationLocalService;
...
/**
 * Provides the base implementation for the donor registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.DonorRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class DonorRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DonorRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.DonorRegistrationLocalServiceUtil} to access the donor registration local service.
	 */
	...
	public DonorRegistration addDonorRegistration(
		...
		return donorRegistrationPersistence.update(donorRegistration);
	}
	...
	public DonorRegistration createDonorRegistration(long DONOR_ID) {
		return donorRegistrationPersistence.create(DONOR_ID);
	}
	...
	public DonorRegistration deleteDonorRegistration(long DONOR_ID)
		...
		return donorRegistrationPersistence.remove(DONOR_ID);
	}
	...
	public DonorRegistration deleteDonorRegistration(
		DonorRegistration donorRegistration) {
		return donorRegistrationPersistence.remove(donorRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DonorRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return donorRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return donorRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public DonorRegistration fetchDonorRegistration(long DONOR_ID) {
		return donorRegistrationPersistence.fetchByPrimaryKey(DONOR_ID);
	}
	...
	public DonorRegistration getDonorRegistration(long DONOR_ID)
		throws PortalException {
		return donorRegistrationPersistence.findByPrimaryKey(DONOR_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(donorRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DonorRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("DONOR_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(donorRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DonorRegistration.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("DONOR_ID");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return donorRegistrationLocalService.deleteDonorRegistration((DonorRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return donorRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DonorRegistration> getDonorRegistrations(int start, int end) {
		return donorRegistrationPersistence.findAll(start, end);
	}
	...
	public int getDonorRegistrationsCount() {
		return donorRegistrationPersistence.countAll();
	}
	 ...
	 */
	public DonorRegistrationLocalService getDonorRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.DonorRegistration",
			donorRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.DonorRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DonorRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = donorRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = DonorRegistrationLocalService.class)
	protected DonorRegistrationLocalService donorRegistrationLocalService;
