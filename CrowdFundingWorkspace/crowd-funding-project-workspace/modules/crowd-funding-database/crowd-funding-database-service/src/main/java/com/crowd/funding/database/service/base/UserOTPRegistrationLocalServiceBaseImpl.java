...
import com.crowd.funding.database.service.UserOTPRegistrationLocalService;
...
/**
 * Provides the base implementation for the user otp registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.UserOTPRegistrationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.crowd.funding.database.service.impl.UserOTPRegistrationLocalServiceImpl
 * @see com.crowd.funding.database.service.UserOTPRegistrationLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class UserOTPRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserOTPRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.UserOTPRegistrationLocalServiceUtil} to access the user otp registration local service.
	 */
	...
	@Override
	public UserOTPRegistration addUserOTPRegistration(
		UserOTPRegistration userOTPRegistration) {
		userOTPRegistration.setNew(true);

		return userOTPRegistrationPersistence.update(userOTPRegistration);
	}
	...
	public UserOTPRegistration createUserOTPRegistration(long USER_OTP_ID) {
		return userOTPRegistrationPersistence.create(USER_OTP_ID);
	}
	...
	@Override
	public UserOTPRegistration deleteUserOTPRegistration(long USER_OTP_ID)
		throws PortalException {
		return userOTPRegistrationPersistence.remove(USER_OTP_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UserOTPRegistration deleteUserOTPRegistration(
		UserOTPRegistration userOTPRegistration) {
		return userOTPRegistrationPersistence.remove(userOTPRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserOTPRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return userOTPRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return userOTPRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UserOTPRegistration fetchUserOTPRegistration(long USER_OTP_ID) {
		return userOTPRegistrationPersistence.fetchByPrimaryKey(USER_OTP_ID);
	}
	 ...
	 */
	@Override
	public UserOTPRegistration getUserOTPRegistration(long USER_OTP_ID)
		throws PortalException {
		return userOTPRegistrationPersistence.findByPrimaryKey(USER_OTP_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(userOTPRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(UserOTPRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("USER_OTP_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(userOTPRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(UserOTPRegistration.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("USER_OTP_ID");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return userOTPRegistrationLocalService.deleteUserOTPRegistration((UserOTPRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return userOTPRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UserOTPRegistration> getUserOTPRegistrations(int start, int end) {
		return userOTPRegistrationPersistence.findAll(start, end);
	}
	...
	public int getUserOTPRegistrationsCount() {
		return userOTPRegistrationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UserOTPRegistration updateUserOTPRegistration(
		UserOTPRegistration userOTPRegistration) {
		return userOTPRegistrationPersistence.update(userOTPRegistration);
	}
	 ...
	 */
	public UserOTPRegistrationLocalService getUserOTPRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.UserOTPRegistration",
			userOTPRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.UserOTPRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return UserOTPRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = userOTPRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = UserOTPRegistrationLocalService.class)
	protected UserOTPRegistrationLocalService userOTPRegistrationLocalService;
