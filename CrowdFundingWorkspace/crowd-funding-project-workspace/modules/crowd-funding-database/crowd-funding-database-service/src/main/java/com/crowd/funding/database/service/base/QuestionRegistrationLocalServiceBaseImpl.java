...
import com.crowd.funding.database.service.QuestionRegistrationLocalService;
...
/**
 * Provides the base implementation for the question registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.QuestionRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class QuestionRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements QuestionRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.QuestionRegistrationLocalServiceUtil} to access the question registration local service.
	 */
	...
	@Override
	public QuestionRegistration addQuestionRegistration(
		QuestionRegistration questionRegistration) {
		questionRegistration.setNew(true);

		return questionRegistrationPersistence.update(questionRegistration);
	}
	...
	public QuestionRegistration createQuestionRegistration(
		long PROJECT_QUESTION_ID) {
		return questionRegistrationPersistence.create(PROJECT_QUESTION_ID);
	}
	...
	@Override
	public QuestionRegistration deleteQuestionRegistration(
		long PROJECT_QUESTION_ID) throws PortalException {
		return questionRegistrationPersistence.remove(PROJECT_QUESTION_ID);
	}
	...
	public QuestionRegistration deleteQuestionRegistration(
		QuestionRegistration questionRegistration) {
		return questionRegistrationPersistence.remove(questionRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(QuestionRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return questionRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return questionRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public QuestionRegistration fetchQuestionRegistration(
		long PROJECT_QUESTION_ID) {
		return questionRegistrationPersistence.fetchByPrimaryKey(PROJECT_QUESTION_ID);
	}
	 ...
	 */
	@Override
	public QuestionRegistration getQuestionRegistration(
		long PROJECT_QUESTION_ID) throws PortalException {
		return questionRegistrationPersistence.findByPrimaryKey(PROJECT_QUESTION_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(questionRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(QuestionRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PROJECT_QUESTION_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(questionRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(QuestionRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return questionRegistrationLocalService.deleteQuestionRegistration((QuestionRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return questionRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QuestionRegistration> getQuestionRegistrations(int start,
		int end) {
		return questionRegistrationPersistence.findAll(start, end);
	}
	...
	public int getQuestionRegistrationsCount() {
		return questionRegistrationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QuestionRegistration updateQuestionRegistration(
		QuestionRegistration questionRegistration) {
		return questionRegistrationPersistence.update(questionRegistration);
	}
	 ...
	 */
	public QuestionRegistrationLocalService getQuestionRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.QuestionRegistration",
			questionRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.QuestionRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuestionRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = questionRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = QuestionRegistrationLocalService.class)
	protected QuestionRegistrationLocalService questionRegistrationLocalService;
