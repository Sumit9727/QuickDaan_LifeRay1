...
import com.crowd.funding.database.service.UpdateRequesterRegistrationLocalService;
...
/**
 * Provides the base implementation for the update requester registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.UpdateRequesterRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class UpdateRequesterRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements UpdateRequesterRegistrationLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.UpdateRequesterRegistrationLocalServiceUtil} to access the update requester registration local service.
	 */
	...
	@Override
	public UpdateRequesterRegistration addUpdateRequesterRegistration(
		UpdateRequesterRegistration updateRequesterRegistration) {
		updateRequesterRegistration.setNew(true);

		return updateRequesterRegistrationPersistence.update(updateRequesterRegistration);
	}
	...
	public UpdateRequesterRegistration createUpdateRequesterRegistration(
		long PROJECT_UPDATE_REQUEST_ID) {
		return updateRequesterRegistrationPersistence.create(PROJECT_UPDATE_REQUEST_ID);
	}
	...
	@Override
	public UpdateRequesterRegistration deleteUpdateRequesterRegistration(
		long PROJECT_UPDATE_REQUEST_ID) throws PortalException {
		return updateRequesterRegistrationPersistence.remove(PROJECT_UPDATE_REQUEST_ID);
	}
	...
	public UpdateRequesterRegistration deleteUpdateRequesterRegistration(
		UpdateRequesterRegistration updateRequesterRegistration) {
		return updateRequesterRegistrationPersistence.remove(updateRequesterRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UpdateRequesterRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return updateRequesterRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return updateRequesterRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UpdateRequesterRegistration fetchUpdateRequesterRegistration(
		long PROJECT_UPDATE_REQUEST_ID) {
		return updateRequesterRegistrationPersistence.fetchByPrimaryKey(PROJECT_UPDATE_REQUEST_ID);
	}
	 ...
	 */
	@Override
	public UpdateRequesterRegistration getUpdateRequesterRegistration(
		long PROJECT_UPDATE_REQUEST_ID) throws PortalException {
		return updateRequesterRegistrationPersistence.findByPrimaryKey(PROJECT_UPDATE_REQUEST_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(updateRequesterRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(UpdateRequesterRegistration.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(updateRequesterRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(UpdateRequesterRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return updateRequesterRegistrationLocalService.deleteUpdateRequesterRegistration((UpdateRequesterRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return updateRequesterRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UpdateRequesterRegistration> getUpdateRequesterRegistrations(
		int start, int end) {
		return updateRequesterRegistrationPersistence.findAll(start, end);
	}
	...
	public int getUpdateRequesterRegistrationsCount() {
		return updateRequesterRegistrationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UpdateRequesterRegistration updateUpdateRequesterRegistration(
		UpdateRequesterRegistration updateRequesterRegistration) {
		return updateRequesterRegistrationPersistence.update(updateRequesterRegistration);
	}
	 ...
	 */
	public UpdateRequesterRegistrationLocalService getUpdateRequesterRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.UpdateRequesterRegistration",
			updateRequesterRegistrationLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return UpdateRequesterRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = updateRequesterRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = UpdateRequesterRegistrationLocalService.class)
	protected UpdateRequesterRegistrationLocalService updateRequesterRegistrationLocalService;
