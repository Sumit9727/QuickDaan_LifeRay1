...
import com.crowd.funding.database.service.CommentRegistrationLocalService;
...
/**
 * Provides the base implementation for the comment registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.CommentRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class CommentRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CommentRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.CommentRegistrationLocalServiceUtil} to access the comment registration local service.
	 */
	...
	@Override
	public CommentRegistration addCommentRegistration(
		CommentRegistration commentRegistration) {
		commentRegistration.setNew(true);

		return commentRegistrationPersistence.update(commentRegistration);
	}
	...
	public CommentRegistration createCommentRegistration(
		long PROJECT_COMMENT_ID) {
		return commentRegistrationPersistence.create(PROJECT_COMMENT_ID);
	}
	...
	@Override
	public CommentRegistration deleteCommentRegistration(
		long PROJECT_COMMENT_ID) throws PortalException {
		return commentRegistrationPersistence.remove(PROJECT_COMMENT_ID);
	}
	...
	public CommentRegistration deleteCommentRegistration(
		CommentRegistration commentRegistration) {
		return commentRegistrationPersistence.remove(commentRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CommentRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return commentRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return commentRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CommentRegistration fetchCommentRegistration(long PROJECT_COMMENT_ID) {
		return commentRegistrationPersistence.fetchByPrimaryKey(PROJECT_COMMENT_ID);
	}
	 ...
	 */
	@Override
	public CommentRegistration getCommentRegistration(long PROJECT_COMMENT_ID)
		throws PortalException {
		return commentRegistrationPersistence.findByPrimaryKey(PROJECT_COMMENT_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(commentRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CommentRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PROJECT_COMMENT_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(commentRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CommentRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return commentRegistrationLocalService.deleteCommentRegistration((CommentRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return commentRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CommentRegistration> getCommentRegistrations(int start, int end) {
		return commentRegistrationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCommentRegistrationsCount() {
		return commentRegistrationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CommentRegistration updateCommentRegistration(
		CommentRegistration commentRegistration) {
		return commentRegistrationPersistence.update(commentRegistration);
	}
	 ...
	 */
	public CommentRegistrationLocalService getCommentRegistrationLocalService() {
	...
	public void setCommentRegistrationLocalService(
		CommentRegistrationLocalService commentRegistrationLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.CommentRegistration",
			commentRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.CommentRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CommentRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = commentRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = CommentRegistrationLocalService.class)
	protected CommentRegistrationLocalService commentRegistrationLocalService;
