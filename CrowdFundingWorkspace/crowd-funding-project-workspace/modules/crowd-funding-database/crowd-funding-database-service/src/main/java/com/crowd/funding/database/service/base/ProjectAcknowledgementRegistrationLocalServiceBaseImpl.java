...
import com.crowd.funding.database.service.ProjectAcknowledgementRegistrationLocalService;
...
/**
 * Provides the base implementation for the project acknowledgement registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.ProjectAcknowledgementRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class ProjectAcknowledgementRegistrationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.ProjectAcknowledgementRegistrationLocalServiceUtil} to access the project acknowledgement registration local service.
	 */
	...
	public ProjectAcknowledgementRegistration addProjectAcknowledgementRegistration(
		...
		return projectAcknowledgementRegistrationPersistence.update(projectAcknowledgementRegistration);
	}
	...
	public ProjectAcknowledgementRegistration createProjectAcknowledgementRegistration(
		...
		return projectAcknowledgementRegistrationPersistence.create(ACKNOWLEDGMENT_ID);
	}
	...
	public ProjectAcknowledgementRegistration deleteProjectAcknowledgementRegistration(
		...
		return projectAcknowledgementRegistrationPersistence.remove(ACKNOWLEDGMENT_ID);
	}
	...
	public ProjectAcknowledgementRegistration deleteProjectAcknowledgementRegistration(
		ProjectAcknowledgementRegistration projectAcknowledgementRegistration) {
		return projectAcknowledgementRegistrationPersistence.remove(projectAcknowledgementRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProjectAcknowledgementRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return projectAcknowledgementRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return projectAcknowledgementRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ProjectAcknowledgementRegistration fetchProjectAcknowledgementRegistration(
		long ACKNOWLEDGMENT_ID) {
		return projectAcknowledgementRegistrationPersistence.fetchByPrimaryKey(ACKNOWLEDGMENT_ID);
	}
	...
	public ProjectAcknowledgementRegistration getProjectAcknowledgementRegistration(
		long ACKNOWLEDGMENT_ID) throws PortalException {
		return projectAcknowledgementRegistrationPersistence.findByPrimaryKey(ACKNOWLEDGMENT_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(projectAcknowledgementRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProjectAcknowledgementRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ACKNOWLEDGMENT_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(projectAcknowledgementRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProjectAcknowledgementRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return projectAcknowledgementRegistrationLocalService.deleteProjectAcknowledgementRegistration((ProjectAcknowledgementRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return projectAcknowledgementRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProjectAcknowledgementRegistration> getProjectAcknowledgementRegistrations(
		int start, int end) {
		return projectAcknowledgementRegistrationPersistence.findAll(start, end);
	}
	...
	public int getProjectAcknowledgementRegistrationsCount() {
		return projectAcknowledgementRegistrationPersistence.countAll();
	}
	...
	public ProjectAcknowledgementRegistrationDOCUMENTBlobModel getDOCUMENTBlobModel(
		...
		try {
			session = projectAcknowledgementRegistrationPersistence.openSession();

			return (ProjectAcknowledgementRegistrationDOCUMENTBlobModel)session.get(ProjectAcknowledgementRegistrationDOCUMENTBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw projectAcknowledgementRegistrationPersistence.processException(e);
		}
		finally {
			projectAcknowledgementRegistrationPersistence.closeSession(session);
		}
	}
	...
	public ProjectAcknowledgementRegistrationVIDEOBlobModel getVIDEOBlobModel(
		...
		try {
			...
			return (ProjectAcknowledgementRegistrationVIDEOBlobModel)session.get(ProjectAcknowledgementRegistrationVIDEOBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw projectAcknowledgementRegistrationPersistence.processException(e);
	 ...
	 */
	public ProjectAcknowledgementRegistrationLocalService getProjectAcknowledgementRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.ProjectAcknowledgementRegistration",
			projectAcknowledgementRegistrationLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProjectAcknowledgementRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = projectAcknowledgementRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = ProjectAcknowledgementRegistrationLocalService.class)
	protected ProjectAcknowledgementRegistrationLocalService projectAcknowledgementRegistrationLocalService;
