...
public class ProjectFeesRegistrationPersistenceImpl extends BasePersistenceImpl<ProjectFeesRegistration>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_PROJECT_FUND_CATEGORY_ID =
		new FinderPath(ProjectFeesRegistrationModelImpl.ENTITY_CACHE_ENABLED,
			ProjectFeesRegistrationModelImpl.FINDER_CACHE_ENABLED,
			ProjectFeesRegistrationImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByPROJECT_FUND_Category_ID",
			new String[] { Long.class.getName(), Long.class.getName() },
			ProjectFeesRegistrationModelImpl.PROJECT_ID_COLUMN_BITMASK |
			ProjectFeesRegistrationModelImpl.CATEGORY_ID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_PROJECT_FUND_CATEGORY_ID =
		new FinderPath(ProjectFeesRegistrationModelImpl.ENTITY_CACHE_ENABLED,
			ProjectFeesRegistrationModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByPROJECT_FUND_Category_ID",
			new String[] { Long.class.getName(), Long.class.getName() });
	...
	public ProjectFeesRegistration findByPROJECT_FUND_Category_ID(
		...
		throws NoSuchProjectFeesRegistrationException {
		ProjectFeesRegistration projectFeesRegistration = fetchByPROJECT_FUND_Category_ID(PROJECT_ID,
				CATEGORY_ID);
	...
	public ProjectFeesRegistration fetchByPROJECT_FUND_Category_ID(
		long PROJECT_ID, long CATEGORY_ID) {
		return fetchByPROJECT_FUND_Category_ID(PROJECT_ID, CATEGORY_ID, true);
	}
	...
	public ProjectFeesRegistration fetchByPROJECT_FUND_Category_ID(
		...
		if (retrieveFromCache) {
			result = finderCache.getResult(FINDER_PATH_FETCH_BY_PROJECT_FUND_CATEGORY_ID,
					finderArgs, this);
		}
		...
		if (result instanceof ProjectFeesRegistration) {
			...
			if ((PROJECT_ID != projectFeesRegistration.getPROJECT_ID()) ||
					(CATEGORY_ID != projectFeesRegistration.getCATEGORY_ID())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_PROJECT_FUND_CATEGORY_ID_PROJECT_ID_2);

			query.append(_FINDER_COLUMN_PROJECT_FUND_CATEGORY_ID_CATEGORY_ID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(FINDER_PATH_FETCH_BY_PROJECT_FUND_CATEGORY_ID,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"ProjectFeesRegistrationPersistenceImpl.fetchByPROJECT_FUND_Category_ID(long, long, boolean) with parameters (" +
								StringUtil.merge(finderArgs) +
								") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
				...
				finderCache.removeResult(FINDER_PATH_FETCH_BY_PROJECT_FUND_CATEGORY_ID,
					finderArgs);
	...
	public ProjectFeesRegistration removeByPROJECT_FUND_Category_ID(
		long PROJECT_ID, long CATEGORY_ID)
		throws NoSuchProjectFeesRegistrationException {
		ProjectFeesRegistration projectFeesRegistration = findByPROJECT_FUND_Category_ID(PROJECT_ID,
				CATEGORY_ID);
	...
	public int countByPROJECT_FUND_Category_ID(long PROJECT_ID, long CATEGORY_ID) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_PROJECT_FUND_CATEGORY_ID;
	...
	private static final String _FINDER_COLUMN_PROJECT_FUND_CATEGORY_ID_PROJECT_ID_2 =
		"projectFeesRegistration.PROJECT_ID = ? AND ";
	private static final String _FINDER_COLUMN_PROJECT_FUND_CATEGORY_ID_CATEGORY_ID_2 =
		"projectFeesRegistration.CATEGORY_ID = ?";
	...
	public void cacheResult(ProjectFeesRegistration projectFeesRegistration) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_PROJECT_FUND_CATEGORY_ID,
			new Object[] {
				projectFeesRegistration.getPROJECT_ID(),
				projectFeesRegistration.getCATEGORY_ID()
			}, projectFeesRegistration);
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(FINDER_PATH_COUNT_BY_PROJECT_FUND_CATEGORY_ID,
			args, Long.valueOf(1), false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_PROJECT_FUND_CATEGORY_ID,
			args, projectFeesRegistrationModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_PROJECT_FUND_CATEGORY_ID,
				args);
			finderCache.removeResult(FINDER_PATH_FETCH_BY_PROJECT_FUND_CATEGORY_ID,
				args);
		}
		...
		if ((projectFeesRegistrationModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_PROJECT_FUND_CATEGORY_ID.getColumnBitmask()) != 0) {
			Object[] args = new Object[] {
