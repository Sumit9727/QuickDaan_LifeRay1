...
import com.crowd.funding.database.service.ImageRegistrationLocalService;
...
/**
 * Provides the base implementation for the image registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.ImageRegistrationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.crowd.funding.database.service.impl.ImageRegistrationLocalServiceImpl
 * @see com.crowd.funding.database.service.ImageRegistrationLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ImageRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ImageRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.ImageRegistrationLocalServiceUtil} to access the image registration local service.
	 */
	...
	@Override
	public ImageRegistration addImageRegistration(
		ImageRegistration imageRegistration) {
		imageRegistration.setNew(true);

		return imageRegistrationPersistence.update(imageRegistration);
	}
	...
	public ImageRegistration createImageRegistration(long PROJECT_IMAGE_ID) {
		return imageRegistrationPersistence.create(PROJECT_IMAGE_ID);
	}
	...
	@Override
	public ImageRegistration deleteImageRegistration(long PROJECT_IMAGE_ID)
		throws PortalException {
		return imageRegistrationPersistence.remove(PROJECT_IMAGE_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ImageRegistration deleteImageRegistration(
		ImageRegistration imageRegistration) {
		return imageRegistrationPersistence.remove(imageRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ImageRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return imageRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return imageRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ImageRegistration fetchImageRegistration(long PROJECT_IMAGE_ID) {
		return imageRegistrationPersistence.fetchByPrimaryKey(PROJECT_IMAGE_ID);
	}
	 ...
	 */
	@Override
	public ImageRegistration getImageRegistration(long PROJECT_IMAGE_ID)
		throws PortalException {
		return imageRegistrationPersistence.findByPrimaryKey(PROJECT_IMAGE_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(imageRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ImageRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PROJECT_IMAGE_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(imageRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ImageRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return imageRegistrationLocalService.deleteImageRegistration((ImageRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return imageRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ImageRegistration> getImageRegistrations(int start, int end) {
		return imageRegistrationPersistence.findAll(start, end);
	}
	...
	public int getImageRegistrationsCount() {
		return imageRegistrationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ImageRegistration updateImageRegistration(
		ImageRegistration imageRegistration) {
		return imageRegistrationPersistence.update(imageRegistration);
	}

	@Override
	public ImageRegistrationIMAGEBlobModel getIMAGEBlobModel(
		Serializable primaryKey) {
		Session session = null;

		try {
			session = imageRegistrationPersistence.openSession();

			return (ImageRegistrationIMAGEBlobModel)session.get(ImageRegistrationIMAGEBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw imageRegistrationPersistence.processException(e);
		}
		finally {
			imageRegistrationPersistence.closeSession(session);
		}
	}
	 ...
	 */
	public ImageRegistrationLocalService getImageRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.ImageRegistration",
			imageRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.ImageRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ImageRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = imageRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = ImageRegistrationLocalService.class)
	protected ImageRegistrationLocalService imageRegistrationLocalService;
