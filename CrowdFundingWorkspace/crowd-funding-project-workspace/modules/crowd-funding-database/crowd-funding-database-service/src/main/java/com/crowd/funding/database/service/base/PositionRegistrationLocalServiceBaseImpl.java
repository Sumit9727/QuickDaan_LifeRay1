...
import com.crowd.funding.database.service.PositionRegistrationLocalService;
...
/**
 * Provides the base implementation for the position registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.PositionRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class PositionRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PositionRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.PositionRegistrationLocalServiceUtil} to access the position registration local service.
	 */
	...
	@Override
	public PositionRegistration addPositionRegistration(
		PositionRegistration positionRegistration) {
		positionRegistration.setNew(true);

		return positionRegistrationPersistence.update(positionRegistration);
	}
	...
	public PositionRegistration createPositionRegistration(long POSITION_ID) {
		return positionRegistrationPersistence.create(POSITION_ID);
	}
	...
	@Override
	public PositionRegistration deletePositionRegistration(long POSITION_ID)
		throws PortalException {
		return positionRegistrationPersistence.remove(POSITION_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PositionRegistration deletePositionRegistration(
		PositionRegistration positionRegistration) {
		return positionRegistrationPersistence.remove(positionRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PositionRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return positionRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return positionRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PositionRegistration fetchPositionRegistration(long POSITION_ID) {
		return positionRegistrationPersistence.fetchByPrimaryKey(POSITION_ID);
	}
	 ...
	 */
	@Override
	public PositionRegistration getPositionRegistration(long POSITION_ID)
		throws PortalException {
		return positionRegistrationPersistence.findByPrimaryKey(POSITION_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(positionRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PositionRegistration.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(positionRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PositionRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return positionRegistrationLocalService.deletePositionRegistration((PositionRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return positionRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PositionRegistration> getPositionRegistrations(int start,
		int end) {
		return positionRegistrationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPositionRegistrationsCount() {
		return positionRegistrationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PositionRegistration updatePositionRegistration(
		PositionRegistration positionRegistration) {
		return positionRegistrationPersistence.update(positionRegistration);
	}
	 ...
	 */
	public PositionRegistrationLocalService getPositionRegistrationLocalService() {
	...
	public void setPositionRegistrationLocalService(
		PositionRegistrationLocalService positionRegistrationLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.PositionRegistration",
			positionRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.PositionRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return PositionRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = positionRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = PositionRegistrationLocalService.class)
	protected PositionRegistrationLocalService positionRegistrationLocalService;
