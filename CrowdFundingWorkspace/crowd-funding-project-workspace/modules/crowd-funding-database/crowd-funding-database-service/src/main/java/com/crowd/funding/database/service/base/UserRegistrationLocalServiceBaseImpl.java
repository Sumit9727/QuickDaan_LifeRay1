...
import com.crowd.funding.database.service.UserRegistrationLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.UserRegistrationLocalServiceImpl}.
 * </p>
 *
...
public abstract class UserRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.UserRegistrationLocalServiceUtil} to access the user registration local service.
	 */
	...
	public UserRegistration createUserRegistration(long USER_ID) {
		return userRegistrationPersistence.create(USER_ID);
	}
	...
	@Override
	public UserRegistration deleteUserRegistration(long USER_ID)
		throws PortalException {
		return userRegistrationPersistence.remove(USER_ID);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserRegistration.class,
	...
	@Override
	public UserRegistration fetchUserRegistration(long USER_ID) {
		return userRegistrationPersistence.fetchByPrimaryKey(USER_ID);
	}
	 ...
	 */
	@Override
	public UserRegistration getUserRegistration(long USER_ID)
		throws PortalException {
		return userRegistrationPersistence.findByPrimaryKey(USER_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(userRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(UserRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("USER_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(userRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(UserRegistration.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("USER_ID");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return userRegistrationLocalService.deleteUserRegistration((UserRegistration)persistedModel);
	}
	 ...
	 */
	public UserRegistrationLocalService getUserRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.UserRegistration",
			userRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.UserRegistration");
	}
	...
	@BeanReference(type = UserRegistrationLocalService.class)
