...
import com.crowd.funding.database.service.FundAccountRegistrationLocalService;
...
/**
 * Provides the base implementation for the fund account registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.FundAccountRegistrationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.crowd.funding.database.service.impl.FundAccountRegistrationLocalServiceImpl
 * @see com.crowd.funding.database.service.FundAccountRegistrationLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class FundAccountRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FundAccountRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.FundAccountRegistrationLocalServiceUtil} to access the fund account registration local service.
	 */
	...
	public FundAccountRegistration addFundAccountRegistration(
		...
		return fundAccountRegistrationPersistence.update(fundAccountRegistration);
	}
	...
	public FundAccountRegistration createFundAccountRegistration(
		long ACCOUNT_ID) {
		return fundAccountRegistrationPersistence.create(ACCOUNT_ID);
	}
	...
	public FundAccountRegistration deleteFundAccountRegistration(
		...
		return fundAccountRegistrationPersistence.remove(ACCOUNT_ID);
	}
	...
	public FundAccountRegistration deleteFundAccountRegistration(
		FundAccountRegistration fundAccountRegistration) {
		return fundAccountRegistrationPersistence.remove(fundAccountRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FundAccountRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fundAccountRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fundAccountRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public FundAccountRegistration fetchFundAccountRegistration(long ACCOUNT_ID) {
		return fundAccountRegistrationPersistence.fetchByPrimaryKey(ACCOUNT_ID);
	}
	...
	public FundAccountRegistration getFundAccountRegistration(long ACCOUNT_ID)
		...
		return fundAccountRegistrationPersistence.findByPrimaryKey(ACCOUNT_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(fundAccountRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FundAccountRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ACCOUNT_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(fundAccountRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FundAccountRegistration.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("ACCOUNT_ID");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return fundAccountRegistrationLocalService.deleteFundAccountRegistration((FundAccountRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return fundAccountRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<FundAccountRegistration> getFundAccountRegistrations(
		int start, int end) {
		return fundAccountRegistrationPersistence.findAll(start, end);
	}
	...
	public int getFundAccountRegistrationsCount() {
		return fundAccountRegistrationPersistence.countAll();
	}
	 ...
	 */
	public FundAccountRegistrationLocalService getFundAccountRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.FundAccountRegistration",
			fundAccountRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.FundAccountRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FundAccountRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = fundAccountRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = FundAccountRegistrationLocalService.class)
	protected FundAccountRegistrationLocalService fundAccountRegistrationLocalService;
