...
import com.crowd.funding.database.service.BenificiaryRegistrationLocalService;
...
/**
 * Provides the base implementation for the benificiary registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.crowd.funding.database.service.impl.BenificiaryRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class BenificiaryRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BenificiaryRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.crowd.funding.database.service.BenificiaryRegistrationLocalServiceUtil} to access the benificiary registration local service.
	 */
	...
	public BenificiaryRegistration addBenificiaryRegistration(
		...
		return benificiaryRegistrationPersistence.update(benificiaryRegistration);
	}
	...
	public BenificiaryRegistration createBenificiaryRegistration(
		long BENIFICIARY_ID) {
		return benificiaryRegistrationPersistence.create(BENIFICIARY_ID);
	}
	...
	public BenificiaryRegistration deleteBenificiaryRegistration(
		...
		return benificiaryRegistrationPersistence.remove(BENIFICIARY_ID);
	}
	...
	public BenificiaryRegistration deleteBenificiaryRegistration(
		BenificiaryRegistration benificiaryRegistration) {
		return benificiaryRegistrationPersistence.remove(benificiaryRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BenificiaryRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return benificiaryRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return benificiaryRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public BenificiaryRegistration fetchBenificiaryRegistration(
		long BENIFICIARY_ID) {
		return benificiaryRegistrationPersistence.fetchByPrimaryKey(BENIFICIARY_ID);
	}
	...
	public BenificiaryRegistration getBenificiaryRegistration(
		long BENIFICIARY_ID) throws PortalException {
		return benificiaryRegistrationPersistence.findByPrimaryKey(BENIFICIARY_ID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(benificiaryRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BenificiaryRegistration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("BENIFICIARY_ID");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(benificiaryRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(BenificiaryRegistration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return benificiaryRegistrationLocalService.deleteBenificiaryRegistration((BenificiaryRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return benificiaryRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<BenificiaryRegistration> getBenificiaryRegistrations(
		int start, int end) {
		return benificiaryRegistrationPersistence.findAll(start, end);
	}
	...
	public int getBenificiaryRegistrationsCount() {
		return benificiaryRegistrationPersistence.countAll();
	}
	...
	public BenificiaryRegistrationIMAGEBlobModel getIMAGEBlobModel(
		...
		try {
			session = benificiaryRegistrationPersistence.openSession();

			return (BenificiaryRegistrationIMAGEBlobModel)session.get(BenificiaryRegistrationIMAGEBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw benificiaryRegistrationPersistence.processException(e);
		}
		finally {
			benificiaryRegistrationPersistence.closeSession(session);
		}
	}
	 ...
	 */
	public BenificiaryRegistrationLocalService getBenificiaryRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.crowd.funding.database.model.BenificiaryRegistration",
			benificiaryRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.crowd.funding.database.model.BenificiaryRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return BenificiaryRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = benificiaryRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = BenificiaryRegistrationLocalService.class)
	protected BenificiaryRegistrationLocalService benificiaryRegistrationLocalService;
