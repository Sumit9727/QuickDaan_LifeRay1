...
/**
 * This class is used by SOAP remote services, specifically {@link com.crowd.funding.database.service.http.PositionRegistrationServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see com.crowd.funding.database.service.http.PositionRegistrationServiceSoap
 * @generated
 */
@ProviderType
public class PositionRegistrationSoap implements Serializable {
	public static PositionRegistrationSoap toSoapModel(
		PositionRegistration model) {
		PositionRegistrationSoap soapModel = new PositionRegistrationSoap();
	...
	public static PositionRegistrationSoap[] toSoapModels(
		PositionRegistration[] models) {
		PositionRegistrationSoap[] soapModels = new PositionRegistrationSoap[models.length];
	...
	public static PositionRegistrationSoap[][] toSoapModels(
		PositionRegistration[][] models) {
		PositionRegistrationSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new PositionRegistrationSoap[models.length][models[0].length];
		}
		else {
			soapModels = new PositionRegistrationSoap[0][0];
		}
	...
	public static PositionRegistrationSoap[] toSoapModels(
		List<PositionRegistration> models) {
		List<PositionRegistrationSoap> soapModels = new ArrayList<PositionRegistrationSoap>(models.size());

		for (PositionRegistration model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new PositionRegistrationSoap[soapModels.size()]);
	}

	public PositionRegistrationSoap() {
	}
