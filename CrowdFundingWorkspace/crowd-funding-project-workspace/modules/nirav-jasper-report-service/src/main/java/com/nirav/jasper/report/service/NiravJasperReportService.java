package com.nirav.jasper.report.service;
...
@Component(
	...
	service = NiravJasperReportApi.class
)
public class NiravJasperReportService implements NiravJasperReportApi {
	
	private static final Log _log = LogFactoryUtil.getLog(NiravJasperReportService.class);
