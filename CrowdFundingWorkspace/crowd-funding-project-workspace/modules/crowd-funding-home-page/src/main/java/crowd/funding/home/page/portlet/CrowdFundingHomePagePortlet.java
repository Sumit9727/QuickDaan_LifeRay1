package crowd.funding.home.page.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.init-param.view-template=/jsp/HomePage/HomePage.jsp",
		"javax.portlet.name= Home Page",
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class CrowdFundingHomePagePortlet extends MVCPortlet {
	...
	*/
	...
	public void emailMobileRegistration(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		try {
		    ...
		    crowd.funding.home.page.constants.CrowdFundingMail.sendMail(mailSubject, mailBody, email);
	...
	public void otpAuthentication(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		try {
		    ...
		    crowd.funding.home.page.constants.CrowdFundingMail.sendMail(mailSubject, mailBody, donorObj.getMAIL_ADDRESS());
	...
	public void donationAmount(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		try {
			...
			if(donateAnonymously != null)
				fundRegistration.setDONOR_STATUS(CrowdFundingHomePagePortletKeys.DONATE_ANONYMOSULY_STATUS_0);
			if(donateAnonymously == null)
				fundRegistration.setDONOR_STATUS(CrowdFundingHomePagePortletKeys.DONATE_ANONYMOSULY_STATUS_1);
			...
			if(collectedFundAmount >= projectObj.getREQUIRED_FUND_AMOUNT()) {
				projectObj.setREQUEST_STATUS(CrowdFundingHomePagePortletKeys.Project_REQUESTED_STATUS_1);
			...
			for(ProjectFollowerRegistration projectFollowerObj : projectFollowerList ) {
				try {
					...
					UserNotificationEventLocalServiceUtil.addUserNotificationEvent(projectFollowerObj.getUSER_ID(), crowd.funding.home.page.constants.SendNotificationToUserHandler.PORTLET_ID,
	...
	public void updateRequestRegistration(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		try {
			...
			updateRequesterRegistration.setSTATUS(CrowdFundingHomePagePortletKeys.UPDATE_REQUEST_POST_STATUS_1);
	...
	public void askQuestionRegistration(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		try {
			...
			questionRegistration.setSTATUS(CrowdFundingHomePagePortletKeys.QUESTION_POST_STATUS_1);
	...
	public void feedbackRegistration(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		try {
			...
			feedbackRegistration.setSTATUS(CrowdFundingHomePagePortletKeys.FEEDBACK_POST_STATUS_1);
	...
	public void commentDetails(ActionRequest actionRequest, ActionResponse actionResponse)
	    ...
	    commentRegistration.setSTATUS(CrowdFundingHomePagePortletKeys.Comment_Status_0);
	...
	public void projectFollowerRegistration(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		try {
			...
			followerRegistration.setSTATUS(CrowdFundingHomePagePortletKeys.CAMPAIGN_FOLLOWER_STATUS_1);
	...
	public void projectUnFollowRegistration(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		try {
		 ...
		 followerObj.setSTATUS(CrowdFundingHomePagePortletKeys.CAMPAIGN_FOLLOWER_STATUS_0);
