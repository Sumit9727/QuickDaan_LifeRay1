            ...
            do {
              ...
              if (_jspx_eval_liferay$1ui_search$1container$1column$1text_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  out.write("\t\t\t\t\t\t");
if (
 layout.isPrivateLayout() && name.equals(RoleConstants.GUEST) ) {
                  out.write("\n");
                  out.write("\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("fm');\n");
        out.write("\n");
        out.write("\tvar preSelectedHandler = dom.delegate(\n");
        out.write("\t\tform,\n");
        out.write("\t\t'mouseover',\n");
        ...
        out.write("\n");
        out.write("\t\t\tLiferay.Portal.ToolTip.show(target, target.getAttribute('data-message'));\n");
        out.write("\t\t}\n");
        out.write("\t);\n");
