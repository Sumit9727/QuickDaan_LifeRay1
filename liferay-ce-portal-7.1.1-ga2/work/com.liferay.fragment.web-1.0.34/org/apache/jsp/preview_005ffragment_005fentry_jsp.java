...
FragmentDisplayContext fragmentDisplayContext = new FragmentDisplayContext(renderRequest, renderResponse, request);
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\n");
        out.write("\tfunction handleIframeMessage(event) {\n");
        out.write("\t\tif (event.data) {\n");
        out.write("\t\t\tvar virtualDocument = document.createElement('html');\n");
        out.write("\n");
        out.write("\t\t\tvirtualDocument.innerHTML = JSON.parse(event.data).data;\n");
        out.write("\n");
        out.write("\t\t\tvar virtualBody = virtualDocument.querySelector('.portlet-body');\n");
        out.write("\n");
        out.write("\t\t\tif (virtualBody) {\n");
        out.write("\t\t\t\tdocument.querySelector('.portlet-body').innerHTML = virtualBody.innerHTML;\n");
        out.write("\t\t\t}\n");
        out.write("\n");
        out.write("\t\t\tdom.globalEval.runScriptsInElement(virtualBody);\n");
        out.write("\t\t}\n");
        out.write("\t}\n");
        out.write("\n");
        out.write("\twindow.addEventListener('message', handleIframeMessage);\n");
