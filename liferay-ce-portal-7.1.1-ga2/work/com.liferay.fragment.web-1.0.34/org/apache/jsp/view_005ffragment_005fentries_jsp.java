			...
			String imagePreviewURL = fragmentEntry.getImagePreviewURL(themeDisplay);
              ...
              if (_jspx_eval_liferay$1ui_search$1container$1column$1text_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  out.write("\t\t\t\t\t");
if (
 Validator.isNotNull(imagePreviewURL) ) {
                  out.write("\n");
                  out.write("\t\t\t\t\t\t");
...
if (
 FragmentPermission.contains(permissionChecker, scopeGroupId, FragmentActionKeys.MANAGE_FRAGMENT_ENTRIES) ) {
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t\tfunction handleAddFragmentEntryMenuItemClick(event) {\n");
          out.write("\t\t\tevent.preventDefault();\n");
          out.write("\n");
          out.write("\t\t\tmodalCommands.openSimpleInputModal(\n");
          out.write("\t\t\t\t{\n");
          ...
          out.write("\t\t}\n");
          out.write("\n");
          out.write("\t\tvar updateFragmentEntryMenuItemClickHandler = dom.delegate(\n");
          ...
          out.write("\t\t\t\tvar data = event.delegateTarget.dataset;\n");
          out.write("\n");
          out.write("\t\t\t\tevent.preventDefault();\n");
          out.write("\n");
          out.write("\t\t\t\tmodalCommands.openSimpleInputModal({\n");
          ...
          if (_jspx_meth_liferay$1ui_message_7((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("',\n");
          out.write("\t\t\t\t\tformSubmitURL: data.formSubmitUrl,\n");
          out.write("\t\t\t\t\tidFieldName: 'id',\n");
          out.write("\t\t\t\t\tidFieldValue: data.idFieldValue,\n");
          out.write("\t\t\t\t\tmainFieldLabel: '");
          ...
          if (_jspx_meth_liferay$1ui_message_9((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("',\n");
          out.write("\t\t\t\t\tmainFieldValue: data.mainFieldValue,\n");
          out.write("\t\t\t\t\tnamespace: '");
          ...
          out.write("\t\t);\n");
          out.write("\n");
          out.write("\t\tvar updateFragmentEntryPreviewMenuItemClickHandler = dom.delegate(\n");
          out.write("\t\t\tdocument.body,\n");
          out.write("\t\t\t'click',\n");
          out.write("\t\t\t'.update-fragment-preview > a',\n");
          out.write("\t\t\tfunction(event) {\n");
          out.write("\t\t\t\tvar data = event.delegateTarget.dataset;\n");
          out.write("\n");
          out.write("\t\t\t\tevent.preventDefault();\n");
          ...
          out.write("\n");
          out.write("\t\t\t\tAUI().use(\n");
          out.write("\t\t\t\t\t'liferay-item-selector-dialog',\n");
          ...
          out.write("\t\t\tupdateFragmentEntryMenuItemClickHandler.removeListener();\n");
          out.write("\t\t\tupdateFragmentEntryPreviewMenuItemClickHandler.removeListener();\n");
          out.write("\n");
          out.write("\t\t\tLiferay.detach('destroyPortlet', handleDestroyPortlet);\n");
          out.write("\t\t}\n");
          out.write("\n");
          out.write("\t\tLiferay.componentReady('fragmentEntriesManagementToolbar').then(\n");
          out.write("\t\t\tfunction(managementToolbar) {\n");
          out.write("\t\t\t\tmanagementToolbar.on('creationButtonClicked', handleAddFragmentEntryMenuItemClick);\n");
          out.write("\t\t\t}\n");
          out.write("\t\t);\n");
          out.write("\n");
      ...
      if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar deleteSelectedFragmentEntries = function() {\n");
          ...
          out.write("\t}\n");
          out.write("\n");
          out.write("\tvar exportSelectedFragmentEntries = function() {\n");
          out.write("\t\tsubmitForm(document.querySelector('#");
          ...
          out.write("\t\t'deleteSelectedFragmentEntries': deleteSelectedFragmentEntries,\n");
          out.write("\t\t'exportSelectedFragmentEntries': exportSelectedFragmentEntries\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tLiferay.componentReady('fragmentEntriesManagementToolbar').then(\n");
          out.write("\t\tfunction(managementToolbar) {\n");
