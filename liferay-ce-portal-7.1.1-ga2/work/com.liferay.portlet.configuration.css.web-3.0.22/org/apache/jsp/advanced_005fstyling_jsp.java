...
PortletConfigurationCSSPortletDisplayContext portletConfigurationCSSPortletDisplayContext = new PortletConfigurationCSSPortletDisplayContext(renderRequest);
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\tvar customCSS = document.getElementById('");
          if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("customCSS');\n");
          out.write("\n");
          out.write("\t\tif (customCSS) {\n");
          out.write("\t\t\tvar customCSSVal = customCSS.value.trim();\n");
          out.write("\n");
          out.write("\t\t\tif (customCSSVal.length) {\n");
          out.write("\t\t\t\tcustomCSSVal += '\\n\\n';\n");
          out.write("\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\tvar newVal = customCSSVal + value + ' {\\n\\t\\n}\\n';\n");
          out.write("\n");
          out.write("\t\t\tcustomCSS.value = newVal;\n");
          out.write("\n");
          out.write("\t\t\tLiferay.Util.setCursorPosition(customCSS, newVal.length - 3);\n");
          out.write("\t\t}\n");
          out.write("\t}\n");
          out.write("\n");
          out.write("\tvar ");
          ...
          out.write("\t}\n");
          out.write("\n");
          out.write("\tvar portlet = Liferay.Util.getOpener()['portlet_");
          out.print( portletConfigurationCSSPortletDisplayContext.getPortletResource() );
          out.write("'];\n");
          out.write("\n");
          ...
          out.write("\t\t\t\tportletClasses = portlet.getAttribute('class').replace(/(?:^|\\s)portlet(?=\\s|$)/g, '');\n");
          out.write("\n");
          ...
          out.write("\n");
          out.write("\t\t\tportletContent.getAttribute('class').replace(\n");
          out.write("\t\t\t\t/(?:([\\w\\d-]+)-)?portlet(?:-?([\\w\\d-]+-?))?/g,\n");
          out.write("\t\t\t\tfunction(match, subMatch1, subMatch2) {\n");
