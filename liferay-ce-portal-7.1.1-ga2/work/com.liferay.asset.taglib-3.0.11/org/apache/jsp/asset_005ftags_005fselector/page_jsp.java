...
if (
 allowAddEntry ) {
      out.write("\n");
      out.write("\t\t<input class=\"form-control lfr-tag-selector-input\" id=\"");
      out.print( id );
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar assetTaglibTagsSelector = new Liferay.AssetTaglibTagsSelector(\n");
          out.write("\t\t{\n");
          out.write("\t\t\tallowAddEntry: ");
...
if (
 portletURL != null ) {
          ...
          out.write("\t");
if (
 Validator.isNotNull(addCallback) ) {
          out.write("\n");
          out.write("\t\tassetTaglibTagsSelector.entries.on(\n");
          out.write("\t\t\t'add',\n");
          ...
          out.write("\t");
if (
 Validator.isNotNull(removeCallback) ) {
          out.write("\n");
          out.write("\t\tassetTaglibTagsSelector.entries.on(\n");
          out.write("\t\t\t'remove',\n");
          out.write("\t\t\tfunction(event) {\n");
