...
if (
 Validator.isNotNull(className) ) {
      ...
      out.write("\t\t\t\t\t");
if (
 vocabulary.getGroupId() != themeDisplay.getSiteGroupId() ) {
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t");
if (
 vocabulary.isRequired(PortalUtil.getClassNameId(className), classTypePK) && showRequiredLabel ) {
      out.write("\n");
      out.write("\t\t\t\t\t\t<span class=\"icon-asterisk text-warning\">\n");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t\t\t\tnew Liferay.AssetTaglibCategoriesSelector(\n");
          out.write("\t\t\t\t\t{\n");
          out.write("\t\t\t\t\t\tcategoryIds: '");
          out.print( categoryIdsTitle[0] );
          out.write("',\n");
          out.write("\t\t\t\t\t\tcategoryTitles: '");
