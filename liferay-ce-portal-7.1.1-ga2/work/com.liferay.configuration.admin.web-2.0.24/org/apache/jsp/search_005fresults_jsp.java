          ...
          do {
            ...
            if (_jspx_eval_liferay$1ui_search$1container$1column$1text_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              do {
                ...
                out.write("\t\t\t\t\t");
if (
 configurationModel.isFactory() && !configurationModel.isCompanyFactory() ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t");
                //  aui:a
            ...
            if (_jspx_eval_liferay$1ui_search$1container$1column$1text_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              do {
                ...
                out.write("\t\t\t\t\t");
if (
 ExtendedObjectClassDefinition.Scope.COMPANY.equals(configurationModel.getScope()) ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t");
 ...
 ExtendedObjectClassDefinition.Scope.GROUP.equals(configurationModel.getScope()) ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t");
 ...
 ExtendedObjectClassDefinition.Scope.PORTLET_INSTANCE.equals(configurationModel.getScope()) ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t");
 ...
 ExtendedObjectClassDefinition.Scope.SYSTEM.equals(configurationModel.getScope()) ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t");
...
if (
 configurationModel.isFactory() && !configurationModel.isCompanyFactory() ) {
                    ...
                    out.write("\t\t\t\t\t\t\t");
if (
 configurationModel.hasConfiguration() ) {
                    out.write("\n");
                    out.write("\t\t\t\t\t\t\t\t");
                    //  portlet:actionURL
