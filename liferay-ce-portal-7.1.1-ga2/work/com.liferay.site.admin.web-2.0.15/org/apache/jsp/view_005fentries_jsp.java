 ...
 Validator.isNotNull(siteImageURL) ) {
            ...
            if (_jspx_eval_liferay$1ui_search$1container$1column$1text_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              do {
                ...
                out.write("\t\t\t\t\t\t<li class=\"h6 text-default\">\n");
                out.write("\t\t\t\t\t\t\t");
                out.write("\n");
                out.write("\t\t\t\t\t\t\t\t");
if (
 curGroup.isActive() ) {
                ...
                out.write("\t\t\t\t\t\t");
if (
 hasAddChildSitePermisison && GroupPermissionUtil.contains(permissionChecker, curGroup, ActionKeys.VIEW) ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t\t<li class=\"h6\">\n");
                out.write("\t\t\t\t\t\t\t\t");
                //  aui:a
...
if (
 hasAddChildSitePermisison && GroupPermissionUtil.contains(permissionChecker, curGroup, ActionKeys.VIEW) ) {
                ...
                _jspx_th_aui_a_5.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_search$1container$1column$1text_3);
                ...
                if (_jspx_eval_aui_a_5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  out.write("\n");
                  out.write("\t\t\t\t<span class=\"child-sites-text\">");
                  //  liferay-ui:message
