			...
			addLayoutData.put("site-initializer-key", siteInitializerItem.getSiteInitializerKey());
              ...
              if (_jspx_eval_liferay$1ui_search$1container$1column$1text_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  out.write("\t\t\t\t\t");
if (
 Objects.equals(siteInitializerItem.getType(), SiteAdminConstants.CREATION_TYPE_SITE_TEMPLATE) || Validator.isBlank(siteInitializerItem.getIcon()) ) {
                  out.write("\n");
                  out.write("\t\t\t\t\t\t");
        ...
        if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\n");
            out.write("\t\tvar addSiteActionOptionQueryClickHandler = dom.delegate(\n");
            out.write("\t\t\tdocument.body,\n");
            out.write("\t\t\t'click',\n");
            out.write("\t\t\t'.add-site-action-option',\n");
            ...
            if (_jspx_meth_liferay$1ui_message_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
              return;
            out.write("',\n");
            out.write("\t\t\t\t\t\tformSubmitURL: uri,\n");
            out.write("\t\t\t\t\t\tidFieldName: 'layoutSetPrototypeId',\n");
            out.write("\t\t\t\t\t\tidFieldValue: data.layoutSetPrototypeId,\n");
            ...
            out.write("\t\t\taddSiteActionOptionQueryClickHandler.removeListener();\n");
            out.write("\n");
