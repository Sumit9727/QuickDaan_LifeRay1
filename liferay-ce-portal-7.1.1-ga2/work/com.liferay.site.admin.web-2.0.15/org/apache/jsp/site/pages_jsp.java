...
boolean hasUnlinkLayoutSetPrototypePermission = PortalPermissionUtil.contains(permissionChecker, ActionKeys.UNLINK_LAYOUT_SET_PROTOTYPE);
      ...
      out.write('	');
if (
 (publicLayoutSetPrototype == null) && (group.getPublicLayoutsPageCount() == 0) && !layoutSetPrototypes.isEmpty() ) {
      out.write("\n");
      out.write("\t\t");
if (
...
if (
 group.getPublicLayoutsPageCount() > 0 ) {
      ...
      out.write("\t\t\t");
if (
 (publicLayoutSetPrototype != null) && !group.isStaged() && hasUnlinkLayoutSetPrototypePermission ) {
      out.write("\n");
      out.write("\t\t\t\t");
if (
 disableLayoutSetPrototypeInput ) {
 ...
 publicLayoutSetPrototype != null ) {
      ...
      out.write('	');
if (
 (privateLayoutSetPrototype == null) && (group.getPrivateLayoutsPageCount() == 0) && !layoutSetPrototypes.isEmpty() ) {
      out.write("\n");
      out.write("\t\t");
if (
 disableLayoutSetPrototypeInput ) {
...
if (
 group.getPrivateLayoutsPageCount() > 0 ) {
      ...
      out.write("\t\t\t");
if (
 (privateLayoutSetPrototype != null) && !group.isStaged() && hasUnlinkLayoutSetPrototypePermission ) {
      out.write("\n");
      out.write("\t\t\t\t");
if (
 disableLayoutSetPrototypeInput ) {
