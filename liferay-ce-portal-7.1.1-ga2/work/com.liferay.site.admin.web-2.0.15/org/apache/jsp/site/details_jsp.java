	...
	if (parentGroup != null) {
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\t\t\t\t\trowColumns.push('<a class=\"modify-link\" data-rowId=\"' + event.entityid + '\" href=\"javascript:;\">");
          out.print( UnicodeFormatter.toString(removeGroupIcon) );
          out.write("</a>');\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tsearchContainer.deleteRow(1, searchContainer.getData());\n");
          out.write("\t\t\t\t\t\tsearchContainer.addRow(rowColumns, event.entityid);\n");
          out.write("\t\t\t\t\t\tsearchContainer.updateDataStore(event.entityid);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tA.one('#");
