...
int trashEntriesMaxAge = PropertiesParamUtil.getInteger(groupTypeSettings, request, "trashEntriesMaxAge", PrefsPropsUtil.getInteger(company.getCompanyId(), PropsKeys.TRASH_ENTRIES_MAX_AGE));
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar trashEnabledCheckbox = $('#");
          if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("trashEnabled');\n");
          out.write("\n");
          out.write("\tvar trashEnabledDefault = trashEnabledCheckbox.prop('checked');\n");
          out.write("\n");
          out.write("\ttrashEnabledCheckbox.on(\n");
          out.write("\t\t'change',\n");
          out.write("\t\tfunction(event) {\n");
          out.write("\t\t\tvar trashEnabled = trashEnabledCheckbox.prop('checked');\n");
          out.write("\n");
          ...
          out.write("')) {\n");
          out.write("\t\t\t\t\ttrashEnabledCheckbox.prop('checked', true);\n");
          out.write("\n");
