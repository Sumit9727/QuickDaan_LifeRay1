...
for (long defaultTeamId : defaultTeamIds) {
	...
	defaultTeams.add(team);
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar bindModifyLink = function(config) {\n");
          out.write("\t\tvar searchContainer = config.searchContainer;\n");
          out.write("\n");
          ...
          out.write("\n");
          out.write("\t\t\t\tsearchContainer.deleteRow(link.ancestor('tr'), link.getAttribute('data-rowId'));\n");
          out.write("\t\t\t},\n");
          out.write("\t\t\t'.modify-link'\n");
          out.write("\t\t);\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tvar bindSelectLink = function(config) {\n");
          out.write("\t\tvar searchContainer = config.searchContainer;\n");
          out.write("\n");
          out.write("\t\tA.one(config.linkId).on(\n");
          out.write("\t\t\t'click',\n");
          out.write("\t\t\tfunction(event) {\n");
          ...
          out.write("\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\tvar ids = A.one(config.inputId).val();\n");
          out.write("\n");
          out.write("\t\t\t\tvar uri = Liferay.Util.addParams(config.urlParam + '=' + ids, config.uri);\n");
          out.write("\n");
          ...
          out.write("\t\t\t\t\t\t\tA.Escape.html(event.entityname),\n");
          out.write("\t\t\t\t\t\t\t'<a class=\"modify-link\" data-rowId=\"' + entityId + '\" href=\"javascript:;\">");
	...
	String selectSiteRolePortletId = PortletProviderUtil.getPortletId(Role.class.getName(), PortletProvider.Action.BROWSE);
          ...
          out.write("\n");
          out.write("\n");
          out.write("\tvar siteRolesConfig = {\n");
          out.write("\t\tid: '");
          if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("selectSiteRole',\n");
          out.write("\t\tidAttr: 'roleid',\n");
          out.write("\t\tinputId: '#");
          ...
          out.write("\t};\n");
          out.write("\n");
          out.write("\tbindModifyLink(siteRolesConfig);\n");
          out.write("\tbindSelectLink(siteRolesConfig);\n");
          out.write("\n");
          out.write("\t");
	...
	String selectTeamPortletId = PortletProviderUtil.getPortletId(Team.class.getName(), PortletProvider.Action.BROWSE);
          ...
          out.write("\n");
          out.write("\n");
          out.write("\tvar teamsConfig = {\n");
          out.write("\t\tid: '");
          if (_jspx_meth_portlet_namespace_4((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("selectTeam',\n");
          out.write("\t\tidAttr: 'teamid',\n");
          out.write("\t\tinputId: '#");
          ...
          out.write("\t};\n");
          out.write("\n");
          out.write("\tbindModifyLink(teamsConfig);\n");
          out.write("\tbindSelectLink(teamsConfig);\n");
