...
if (
 (childSitesCount > 0) && (row != null) ) {
          ...
          out.write("\t\t");
if (
 siteAdminDisplayContext.hasAddChildSitePermission(group) ) {
          out.write("\n");
          out.write("\t\t\t");
          //  liferay-portlet:renderURL
		...
		PortletURL viewSiteSettingsURL = PortalUtil.getControlPanelPortletURL(request, group, SiteAdminPortletKeys.SITE_SETTINGS, 0, 0, PortletRequest.RENDER_PHASE);
          ...
          out.write("\t");
if (
 group.isActive() && (group.getPublicLayoutsPageCount() > 0) ) {
          out.write("\n");
          out.write("\t\t");
          //  liferay-ui:icon
          ...
          out.write("\t");
if (
 group.isActive() && (group.getPrivateLayoutsPageCount() > 0) ) {
          out.write("\n");
          out.write("\t\t");
          //  liferay-ui:icon
          ...
          out.write("\t");
if (
 siteAdminDisplayContext.hasEditAssignmentsPermission(group, organizationUser, userGroupUser) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
          ...
          out.write("\t\t");
if (
 group.isActive() && !group.isCompany() && !group.isGuest() && hasUpdatePermission ) {
          out.write("\n");
          out.write("\t\t\t");
          //  portlet:actionURL
 ...
 !group.isActive() && !group.isCompany() && hasUpdatePermission ) {
          out.write("\n");
          out.write("\t\t\t");
          //  portlet:actionURL
          ...
          out.write("\t");
if (
 siteAdminDisplayContext.hasDeleteGroupPermission(group) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
