...
public final class edit_005flayout_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/META-INF/liferay-layout.tld");
...
String title = GetterUtil.getString(request.getAttribute(WebKeys.TITLE));
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"form-group input-text-wrapper text-default\">\n");
      out.write("\t<div class=\"d-inline-block\" id=\"");
...
if (selLayout != null) {
	itemSelectorURL.setParameter("layoutUuid", selLayout.getUuid());
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar groupId = A.one('#");
          if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("groupId');\n");
          out.write("\tvar layoutItemRemove = A.one('#");
          if (_jspx_meth_portlet_namespace_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("layoutItemRemove');\n");
          out.write("\tvar layoutNameInput = A.one('#");
          if (_jspx_meth_portlet_namespace_4((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("layoutNameInput');\n");
          out.write("\tvar layoutUuid = A.one('#");
          if (_jspx_meth_portlet_namespace_5((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("layoutUuid');\n");
          out.write("\tvar privateLayout = A.one('#");
          ...
          out.write("\t\t\t\t\t\t\t\tgroupId.val(selectedItem.groupId);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\tlayoutUuid.val(selectedItem.id);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\tprivateLayout.val(selectedItem.privateLayout);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\tlayoutNameInput.html(selectedItem.name);\n");
          out.write("\t\t\t\t\t\t\t\tlayoutNameInput.simulate('change');\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\tlayoutItemRemove.removeClass('hide');\n");
          out.write("\t\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t},\n");
          ...
          out.write("\t);\n");
          out.write("\n");
          out.write("\tlayoutItemRemove.on(\n");
          out.write("\t\t'click',\n");
          out.write("\t\tfunction(event) {\n");
          out.write("\t\t\tlayoutNameInput.html('");
          if (_jspx_meth_liferay$1ui_message_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("');\n");
          out.write("\n");
          out.write("\t\t\tlayoutUuid.val('');\n");
          out.write("\n");
          out.write("\t\t\tlayoutItemRemove.addClass('hide');\n");
          out.write("\t\t}\n");
          out.write("\t);\n");
