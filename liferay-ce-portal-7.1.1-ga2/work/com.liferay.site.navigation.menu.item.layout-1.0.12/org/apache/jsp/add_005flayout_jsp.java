  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\tfunction(selectLayout) {\n");
        out.write("\t\t\tselectLayout.on(\n");
        out.write("\t\t\t\t'");
        if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("selectLayout',\n");
        out.write("\t\t\t\tfunction(event) {\n");
        out.write("\t\t\t\t\tvar selectedItems = event.data;\n");
        out.write("\n");
        out.write("\t\t\t\t\tif (selectedItems) {\n");
        out.write("\t\t\t\t\t\tvar layoutUuids = selectedItems.reduce(\n");
        out.write("\t\t\t\t\t\t\tfunction(previousValue, currentValue) {\n");
        out.write("\t\t\t\t\t\t\t\treturn previousValue.concat([currentValue.id]);\n");
        out.write("\t\t\t\t\t\t\t},\n");
        out.write("\t\t\t\t\t\t\t[]\n");
        out.write("\t\t\t\t\t\t);\n");
        out.write("\n");
        out.write("\t\t\t\t\t\tlayoutUuid.val(layoutUuids.join());\n");
        out.write("\t\t\t\t\t}\n");
        out.write("\t\t\t\t}\n");
        out.write("\t\t\t);\n");
        out.write("\t\t}\n");
