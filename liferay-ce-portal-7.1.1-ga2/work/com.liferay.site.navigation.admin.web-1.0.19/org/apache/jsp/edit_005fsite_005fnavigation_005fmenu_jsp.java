...
renderResponse.setTitle(siteNavigationAdminDisplayContext.getSiteNavigationMenuName());
      ...
      out.write("\n");
      out.write("\n");
      out.write("<nav class=\"management-bar management-bar-light navbar navbar-expand-md site-navigation-management-bar\">\n");
      out.write("\t<div class=\"container\">\n");
      out.write("\t\t<ul class=\"navbar-nav\"></ul>\n");
      out.write("\n");
      out.write("\t\t<ul class=\"navbar-nav\">\n");
      out.write("\t\t\t<li class=\"nav-item\">\n");
      out.write("\t\t\t\t<button class=\"btn btn-unstyled nav-link nav-link-monospaced\" id=\"");
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"container-fluid-1280 contextual-sidebar-content site-navigation-content\">\n");
      out.write("\t<div class=\"lfr-search-container-wrapper site-navigation-menu-container\">\n");
      out.write("\n");
      out.write("\t\t");
      ...
      out.write("\t\t\t");
if (
 siteNavigationMenuItems.size() > 0 ) {
      out.write("\n");
      out.write("\t\t\t\t<div class=\"hide\" data-site-navigation-menu-item-id=\"0\"></div>\n");
      out.write("\n");
      out.write("\t\t\t\t");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar addMenuItemClickHandler = dom.delegate(\n");
          ...
          out.write("\t\t\t\t\ttitle: event.delegateTarget.title || event.delegateTarget.innerText,\n");
          out.write("\t\t\t\t\turi: event.delegateTarget.href\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t);\n");
          out.write("\t\t}\n");
          out.write("\t);\n");
          out.write("\n");
          out.write("\tvar destroyAddMenuItemClickHandler = function() {\n");
          out.write("\t\tif (addMenuItemClickHandler) {\n");
          out.write("\t\t\taddMenuItemClickHandler.removeListener();\n");
          out.write("\n");
          out.write("\t\t\taddMenuItemClickHandler = null;\n");
          out.write("\t\t}\n");
          out.write("\n");
          out.write("\t\tLiferay.detach('");
          out.print( portletDisplay.getId() );
          out.write(":portletRefreshed', destroyAddMenuItemClickHandler);\n");
          out.write("\t\tLiferay.detach('destroyPortlet', destroyAddMenuItemClickHandler);\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tLiferay.on('");
          out.print( portletDisplay.getId() );
          out.write(":portletRefreshed', destroyAddMenuItemClickHandler);\n");
          out.write("\tLiferay.on('destroyPortlet', destroyAddMenuItemClickHandler);\n");
      ...
      if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\tvar showSiteNavigationMenuSettingsButtonClickHandler = null;\n");
          out.write("\tvar sidebar = null;\n");
          out.write("\tvar sidebarBodyChangeHandler = null;\n");
          out.write("\tvar siteNavigationMenuEditor = null;\n");
          out.write("\tvar siteNavigationMenuItemRemoveButtonClickHandler = null;\n");
          out.write("\tvar siteNavigationMenuItemRemoveButtonKeyupHandler = null;\n");
          out.write("\n");
          out.write("\tvar closeSidebar = function() {\n");
          out.write("\t\tlet form = document.querySelector('#");
          if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_1, _jspx_page_context))
            return;
          out.write("fm');\n");
          out.write("\t\tlet error = form ? form.querySelector(\"[role='alert']\") : null;\n");
          out.write("\n");
          out.write("\t\tvar saveChanges = false;\n");
          out.write("\n");
          out.write("\t\tif (changed) {\n");
          out.write("\t\t\tif (!error) {\n");
          out.write("\t\t\t\tsaveChanges = confirm(\n");
          out.write("\t\t\t\t\t'");
          ...
          out.write("\t\telse {\n");
          out.write("\t\t\tif (!error) {\n");
          out.write("\t\t\t\tif (sidebarBodyChangeHandler) {\n");
          out.write("\t\t\t\t\tsidebarBodyChangeHandler.detach();\n");
          out.write("\n");
          out.write("\t\t\t\t\tsidebarBodyChangeHandler = null;\n");
          out.write("\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\tsidebar.body = '';\n");
          out.write("\t\t\t\tsidebar.visible = false;\n");
          out.write("\n");
          out.write("\t\t\t\tchanged = false;\n");
          out.write("\t\t\t}\n");
          out.write("\t\t}\n");
          out.write("\n");
          out.write("\t\treturn !saveChanges;\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tvar handleSelectedMenuItemChanged = function(event) {\n");
          out.write("\t\tconst siteNavigationMenuItem = event.newVal;\n");
          out.write("\n");
          out.write("\t\tif (!closeSidebar() || !siteNavigationMenuItem) {\n");
          out.write("\t\t\treturn;\n");
          out.write("\t\t}\n");
          out.write("\n");
          ...
          out.write("',\n");
          out.write("\t\t\t\tsiteNavigationMenuItemId: siteNavigationMenuItem.dataset.siteNavigationMenuItemId\n");
          out.write("\t\t\t}\n");
          out.write("\t\t);\n");
          out.write("\n");
          out.write("\t\topenSidebar(siteNavigationMenuItem.dataset.title);\n");
          out.write("\n");
          out.write("\t\tAUI().use(\n");
          out.write("\t\t\t['aui-base'],\n");
          out.write("\t\t\tfunction(A) {\n");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\tsetSidebarBody(responseData);\n");
          out.write("\t\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t);\n");
          ...
          out.write("\t};\n");
          out.write("\n");
          out.write("\tvar handlePortletDestroy = function() {\n");
          out.write("\t\tsidebar.dispose();\n");
          out.write("\t\tsiteNavigationMenuEditor.dispose();\n");
          out.write("\t\tsiteNavigationMenuItemRemoveButtonClickHandler.detach();\n");
          out.write("\t\tsiteNavigationMenuItemRemoveButtonKeyupHandler.detach();\n");
          out.write("\t\tshowSiteNavigationMenuSettingsButtonClickHandler.detach();\n");
          out.write("\n");
          out.write("\t\tsidebar = null;\n");
          out.write("\t\tsiteNavigationMenuEditor = null;\n");
          out.write("\t\tsiteNavigationMenuItemRemoveButtonClickHandler = null;\n");
          out.write("\t\tsiteNavigationMenuItemRemoveButtonKeyupHandler = null;\n");
          out.write("\t\tshowSiteNavigationMenuSettingsButtonClickHandler = null;\n");
          out.write("\n");
          out.write("\t\tLiferay.detach('");
          out.print( portletDisplay.getId() );
          out.write(":portletRefreshed', handlePortletDestroy);\n");
          out.write("\t\tLiferay.detach('destroyPortlet', handlePortletDestroy);\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tvar handleShowSiteNavigationMenuSettingsButtonClick = function(event) {\n");
          out.write("\t\tif (!closeSidebar()) {\n");
          ...
          out.write("\t\t);\n");
          out.write("\n");
          out.write("\t\tsiteNavigationMenuItemDOMHandlerModule.unselectAll();\n");
          out.write("\n");
          ...
          out.write("\t};\n");
          out.write("\n");
          out.write("\tvar handleSidebarBodyChange = function() {\n");
          out.write("\t\tchanged = true;\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tvar handleSidebarCloseButtonClick = function() {\n");
          out.write("\t\tcloseSidebar();\n");
          out.write("\t\tsiteNavigationMenuItemDOMHandlerModule.unselectAll();\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tvar handleSiteNavigationMenuItemRemoveIconClick = function(event) {\n");
          out.write("\t\tevent.stopPropagation();\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tvar handleSiteNavigationMenuItemRemoveIconKeyup = function(event) {\n");
          out.write("\t\tif (event.which === 32) {\n");
          out.write("\t\t\tevent.preventDefault();\n");
          out.write("\t\t\tevent.stopPropagation();\n");
          out.write("\t\t\tevent.target.getDOMNode().click();\n");
          out.write("\t\t}\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tvar openSidebar = function(title) {\n");
          out.write("\t\tsidebar.body = '<div id=\"");
          ...
          out.write("\t\tsidebar.header = '<div class=\"autofit-row sidebar-section\"><div class=\"autofit-col autofit-col-expand\"><h4 class=\"component-title\"><span class=\"text-truncate-inline\"><span class=\"text-truncate\">' + title + '</span></span></h4></div><div class=\"autofit-col\"><button class=\"btn btn-monospaced btn-unstyled\" id=\"");
          ...
          out.write("\t\tsidebar.visible = true;\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tvar setSidebarBody = function(content) {\n");
          out.write("\t\tAUI().use(\n");
          out.write("\t\t\t['aui-base', 'aui-parse-content'],\n");
          out.write("\t\t\tfunction(A) {\n");
          out.write("\t\t\t\tvar sidebarBody = A.one('#");
          ...
          out.write("\t\t\t\tvar sidebarHeaderButton = A.one('#");
          ...
          out.write("\n");
          out.write("\t\t\t\tif (sidebarBody) {\n");
          out.write("\t\t\t\t\tsidebarBody.plug(A.Plugin.ParseContent);\n");
          out.write("\n");
          out.write("\t\t\t\t\tsidebarBody.setContent(content);\n");
          out.write("\t\t\t\t\tsidebarBodyChangeHandler = sidebarBody.on('change', handleSidebarBodyChange);\n");
          out.write("\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\tif (sidebarHeaderButton) {\n");
          out.write("\t\t\t\t\tsidebarHeaderButton.on('click', handleSidebarCloseButtonClick);\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t}\n");
          out.write("\t\t);\n");
          out.write("\t};\n");
          ...
          out.write("\t)\n");
          out.write("\t.then(\n");
          out.write("\t\tfunction(_sidebar) {\n");
          out.write("\t\t\tsidebar = _sidebar;\n");
          out.write("\n");
          out.write("\t\t\tsidebar.on('hide', closeSidebar);\n");
          out.write("\n");
          out.write("\t\t\tsiteNavigationMenuEditor = new siteNavigationMenuEditorModule.default(\n");
          out.write("\t\t\t\t{\n");
          out.write("\t\t\t\t\teditSiteNavigationMenuItemParentURL: '");
          //  portlet:actionURL
          ...
          out.write("\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\tsiteNavigationMenuEditor.on(\n");
          out.write("\t\t\t\t'selectedMenuItemChanged',\n");
          out.write("\t\t\t\thandleSelectedMenuItemChanged\n");
          out.write("\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\tAUI().use(\n");
          out.write("\t\t\t\t['aui-base'],\n");
          out.write("\t\t\t\tfunction(A) {\n");
          out.write("\t\t\t\t\tsiteNavigationMenuItemRemoveButtonClickHandler = A\n");
          out.write("\t\t\t\t\t\t.all('.site-navigation-menu-item__remove-icon')\n");
          out.write("\t\t\t\t\t\t.on('click', handleSiteNavigationMenuItemRemoveIconClick);\n");
          out.write("\n");
          out.write("\t\t\t\t\tsiteNavigationMenuItemRemoveButtonKeyupHandler = A\n");
          out.write("\t\t\t\t\t\t.all('.site-navigation-menu-item__remove-icon')\n");
          out.write("\t\t\t\t\t\t.on('keyup', handleSiteNavigationMenuItemRemoveIconKeyup);\n");
          out.write("\n");
          out.write("\t\t\t\t\tshowSiteNavigationMenuSettingsButtonClickHandler = A\n");
          out.write("\t\t\t\t\t\t.one('#");
          ...
          out.write("\t\t\t\t\t\t.on('click', handleShowSiteNavigationMenuSettingsButtonClick);\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\tLiferay.on('");
          out.print( portletDisplay.getId() );
          out.write(":portletRefreshed', handlePortletDestroy);\n");
          out.write("\t\t\tLiferay.on('destroyPortlet', handlePortletDestroy);\n");
          out.write("\t\t}\n");
          out.write("\t);\n");
