...
PortletURL portletURL = renderResponse.createRenderURL();
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write('	');
if (
 SiteNavigationMenuPermission.contains(permissionChecker, siteNavigationMenu, ActionKeys.UPDATE) && siteNavigationAdminDisplayContext.hasEditPermission() ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
...
if (
 SiteNavigationMenuPermission.contains(permissionChecker, siteNavigationMenu, ActionKeys.UPDATE) && siteNavigationAdminDisplayContext.hasEditPermission() ) {
		...
		updateSiteNavigationMenuData.put("main-field-value", siteNavigationMenu.getName());
          ...
          out.write("\t");
if (
 SiteNavigationMenuPermission.contains(permissionChecker, siteNavigationMenu, ActionKeys.PERMISSIONS) && siteNavigationAdminDisplayContext.hasEditPermission() ) {
          out.write("\n");
          out.write("\t\t");
...
if (
 SiteNavigationMenuPermission.contains(permissionChecker, siteNavigationMenu, ActionKeys.UPDATE) && siteNavigationAdminDisplayContext.hasEditPermission() ) {
          out.write("\n");
          out.write("\t\t<div class=\"border-top dropdown-subheader\">\n");
          out.write("\t\t\t");
          if (_jspx_meth_liferay$1ui_message_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1ui_icon$1menu_0, _jspx_page_context))
            return;
          out.write("\n");
          out.write("\t\t</div>\n");
          out.write("\n");
		...
		String taglibOnClickSecondary = "submitForm(document.hrefFm, '" + markAsSecondaryURL + "');";
          ...
          _jspx_th_liferay$1portlet_actionURL_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1menu_0);
		...
		String taglibOnClickSocial = "submitForm(document.hrefFm, '" + markAsSocialURL + "');";
          ...
          _jspx_th_liferay$1portlet_actionURL_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1menu_0);
		...
		String taglibOnClickPrivate = "submitForm(document.hrefFm, '" + markAsPrivteURL + "');";
          ...
          out.write("\t");
if (
 SiteNavigationMenuPermission.contains(permissionChecker, siteNavigationMenu, ActionKeys.DELETE) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1ui_icon$1menu_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1menu_0);
