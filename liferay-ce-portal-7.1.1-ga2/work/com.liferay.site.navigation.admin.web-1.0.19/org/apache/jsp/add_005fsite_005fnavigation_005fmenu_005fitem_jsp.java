...
renderResponse.setTitle(LanguageUtil.format(request, "add-x", siteNavigationMenuItemType.getLabel(locale)));
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar addButton = $('#");
          if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("addButton');\n");
          out.write("\n");
          out.write("\taddButton.on(\n");
          out.write("\t\t'click',\n");
          out.write("\t\tfunction() {\n");
          ...
          out.write("\n");
          out.write("\t\t\tArray.prototype.slice.call(\n");
          out.write("\t\t\t\tform.querySelectorAll('input')\n");
          out.write("\t\t\t).forEach(\n");
          out.write("\t\t\t\tfunction(input) {\n");
          out.write("\t\t\t\t\tif (input.name && input.value) {\n");
          out.write("\t\t\t\t\t\tformData.append(input.name, input.value);\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\tvar formValidator = Liferay.Form.get('");
          ...
          out.write("\t\t\t).then(\n");
          out.write("\t\t\t\tfunction(response) {\n");
          out.write("\t\t\t\t\tif (response.siteNavigationMenuItemId) {\n");
          ...
          out.write("\t\t\t\t\t\t\t\ticon: 'exclamation-circle',\n");
          out.write("\t\t\t\t\t\t\t\tmessage: response.errorMessage,\n");
