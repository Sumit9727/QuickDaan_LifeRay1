...
if (
 !colorSchemes.isEmpty() ) {
      ...
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t<div class=\"color-scheme-selector img-thumbnail ");
      ...
      out.write("\">\n");
      out.write("\t\t\t\t<div class=\"aspect-ratio aspect-ratio-4-to-3 aspect-ratio-middle\">\n");
 ...
 !colorSchemes.isEmpty() ) {
  ...
  private boolean _jspx_meth_aui_script_1(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\n");
        out.write("\t\tvar colorSchemesContainer = A.one('#");
        if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_1, _jspx_page_context))
          return true;
        out.write("colorSchemesContainer');\n");
        out.write("\n");
        out.write("\t\tcolorSchemesContainer.delegate(\n");
        out.write("\t\t\t'click',\n");
        out.write("\t\t\tfunction(event) {\n");
        out.write("\t\t\t\tvar currentTarget = event.currentTarget;\n");
        out.write("\n");
        out.write("\t\t\t\tcolorSchemesContainer.all('.color-scheme-selector').removeClass('selected');\n");
        out.write("\n");
        out.write("\t\t\t\tcurrentTarget.addClass('selected');\n");
        out.write("\n");
        out.write("\t\t\t\tA.one('#");
        ...
        out.write("\t\t\t},\n");
        out.write("\t\t\t'.color-scheme-selector'\n");
        out.write("\t\t);\n");
        out.write("\t");
