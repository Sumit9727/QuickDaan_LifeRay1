...
if (
 ...
 selectLayoutPageTemplateEntryDisplayContext.isBasicPages() ) {
      out.write("\n");
      out.write("\t\t\t\t\t\t\t");
...
if (
 Validator.isNotNull(autoSiteNavigationMenuNames) ) {
          ...
          out.write("',\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\tidFieldName: 'TypeSettingsProperties--layoutPageTemplateEntryId--',\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\tidFieldValue: actionElement.dataset.layoutPageTemplateEntryId,\n");
