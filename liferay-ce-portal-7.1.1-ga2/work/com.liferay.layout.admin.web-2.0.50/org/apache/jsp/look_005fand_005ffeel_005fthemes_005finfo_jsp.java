...
if (
 (selPluginPackage != null) && Validator.isNotNull(selPluginPackage.getAuthor()) ) {
          out.write("\n");
          out.write("\t\t\t\t\t<h4>");
          if (_jspx_meth_liferay$1ui_message_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_col_1, _jspx_page_context))
            return;
          out.write("</h4>\n");
          out.write("\n");
          out.write("\t\t\t\t\t<p class=\"text-default\">\n");
          ...
          _jspx_th_aui_a_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_col_1);
...
if (
 (selPluginPackage != null) && Validator.isNotNull(selPluginPackage.getShortDescription()) ) {
      ...
      out.write("\t\t");
if (
 !colorSchemes.isEmpty() && Validator.isNotNull(selColorScheme) ) {
      out.write("\n");
      out.write("\t\t\t<h4>");
      ...
      out.write("</h4>\n");
      out.write("\n");
      out.write("\t\t\t<img alt=\"\" class=\"img-thumbnail theme-screenshot\" src=\"");
      out.print( themeDisplay.getCDNBaseURL() );
      out.print( HtmlUtil.escapeAttribute(selTheme.getStaticResourcePath()) );
...
if (
 !configurableSettings.isEmpty() ) {
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_col_1, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_col_1);
