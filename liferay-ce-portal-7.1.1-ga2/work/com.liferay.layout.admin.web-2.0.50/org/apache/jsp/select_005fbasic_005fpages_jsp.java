...
SelectLayoutPageTemplateEntryDisplayContext selectLayoutPageTemplateEntryDisplayContext = new SelectLayoutPageTemplateEntryDisplayContext(request);
      ...
      out.write("\t");
if (
 selectLayoutPageTemplateEntryDisplayContext.getPrimaryTypesCount() > 0 ) {
      out.write("\n");
      ...
      out.write("\t\t\t\t\t<div class=\"card card-type-asset\">\n");
      out.write("\t\t\t\t\t\t<div class=\"aspect-ratio\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"aspect-ratio-item-center-middle aspect-ratio-item-fluid layout-type-img\">\n");
      out.write("\t\t\t\t\t\t\t\t<img src=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a class=\"add-layout-action-option\" data-type=\"");
      out.print( primaryType );
...
if (
 selectLayoutPageTemplateEntryDisplayContext.getTypesCount() > 0 ) {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"sticker\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<svg aria-hidden=\"true\" class=\"lexicon-icon lexicon-icon-page\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<h3 class=\"card-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span class=\"text-truncate-inline\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a class=\"add-layout-action-option text-truncate\" data-type=\"");
      out.print( type );
...
String autoSiteNavigationMenuNames = layoutsAdminDisplayContext.getAutoSiteNavigationMenuNames();
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar addLayoutActionOptionQueryClickHandler = dom.delegate(\n");
          out.write("\t\tdocument.body,\n");
          out.write("\t\t'click',\n");
          out.write("\t\t'.add-layout-action-option',\n");
          out.write("\t\tfunction(event) {\n");
          out.write("\t\t\tvar actionElement = event.delegateTarget;\n");
          out.write("\n");
          out.write("\t\t\tmodalCommands.openSimpleInputModal(\n");
          out.write("\t\t\t\t{\n");
          out.write("\t\t\t\t\t");
if (
 Validator.isNotNull(autoSiteNavigationMenuNames) ) {
          out.write("\n");
          out.write("\t\t\t\t\t\tcheckboxFieldLabel: '");
          //  liferay-ui:message
          ...
          _jspx_tagPool_liferay$1ui_message_key_arguments_nobody.reuse(_jspx_th_liferay$1ui_message_2);
          out.write("',\n");
          out.write("\t\t\t\t\t\tcheckboxFieldName: 'TypeSettingsProperties--addToAutoMenus--',\n");
          out.write("\t\t\t\t\t\tcheckboxFieldValue: true,\n");
          out.write("\t\t\t\t\t");
}
          out.write("\n");
          out.write("\n");
          ...
          out.write("',\n");
          out.write("\t\t\t\t\tidFieldName: 'type',\n");
          out.write("\t\t\t\t\tidFieldValue: actionElement.dataset.type,\n");
          ...
          out.write("\t\taddLayoutActionOptionQueryClickHandler.removeListener();\n");
          out.write("\n");
