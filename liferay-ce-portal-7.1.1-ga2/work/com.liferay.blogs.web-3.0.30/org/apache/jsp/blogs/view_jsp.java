...
private List<BlogsEntry> _convertToBlogEntries(List results) throws PortalException, SystemException {
  ...
  static {
    _jspx_dependants = new java.util.ArrayList<String>(26);
...
if (
 results.isEmpty() ) {
      out.write('\n');
      out.write('	');
      if (_jspx_meth_liferay$1ui_empty$1result$1message_0(_jspx_page_context))
        return;
      out.write('\n');
}
      out.write('\n');
...
List<BlogsEntry> blogsEntries = _convertToBlogEntries(results);
      ...
      if (_jspx_eval_liferay$1ddm_template$1renderer_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write("\n");
        out.write("\t<div class=\"widget-mode-simple\">\n");
        out.write("\n");
        out.write("\t\t");
  ...
  private boolean _jspx_meth_liferay$1ui_empty$1result$1message_0(PageContext _jspx_page_context)
          throws Throwable {
    ...
    _jspx_th_liferay$1ui_empty$1result$1message_0.setParent(null);
