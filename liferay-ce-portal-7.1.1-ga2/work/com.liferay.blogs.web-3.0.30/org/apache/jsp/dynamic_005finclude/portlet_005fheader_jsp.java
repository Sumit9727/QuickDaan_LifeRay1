...
BlogsGroupServiceOverriddenConfiguration blogsGroupServiceOverriddenConfiguration = ConfigurationProviderUtil.getConfiguration(BlogsGroupServiceOverriddenConfiguration.class, new GroupServiceSettingsLocator(themeDisplay.getSiteGroupId(), BlogsConstants.SERVICE_NAME));
      ...
      out.write("\t");
if (
 blogsGroupServiceOverriddenConfiguration.enableRss() ) {
      out.write("\n");
      out.write("\n");
      out.write("\t\t");
	...
	BlogsGroupServiceSettings blogsGroupServiceSettings = BlogsGroupServiceSettings.getInstance(scopeGroupId);
      ...
      out.write("\t");
if (
 BlogsPermission.contains(permissionChecker, scopeGroupId, ActionKeys.SUBSCRIBE) && (blogsGroupServiceSettings.isEmailEntryAddedEnabled() || blogsGroupServiceSettings.isEmailEntryUpdatedEnabled()) ) {
      out.write("\n");
      out.write("\t\t<div class=\"btn-group-item\">\n");
      out.write("\t\t\t");
      out.write("\n");
      out.write("\t\t\t\t");
if (
 SubscriptionLocalServiceUtil.isSubscribed(company.getCompanyId(), user.getUserId(), BlogsEntry.class.getName(), scopeGroupId) ) {
      out.write("\n");
      out.write("\t\t\t\t\t");
      //  portlet:actionURL
...
if (
 BlogsPermission.contains(permissionChecker, scopeGroupId, ActionKeys.ADD_ENTRY) ) {
      ...
      _jspx_th_clay_link_3.setParent(null);
