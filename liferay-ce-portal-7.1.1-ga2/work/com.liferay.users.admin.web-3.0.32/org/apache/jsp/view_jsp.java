...
if (
 ...
 portletName.equals(UsersAdminPortletKeys.MY_ORGANIZATIONS) || usersListView.equals(UserConstants.LIST_VIEW_FLAT_ORGANIZATIONS) ) {
      out.write("\n");
      out.write("\t\t");
      //  liferay-util:include
 ...
 usersListView.equals(UserConstants.LIST_VIEW_FLAT_USERS) ) {
      out.write("\n");
      out.write("\n");
      out.write("\t\t");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("').val(cmd);\n");
          out.write("\t\t\tform.fm('redirect').val(form.fm('usersRedirect').val());\n");
          out.write("\t\t\tform.fm('deleteUserIds').val(Liferay.Util.listCheckedExcept(form, '");
          ...
          out.write("\t\t\t\tvar count = parseInt(responseData, 10);\n");
          out.write("\n");
          ...
          out.write("\t\t\t\t\t\tstatus,\n");
          out.write("\t\t\t\t\t\tfunction(responseData) {\n");
          out.write("\t\t\t\t\t\t\tcount = parseInt(responseData, 10);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\tif (count > 0) {\n");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\tif (ids && (ids.toString().split(',').length > 1)) {\n");
          out.write("\t\t\t\t\t\t\t\t\tmessage = '");
          ...
          out.print( Constants.DELETE );
          out.write("');\n");
          out.write("\t\tform.fm('redirect').val(form.fm('organizationsRedirect').val());\n");
          out.write("\t\tform.fm('deleteOrganizationIds').val(organizationIds);\n");
          out.write("\n");
          out.write("\t\tsubmitForm(form, '");
		...
		if (Validator.isNotNull(viewUsersRedirect)) {
          ...
          out.write("\t\tfunction(organizationId) {\n");
          out.write("\t\t\tvar A = AUI();\n");
          out.write("\n");
          out.write("\t\t\tvar form = AUI.$(document.");
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\t\tvar selectUsersURL = Liferay.PortletURL.createURL('");
          out.print( selectUsersURL.toString() );
          out.write("');\n");
          out.write("\n");
          out.write("\t\t\tselectUsersURL.setParameter('organizationId', organizationId);\n");
          out.write("\n");
          ...
          out.write("\t\t\t\t\t\t\tvar data = event.newVal;\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\tif (data) {\n");
          out.write("\t\t\t\t\t\t\t\tvar editAssignmentURL = Liferay.PortletURL.createURL('");
          if (_jspx_meth_portlet_actionURL_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("');\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\teditAssignmentURL.setParameter('addUserIds', data.value);\n");
          out.write("\t\t\t\t\t\t\t\teditAssignmentURL.setParameter('organizationId', organizationId);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\tvar assignmentsRedirectURL = Liferay.PortletURL.createURL('");
          //  portlet:renderURL
          ...
          out.write("');\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\tassignmentsRedirectURL.setParameter('organizationId', organizationId);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\teditAssignmentURL.setParameter('assignmentsRedirect', assignmentsRedirectURL.toString());\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\tsubmitForm(form, editAssignmentURL.toString());\n");
          out.write("\t\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t},\n");
          out.write("\t\t\t\t\tstrings: {\n");
          ...
          if (_jspx_meth_liferay$1ui_message_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("',\n");
          out.write("\t\t\t\t\turl: selectUsersURL.toString()\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\titemSelectorDialog.open();\n");
          out.write("\t\t},\n");
          out.write("\t\t['liferay-item-selector-dialog', 'liferay-portlet-url']\n");
          out.write("\t);\n");
