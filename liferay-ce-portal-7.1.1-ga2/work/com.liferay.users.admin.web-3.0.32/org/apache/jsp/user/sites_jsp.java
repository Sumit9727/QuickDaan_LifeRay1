...
currentURLObj.setParameter("historyKey", renderResponse.getNamespace() + "sites");
      ...
      out.write("\t<span class=\"autofit-padded-no-gutters autofit-row\">\n");
 ...
 !portletName.equals(myAccountPortletId) ) {
      ...
      if (_jspx_eval_liferay$1ui_search$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
		...
		if (selUser != null) {
            ...
            out.write("\t\t");
if (
 !portletName.equals(myAccountPortletId) && (selUser != null) && !SiteMembershipPolicyUtil.isMembershipRequired(selUser.getUserId(), group.getGroupId()) && !SiteMembershipPolicyUtil.isMembershipProtected(permissionChecker, selUser.getUserId(), group.getGroupId()) ) {
            out.write("\n");
            out.write("\t\t\t");
            //  liferay-ui:search-container-column-text
 ...
 !portletName.equals(myAccountPortletId) ) {
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\n");
          out.write("\t\tvar handleOnSelect = A.one('#");
          ...
          out.write("\n");
          out.write("\t\t\t\tif (!searchContainerData.length) {\n");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\trowColumns.push(event.entityname);\n");
          out.write("\t\t\t\t\t\trowColumns.push('');\n");
          out.write("\t\t\t\t\t\trowColumns.push('<a class=\"modify-link\" data-rowId=\"' + entityId + '\" href=\"javascript:;\">");
          out.print( UnicodeFormatter.toString(removeGroupIcon) );
          out.write("</a>');\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tsearchContainer.addRow(rowColumns, entityId);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tsearchContainer.updateDataStore();\n");
          out.write("\n");
          out.write("\t\t\t\t\t\taddGroupIds.push(entityId);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tAArray.removeItem(deleteGroupIds, entityId);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tdocument.");
          ...
          out.write("\t\t);\n");
          out.write("\n");
          out.write("\t\tvar handleOnModifyLink = searchContainerContentBox.delegate(\n");
          out.write("\t\t\t'click',\n");
          out.write("\t\t\tfunction(event) {\n");
          ...
          out.write("\t\t\t\t\tvar selectButton = selectGroup.iframe.node.get('contentWindow.document').one('.selector-button[data-entityid=\"' + rowId + '\"]');\n");
          out.write("\n");
          ...
          out.write("\t\t);\n");
          out.write("\n");
          out.write("\t\tvar handleEnableRemoveSite = Liferay.on(\n");
          out.write("\t\t\t'");
          ...
          out.write("\t\t\t\t\t\tvar groupId = item.attr('data-entityid');\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tif (deleteGroupIds.indexOf(groupId) != -1) {\n");
          ...
          out.write("') {\n");
          out.write("\t\t\t\tLiferay.detach(handleOnSelect);\n");
          out.write("\t\t\t\tLiferay.detach(handleOnModifyLink);\n");
          out.write("\t\t\t\tLiferay.detach(handleEnableRemoveSite);\n");
          out.write("\n");
