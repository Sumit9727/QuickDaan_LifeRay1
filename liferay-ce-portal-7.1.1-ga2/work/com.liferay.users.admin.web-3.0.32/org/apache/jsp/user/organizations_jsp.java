 ...
 !portletName.equals(myAccountPortletId) ) {
      ...
      if (_jspx_eval_liferay$1ui_search$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
		...
		if (selUser != null) {
            ...
            out.write("\t\t");
if (
 !portletName.equals(myAccountPortletId) && ((selUser == null) || !OrganizationMembershipPolicyUtil.isMembershipProtected(permissionChecker, selUser.getUserId(), organization.getOrganizationId())) ) {
            out.write("\n");
            out.write("\t\t\t");
            //  liferay-ui:search-container-column-text
 ...
 !portletName.equals(myAccountPortletId) ) {
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\t\t\t\tvar selectButton = selectOrganization.iframe.node.get('contentWindow.document').one('.selector-button[data-entityid=\"' + rowId + '\"]');\n");
          out.write("\n");
          ...
          out.write("\t\t\t\t\t\tvar organizationId = item.attr('data-entityid');\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tif (deleteOrganizationIds.indexOf(organizationId) != -1) {\n");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\t\tAArray.removeItem(deleteOrganizationIds, entityId);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\taddOrganizationIds.push(entityId);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\tdocument.");
