      ...
      if (_jspx_eval_liferay$1ui_search$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_liferay$1ui_search$1container$1row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            out.write("\t\t");
if (
 !portletName.equals(myAccountPortletId) && !UserGroupMembershipPolicyUtil.isMembershipRequired((selUser != null) ? selUser.getUserId() : 0, userGroup.getUserGroupId()) ) {
            out.write("\n");
            out.write("\t\t\t");
 ...
 !portletName.equals(myAccountPortletId) ) {
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\tif (deleteUserGroupIds.indexOf(userGroupId) != -1) {\n");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\trowColumns.push(A.Escape.html(event.entityname));\n");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\tA.Array.removeItem(deleteUserGroupIds, entityId);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\taddUserGroupIds.push(entityId);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tdocument.");
