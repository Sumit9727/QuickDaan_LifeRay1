...
if (
 !organizations.isEmpty() ) {
      ...
      _jspx_th_liferay$1ui_search$1container_2.setParent(null);
 ...
 !portletName.equals(myAccountPortletId) ) {
      ...
      if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\t\t\t\t\t\tvar selectButton = selectOrganizationRole.iframe.node.get('contentWindow.document').one('.selector-button[data-groupid=\"' + groupId + '\"][data-entityid=\"' + rowId + '\"]');\n");
          out.write("\n");
          ...
          out.write("\t\t\t\t\t\t\t\tvar roleId = item.attr('data-entityid');\n");
          out.write("\n");
          ...
          out.write("\t\t\t\t\t\t\t\t\t\tUtil.toggleDisabled(item, true);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\t\tbreak;\n");
          out.write("\t\t\t\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t\t\t\t}\n");
...
if (
 !organizations.isEmpty() && !portletName.equals(myAccountPortletId) ) {
      ...
      out.write("\t\t\t");
if (
 !groups.isEmpty() && !portletName.equals(myAccountPortletId) ) {
      out.write("\n");
      out.write("\t\t\t\t<span class=\"autofit-col\">\n");
      out.write("\t\t\t\t\t");
      //  liferay-ui:icon
...
if (
 groups.isEmpty() ) {
      ...
      _jspx_th_liferay$1ui_search$1container_3.setParent(null);
 ...
 !portletName.equals(myAccountPortletId) ) {
      ...
      if (_jspx_eval_aui_script_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\t\t\t\t\t\t\tvar selectButton = selectSiteRole.iframe.node.get('contentWindow.document').one('.selector-button[data-groupid=\"' + groupId + '\"][data-entityid=\"' + rowId + '\"]');\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\tUtil.toggleDisabled(selectButton, false);\n");
          out.write("\t\t\t\t\t\t\t}\n");
          out.write("\n");
...
if (
 !inheritedSiteRoles.isEmpty() ) {
      ...
      _jspx_th_liferay$1ui_search$1container_4.setParent(null);
 ...
 !portletName.equals(myAccountPortletId) ) {
      ...
      if (_jspx_eval_aui_script_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\t\t\tfunction(roleId, name, searchContainer, groupName, groupId, iconCssClass) {\n");
          out.write("\t\t\t\t\tvar A = AUI();\n");
          ...
          out.write("\n");
          out.write("\t\t\t\t\trowColumns.push('<i class=\"' + iconCssClass + '\"></i> ' + LString.escapeHTML(name));\n");
          out.write("\n");
      ...
      if (_jspx_eval_aui_script_5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\t\t\t\t\tvar selectButton = selectRegularRole.iframe.node.get('contentWindow.document').one('.selector-button[data-entityid=\"' + rowId + '\"]');\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tUtil.toggleDisabled(selectButton, false);\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\n");
