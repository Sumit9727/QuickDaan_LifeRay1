...
if (
 Validator.isNull(currentImageURL) || currentImageURL.contains("/spacer.png") ) {
            ...
            out.write("\t\t\t\t\t\t\t\t<label class=\"btn btn-default\" for=\"");
      ...
      if (_jspx_eval_aui_script_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\n");
          out.write("\t\t\t\tif (dialog) {\n");
          out.write("\t\t\t\t\tdialog.on(['resize:end', 'resize:resize', 'resize:start'], logoEditor.resize, logoEditor);\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t}\n");
          out.write("\t\t");
  ...
  private boolean _jspx_meth_aui_script_1(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\n");
        out.write("\t\t\tvar uploadImage = $('#uploadImage');\n");
        out.write("\n");
        out.write("\t\t\tuploadImage.on(\n");
        out.write("\t\t\t\t'keypress',\n");
        out.write("\t\t\t\tfunction(event) {\n");
        out.write("\t\t\t\t\tevent.preventDefault();\n");
        out.write("\n");
        out.write("\t\t\t\t\tif (event.which == 13 || event.which == 32) {\n");
        out.write("\t\t\t\t\t\tuploadImage.trigger('click');\n");
        out.write("\t\t\t\t\t}\n");
        out.write("\t\t\t\t}\n");
        out.write("\t\t\t);\n");
        out.write("\t\t");
