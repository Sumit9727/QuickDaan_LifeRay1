...
navigationURL.setParameter(SearchContainer.DEFAULT_CUR_PARAM, "0");
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"container-fluid-1280 main-content-body\">\n");
      out.write("\t");
      //  aui:form
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        out.write("\n");
        out.write("\t\t<div class=\"user-notifications\">\n");
        out.write("\t\t\t");
...
if (
 !anonymous ) {
              ...
              out.write('	');
if (
 userNotificationFeedEntry == null ) {
              out.write("\n");
              out.write("\t\t");
              //  liferay-ui:search-container-column-text
 ...
 !userNotificationFeedEntry.isApplicable() ) {
              ...
              _jspx_th_portlet_actionURL_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_search$1container$1row_0);
              ...
              if (_jspx_eval_portlet_actionURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                out.write("\t\t\t\t");
if (
 Validator.isNotNull(userNotificationFeedEntry.getLink()) ) {
                out.write("\n");
                out.write("\t\t\t\t\t");
                //  portlet:param
...
if (
 notificationUnread ) {
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar deleteAllNotifications = function() {\n");
          ...
          out.write("\t};\n");
          out.write("\n");
          out.write("\tvar markNotificationsAsRead = function() {\n");
          out.write("\t\tvar form = document.getElementById('");
          ...
          out.write("\t};\n");
          out.write("\n");
          out.write("\tvar markNotificationsAsUnread = function() {\n");
          out.write("\t\tvar form = document.getElementById('");
          ...
          out.write("\t\t'deleteAllNotifications': deleteAllNotifications,\n");
          out.write("\t\t'markNotificationsAsRead': markNotificationsAsRead,\n");
          out.write("\t\t'markNotificationsAsUnread': markNotificationsAsUnread\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tLiferay.componentReady('notificationsManagementToolbar').then(\n");
          out.write("\t\tfunction(managementToolbar) {\n");
          out.write("\t\t\tmanagementToolbar.on(\n");
          out.write("\t\t\t\t'actionItemClicked',\n");
  ...
  private boolean _jspx_meth_aui_script_1(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\t\tcurrentTarget.attr('href'),\n");
        out.write("\t\t\t\t{\n");
        ...
        out.write("\t\t\t\t\t\t\t\tvar notificationContainer = currentTarget.ancestor('li.list-group-item');\n");
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\tif (notificationContainer) {\n");
        out.write("\t\t\t\t\t\t\t\t\tvar markAsReadURL = notificationContainer.one('a').attr('href');\n");
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\tform.attr('method', 'post');\n");
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\tsubmitForm(form, markAsReadURL);\n");
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\tnotificationContainer.remove();\n");
        out.write("\t\t\t\t\t\t\t\t}\n");
        out.write("\t\t\t\t\t\t\t}\n");
        out.write("\t\t\t\t\t\t\telse {\n");
        out.write("\t\t\t\t\t\t\t\tgetNotice().show();\n");
        out.write("\t\t\t\t\t\t\t}\n");
        out.write("\t\t\t\t\t\t}\n");
        out.write("\t\t\t\t\t}\n");
        out.write("\t\t\t\t}\n");
        out.write("\t\t\t);\n");
        out.write("\t\t},\n");
        out.write("\t\t'.user-notification-action'\n");
        out.write("\t);\n");
        out.write("\n");
        out.write("\tvar notice;\n");
        out.write("\n");
        out.write("\tfunction getNotice() {\n");
        out.write("\t\tif (!notice) {\n");
        out.write("\t\t\tnotice = new Liferay.Notice(\n");
        out.write("\t\t\t\t{\n");
        ...
        out.write("\t\t\t\t\tuseAnimation: false\n");
        out.write("\t\t\t\t}\n");
        out.write("\t\t\t);\n");
        out.write("\t\t}\n");
        out.write("\n");
        out.write("\t\treturn notice;\n");
        out.write("\t}\n");
