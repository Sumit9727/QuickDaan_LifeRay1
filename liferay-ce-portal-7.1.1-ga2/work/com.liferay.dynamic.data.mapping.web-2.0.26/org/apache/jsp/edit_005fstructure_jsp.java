...
if (
 ddmDisplay.isShowBackURLInTitleBar() ) {
        ...
        out.write("\t\t");
if (
 (structureVersion != null) && ddmDisplay.isVersioningEnabled() ) {
        out.write("\n");
        out.write("\t\t\t");
        //  aui:workflow-status
        ...
        out.write("\n");
        out.write("\n");
        out.write("\t\t\t<div class=\"structure-history-toolbar\" id=\"");
        ...
        if (_jspx_eval_aui_fieldset$1group_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_aui_field$1wrapper_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              out.write("\t\t\t\t\t");
if (
 (structure != null) && (DDMStorageLinkLocalServiceUtil.getStructureStorageLinksCount(classPK) > 0) ) {
              out.write("\n");
              out.write("\t\t\t\t\t\t<div class=\"alert alert-warning\">\n");
              out.write("\t\t\t\t\t\t\t");
              if (_jspx_meth_liferay$1ui_message_5((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_field$1wrapper_0, _jspx_page_context))
                return;
              out.write("\n");
              out.write("\t\t\t\t\t\t</div>\n");
              out.write("\t\t\t\t\t");
              ...
              out.write("\t\t\t\t\t");
if (
 (classPK > 0) && (DDMTemplateLocalServiceUtil.getTemplatesCount(null, classNameId, classPK) > 0) ) {
              out.write("\n");
              out.write("\t\t\t\t\t\t<div class=\"alert alert-info\">\n");
              out.write("\t\t\t\t\t\t\t");
              if (_jspx_meth_liferay$1ui_message_6((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_field$1wrapper_0, _jspx_page_context))
                return;
              out.write("\n");
              out.write("\t\t\t\t\t\t</div>\n");
              out.write("\t\t\t\t\t");
              ...
              out.write("\t\t\t\t\t");
if (
 (structure != null) && (groupId != scopeGroupId) ) {
              out.write("\n");
              out.write("\t\t\t\t\t\t<div class=\"alert alert-warning\">\n");
              out.write("\t\t\t\t\t\t\t");
              if (_jspx_meth_liferay$1ui_message_7((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_field$1wrapper_0, _jspx_page_context))
                return;
              out.write("\n");
              out.write("\t\t\t\t\t\t</div>\n");
              out.write("\t\t\t\t\t");
              ...
              do {
                ...
                if (_jspx_eval_liferay$1ui_panel_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  if (_jspx_eval_aui_row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                    ...
                    out.write("\t\t\t\t\t\t\t\t");
if (
 Validator.isNull(storageTypeValue) ) {
                    out.write("\n");
                    out.write("\t\t\t\t\t\t\t\t\t");
                    //  aui:col
                    ...
                    _jspx_th_aui_input_10.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_row_0);
                  ...
                  out.write("\t\t\t\t\t\t");
if (
 !ddmDisplayContext.autogenerateStructureKey() ) {
                  out.write("\n");
                  out.write("\t\t\t\t\t\t\t");
                  //  aui:input
                  ...
                  _jspx_th_aui_input_11.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_panel_0);
 ...
 ddmDisplay.isVersioningEnabled() ) {
      ...
      if (_jspx_eval_aui_script_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("fm');\n");
          out.write("\n");
          out.write("\t\t\t\tform.fm('parentStructureId').val(event.ddmstructureid);\n");
          out.write("\n");
          out.write("\t\t\t\tform.fm('parentStructureName').val(Liferay.Util.unescape(event.name));\n");
          out.write("\n");
          out.write("\t\t\t\tform.fm('removeParentStructureButton').attr('disabled', false).removeClass('disabled');\n");
          out.write("\t\t\t}\n");
          out.write("\t\t);\n");
          out.write("\t}\n");
          out.write("\n");
          ...
          out.write("fm');\n");
          out.write("\n");
          out.write("\t\tform.fm('parentStructureId').val('');\n");
          out.write("\t\tform.fm('parentStructureName').val('');\n");
          out.write("\n");
          out.write("\t\tform.fm('removeParentStructureButton').attr('disabled', true).addClass('disabled');\n");
          out.write("\t}\n");
          out.write("\n");
          out.write("\tfunction ");
          ...
          out.write("fm');\n");
          out.write("\n");
          out.write("\t\tform.fm('definition').val(");
  ...
  private boolean _jspx_meth_liferay$1ui_message_5(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_field$1wrapper_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
  ...
  private boolean _jspx_meth_liferay$1ui_message_6(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_field$1wrapper_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_6.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_field$1wrapper_0);
  ...
  private boolean _jspx_meth_liferay$1ui_message_7(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_field$1wrapper_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_7.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_field$1wrapper_0);
