...
boolean includeCheckBox = ParamUtil.getBoolean(request, "includeCheckBox", true);
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar deleteTemplates = function() {\n");
          ...
          out.write("\t\t\tform.fm('deleteTemplateIds').val(Liferay.Util.listCheckedExcept(searchContainer, '");
          ...
          out.write("\t\t'deleteTemplates': deleteTemplates\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tLiferay.componentReady('ddmTemplateManagementToolbar').then(\n");
