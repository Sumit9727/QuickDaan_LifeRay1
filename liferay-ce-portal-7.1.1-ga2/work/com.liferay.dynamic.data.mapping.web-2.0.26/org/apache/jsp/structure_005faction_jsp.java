...
DDMStructure structure = (DDMStructure)row.getObject();
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write('	');
if (
 DDMStructurePermission.contains(permissionChecker, structure, ActionKeys.UPDATE) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
	...
	String editStructureDefaultValuesURL = PortalUtil.escapeRedirect(ddmDisplay.getEditStructureDefaultValuesURL(liferayPortletRequest, liferayPortletResponse, structure, currentURL));
          ...
          out.write("\t");
if (
 Validator.isNotNull(editStructureDefaultValuesURL) && DDMStructurePermission.contains(permissionChecker, structure, ActionKeys.UPDATE) ) {
          out.write("\n");
          out.write("\t\t");
          //  liferay-ui:icon
          ...
          out.write("\t");
if (
 DDMStructurePermission.contains(permissionChecker, structure, ActionKeys.VIEW) && showManageTemplates ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
          ...
          out.write("\t");
if (
 DDMStructurePermission.contains(permissionChecker, structure, ActionKeys.PERMISSIONS) ) {
          out.write("\n");
          out.write("\t\t");
          ...
          out.write("\t");
if (
 ddmDisplay.isShowAddButton(themeDisplay.getScopeGroup()) && DDMStructurePermission.containsAddStructurePermission(permissionChecker, scopeGroupId, structure.getClassNameId()) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
          ...
          out.write("\t");
if (
 DDMStructurePermission.contains(permissionChecker, structure, ActionKeys.DELETE) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
