...
DDMTemplate template = (DDMTemplate)row.getObject();
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write('	');
if (
 DDMTemplatePermission.contains(permissionChecker, template, ActionKeys.UPDATE) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
          ...
          out.write("\t");
if (
 DDMTemplatePermission.contains(permissionChecker, template, ActionKeys.PERMISSIONS) ) {
          out.write("\n");
          out.write("\t\t");
          ...
          out.write("\t");
if (
 ddmDisplay.isShowAddButton(themeDisplay.getScopeGroup()) && DDMTemplatePermission.containsAddTemplatePermission(permissionChecker, scopeGroupId, template.getClassNameId(), template.getResourceClassNameId()) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
          ...
          out.write("\t");
if (
 DDMTemplatePermission.contains(permissionChecker, template, ActionKeys.DELETE) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
