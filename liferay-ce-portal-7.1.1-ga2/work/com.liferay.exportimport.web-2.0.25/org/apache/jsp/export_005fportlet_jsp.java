...
portletURL.setParameter("portletResource", portletResource);
      ...
      out.write('	');
if (
 tabs3.equals("new-export-process") ) {
      out.write("\n");
      out.write("\n");
      out.write("\t\t");
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_aui_fieldset$1group_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          out.write("\t\t\t\t\t\t");
if (
 ArrayUtil.isNotEmpty(configurationControls) ) {
          out.write("\n");
          out.write("\t\t\t\t\t\t\t");
          //  aui:fieldset
          ...
          if (_jspx_eval_aui_fieldset_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            out.write("\n");
            out.write("\t\t\t\t\t\t\t\t<ul class=\"lfr-tree list-unstyled select-options\">\n");
            ...
            out.write("\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"lfr-tree list-unstyled\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"tree-item\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
            //  aui:fieldset
...
if (
 !portletDataHandler.isDisplayPortlet() ) {
          ...
          out.write("\t\t\t\t\t\t\t");
if (
 (exportModelCount != 0) || (modelDeletionCount != 0) || (startDate != null) || (endDate != null) ) {
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t");
          //  aui:fieldset
          ...
          if (_jspx_eval_aui_fieldset_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"flex-item-center range-options\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
            //  aui:input
            ...
            out.write("\n");
            out.write("\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"date-range-options hide list-unstyled\" id=\"");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"flex-container\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
            //  aui:fieldset
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t</ul>\n");
            out.write("\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"hide list-unstyled\" id=\"");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t");
if (
 (exportModelCount != 0) || (modelDeletionCount != 0) ) {
            out.write("\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<li class=\"options\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"portlet-list\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"tree-item\">\n");
            ...
            out.write("\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"hide\" id=\"");
            if (_jspx_meth_portlet_namespace_9((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_fieldset_3, _jspx_page_context))
              return;
            out.write("content_");
            out.print( selPortlet.getRootPortletId() );
            out.write("\">\n");
            ...
            _jspx_th_aui_fieldset_6.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_3);
...
if (
 exportControls != null ) {
              ...
              _jspx_th_aui_field$1wrapper_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_6);
...
if (
 metadataControls != null ) {
              ...
              _jspx_th_aui_field$1wrapper_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_6);
            ...
            out.write("\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<ul id=\"");
            if (_jspx_meth_portlet_namespace_10((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_fieldset_3, _jspx_page_context))
              return;
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"selected-labels\" id=\"");
            if (_jspx_meth_portlet_namespace_11((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_fieldset_3, _jspx_page_context))
              return;
            ...
            _jspx_th_aui_a_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_3);
            ...
            _jspx_th_aui_fieldset_7.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_3);
      ...
      if (_jspx_eval_aui_script_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\n");
          out.write("\t\t\t\t\tvar exportImport = Liferay.component('");
          ...
          out.write("\n");
          out.write("\t\t\t\t\tvar dateChecker = exportImport.getDateRangeChecker();\n");
          out.write("\n");
          out.write("\t\t\t\t\tif (dateChecker.validRange) {\n");
          out.write("\t\t\t\t\t\tsubmitForm(form, form.attr('action'), false);\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t\telse {\n");
          out.write("\t\t\t\t\t\texportImport.showNotification(dateChecker);\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\tvar oldFieldRules = liferayForm.get('fieldRules');\n");
          out.write("\n");
          out.write("\t\t\tvar fieldRules = [\n");
          out.write("\t\t\t\t{\n");
          out.write("\t\t\t\t\tbody: function(val, fieldNode, ruleValue) {\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t");
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tvar blacklistCharJSONArray = ");
          out.print( blacklistCharJSONArray.toJSONString() );
          out.write(";\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tfor (var i = 0; i < blacklistCharJSONArray.length; i++) {\n");
          out.write("\t\t\t\t\t\t\tif (val.indexOf(blacklistCharJSONArray[i]) !== -1) {\n");
          ...
          out.write("\t\t\t\t\tvalidatorName: 'custom_exportFileNameValidator'\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t];\n");
          out.write("\n");
          out.write("\t\tif (oldFieldRules) {\n");
          out.write("\t\t\tfieldRules = fieldRules.concat(oldFieldRules);\n");
          out.write("\t\t}\n");
          out.write("\n");
          out.write("\t\tliferayForm.set('fieldRules', fieldRules);\n");
          out.write("\t\t");
 ...
 tabs3.equals("current-and-previous") ) {
      out.write("\n");
      out.write("\t\t<div class=\"portlet-export-import-export-processes process-list\" id=\"");
      ...
      if (_jspx_eval_aui_script_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\n");
          out.write("\n");
          out.write("\tvar exportImport = new Liferay.ExportImport(\n");
          out.write("\t\t{\n");
          ...
          out.write("\t\tfunction() {\n");
          out.write("\t\t\texportImport.destroy();\n");
          out.write("\t\t}\n");
          out.write("\t);\n");
  ...
  private boolean _jspx_meth_portlet_namespace_9(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_fieldset_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  portlet:namespace
    ...
    _jspx_th_portlet_namespace_9.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_3);
  ...
  private boolean _jspx_meth_portlet_namespace_10(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_fieldset_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  portlet:namespace
    ...
    _jspx_th_portlet_namespace_10.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_3);
  ...
  private boolean _jspx_meth_portlet_namespace_11(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_fieldset_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  portlet:namespace
    ...
    _jspx_th_portlet_namespace_11.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_3);
