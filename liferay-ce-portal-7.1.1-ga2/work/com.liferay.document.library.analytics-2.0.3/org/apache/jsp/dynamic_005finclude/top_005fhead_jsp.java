    ...
    try {
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\n");
          out.write("\t\t\t\tif (match) {\n");
          out.write("\t\t\t\t\tvar groupId = match[1];\n");
          out.write("\t\t\t\t\tvar fileEntryUUID = match[4];\n");
          out.write("\n");
          out.write("\t\t\t\t\tfetch(\n");
          out.write("\t\t\t\t\t\t'");
          ...
          out.write("\t\t\t\t\t\t\t'documentDownloaded',\n");
          out.write("\t\t\t\t\t\t\t'Document',\n");
          out.write("\t\t\t\t\t\t\t{\n");
          out.write("\t\t\t\t\t\t\t\tgroupId: groupId,\n");
          out.write("\t\t\t\t\t\t\t\tfileEntryId: response.fileEntryId,\n");
          out.write("\t\t\t\t\t\t\t\tpreview: !!window.");
          out.print( DocumentLibraryAnalyticsConstants.JS_PREFIX );
          out.write("isViewFileEntry,\n");
          out.write("\t\t\t\t\t\t\t\ttitle: decodeURIComponent(match[3].replace(/\\+/ig, ' ')),\n");
