...
if (
 items > 0 ) {
          out.write("\n");
          out.write("\t\t<span class=\"staging-taglib-checkbox-items\">");
...
if (
 deletions > 0 ) {
          out.write("\n");
          out.write("\t\t<span class=\"deletions staging-taglib-checkbox-deletions\">");
...
if (
 Validator.isNotNull(description) ) {
          out.write("\n");
          out.write("\t\t<span class=\"staging-taglib-checkbox-description\">");
          ...
          out.write("\t");
if (
 Validator.isNotNull(warning) ) {
          out.write("\n");
          out.write("\t\t<span class=\"staging-taglib-checkbox-warning\">");
          ...
          out.write("\t");
if (
 Validator.isNotNull(suggestion) ) {
          out.write("\n");
          out.write("\t\t<span class=\"staging-taglib-checkbox-suggestion\">");
