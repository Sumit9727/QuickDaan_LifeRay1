...
if (
 Validator.isNotNull(text) ) {
      out.write("\n");
      out.write("\t<span class=\"staging-taglib-popover\" id=\"");
      out.print( domId );
      out.write("\">\n");
      out.write("\t\t<span class=\"staging-taglib-popover-icon-holder\">\n");
      out.write("\t\t\t");
      ...
      out.write("\t\t</span>\n");
      out.write("\n");
      out.write("\t\t<div class=\"bs-popover-right popover\">\n");
      out.write("\t\t\t<div class=\"arrow\"></div>\n");
      out.write("\t\t\t<div class=\"inline-scroller\">\n");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t\tA.ready(\"aui-base\", function(A)\n");
          out.write("\t\t\t{\n");
          out.write("\t\t\t\tvar popoverNode = A.one(\"#");
          out.print( domId );
          out.write("\");\n");
          out.write("\n");
          out.write("\t\t\t\tvar popover = popoverNode.one(\".popover\");\n");
          out.write("\n");
          out.write("\t\t\t\tvar arrow = popover.one(\".arrow\");\n");
          out.write("\n");
          out.write("\t\t\t\tvar dx = arrow.width();\n");
          out.write("\t\t\t\tvar dy = arrow.height() / 2;\n");
          out.write("\n");
          out.write("\t\t\t\tvar iconHolderNode = popoverNode.one(\".staging-taglib-popover-icon-holder\");\n");
          out.write("\n");
          out.write("\t\t\t\ticonHolderNode.on(\"hover\", function alignPopoverToIcon(event)\n");
          out.write("\t\t\t\t\t{\n");
          out.write("\t\t\t\t\t\tif (\"visible\" !== popover.get('visibility')) {\n");
          out.write("\t\t\t\t\t\t\tpopover.setXY([iconHolderNode.getX() + iconHolderNode.width() + dx, iconHolderNode.getY() - dy]);\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t);\n");
          out.write("\n");
