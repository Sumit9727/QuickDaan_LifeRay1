...
if (
 layout.isTypePortlet() ) {
        ...
        out.write("\n");
        out.write("\t\t\t\t<h6>");
        if (_jspx_meth_aui_icon_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_form_0, _jspx_page_context))
          return;
        out.write("</h6>\n");
        out.write("\t\t\t</div>\n");
        out.write("\t\t");
        ...
        out.write("\t\t");
if (
 !layout.isTypePanel() && permissionChecker.isOmniadmin() && PortletLocalServiceUtil.hasPortlet(themeDisplay.getCompanyId(), PortletKeys.MARKETPLACE_STORE) ) {
        out.write("\n");
        out.write("\n");
        out.write("\t\t\t");
  ...
  private boolean _jspx_meth_aui_icon_1(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_form_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  aui:icon
    ...
    _jspx_th_aui_icon_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_form_0);
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\n");
        out.write("\tvar ControlMenu = Liferay.ControlMenu;\n");
        out.write("\n");
        out.write("\tvar addApplicationCollapse = A.one('#");
        ...
        out.write("\n");
        out.write("\tif (addApplicationCollapse && searchApplication) {\n");
        out.write("\t\tvar addApplication = new ControlMenu.AddApplication(\n");
        out.write("\t\t\t{\n");
        ...
        out.write("\t\t\t\tpanelBody: addApplicationCollapse\n");
        out.write("\t\t\t}\n");
        out.write("\t\t);\n");
        out.write("\n");
        out.write("\t\tif (ControlMenu.PortletDragDrop) {\n");
        out.write("\t\t\taddApplication.plug(\n");
        out.write("\t\t\t\tControlMenu.PortletDragDrop,\n");
        out.write("\t\t\t\t{\n");
        out.write("\t\t\t\t\ton: {\n");
