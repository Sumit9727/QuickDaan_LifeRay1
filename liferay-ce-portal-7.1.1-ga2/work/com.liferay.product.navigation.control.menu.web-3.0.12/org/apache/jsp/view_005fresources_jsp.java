...
if (Validator.isNotNull(keywords)) {
	panelTitle = "search-results";
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"display-style-bar\">\n");
      out.write("\t<span class=\"dropdown\" id=\"");
      if (_jspx_meth_portlet_namespace_0(_jspx_page_context))
        return;
      out.write("numItemsContainer\">\n");
      out.write("\t\t<a aria-expanded=\"true\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" href=\"javascript:;\">\n");
      out.write("\t\t\t<span class=\"item-title\">");
      out.print( delta );
      out.write("</span>\n");
      out.write("\t\t\t<span class=\"icon-sort\"></span>\n");
      out.write("\t\t</a>\n");
      out.write("\n");
      ...
      out.write("\t\t</ul>\n");
      out.write("\t</span>\n");
      out.write("\t<span class=\"pull-right\" id=\"");
      ...
      out.write("</div>\n");
      out.write("\n");
      out.write("<div class=\"add-content-button\">\n");
      out.write("\n");
      out.write("\t");
	...
	redirectURL.setWindowState(LiferayWindowState.POP_UP);
      ...
      out.write("</div>\n");
      out.write("\n");
      out.write("<div class=\"lfr-content-category panel-page-category\">\n");
      out.write("\t<a class=\"collapse-icon list-group-heading panel-header panel-header-link\" data-toggle=\"collapse\" href=\"#manageRecentPanel\">\n");
      out.write("\t\t");
      //  liferay-ui:message
      ...
      out.write("\t</a>\n");
      out.write("\n");
      out.write("\t<div class=\"collapse in list-group-panel\" id=\"manageRecentPanel\">\n");
...
if (
 displayStyle.equals("icon") ) {
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<li class=\"col-md-6 col-sm-6 col-xs-6 drag-content-item lfr-content-item\" ");
      ...
      out.write("\t\t\t\t\t\t\t\t\t");
if (
 Validator.isNotNull(thumbnailPath) ) {
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
      ...
      _jspx_th_liferay$1frontend_vertical$1card_0.setParent(null);
      ...
      _jspx_th_liferay$1frontend_icon$1vertical$1card_0.setParent(null);
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<li class=\"drag-content-item entry-display-style lfr-content-item list-group-item\" ");
      out.print( AUIUtil.buildData(itemData) );
      out.write(">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\" list-group-item-field\">\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
if (
 Validator.isNotNull(thumbnailPath) ) {
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"user-icon user-icon-square user-icon-xl\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<img alt=\"thumbnail\" class=\"img-responsive img-rounded\" src=\"");
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span class=\"sticker sticker-secondary\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      //  liferay-ui:icon
      ...
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\" list-group-item-content\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<h1>");
      out.print( title );
      out.write("</h1>\n");
      out.write("\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t<h2 class=\"text-default\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
      //  liferay-ui:message
      ...
      out.write("\t\t\t\t\t\t\t\t\t</h2>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t<h3 class=\"text-default\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\tvar delta = event.currentTarget.attr('data-delta');\n");
        out.write("\n");
        out.write("\t\t\tLiferay.fire(\n");
        out.write("\t\t\t\t'AddContent:refreshContentList',\n");
        out.write("\t\t\t\t{\n");
        out.write("\t\t\t\t\tdelta: delta\n");
        out.write("\t\t\t\t}\n");
        out.write("\t\t\t);\n");
        out.write("\t\t},\n");
        out.write("\t\t'.num-item'\n");
        ...
        out.write("\t\t'click',\n");
        out.write("\t\tfunction(event) {\n");
        out.write("\t\t\tvar displayStyle = event.currentTarget.attr('data-displaystyle');\n");
        out.write("\n");
        out.write("\t\t\tLiferay.fire(\n");
        out.write("\t\t\t\t'AddContent:refreshContentList',\n");
        out.write("\t\t\t\t{\n");
