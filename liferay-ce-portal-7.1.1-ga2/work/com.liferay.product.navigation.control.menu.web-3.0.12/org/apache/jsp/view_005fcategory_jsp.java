...
if (!categories.isEmpty() || !portlets.isEmpty()) {
	...
	String title = Validator.isNotNull(externalPortletCategory) ? externalPortletCategory : LanguageUtil.get(request, portletCategory.getName());
      ...
      out.write("\t\t<a class=\"collapse-icon collapse-icon-middle collapsed list-group-heading panel-header panel-header-link\" data-toggle=\"collapse\" href=\"#");
      out.print( panelId );
      out.write("\">\n");
      out.write("\t\t\t");
      out.print( title );
      ...
      out.write("\t\t</a>\n");
      out.write("\n");
      out.write("\t\t<div class=\"collapse list-group-panel\" id=\"");
      out.print( panelId );
      out.write("\">\n");
      out.write("\t\t\t<div class=\"list-group-item\">\n");
      out.write("\t\t\t\t<ul class=\"nav nav-equal-height nav-stacked\">\n");
      out.write("\n");
      out.write("\t\t\t\t\t");
...
if (
 layout.isTypePortlet() ) {
      ...
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t<li class=\"lfr-content-item\" role=\"presentation\">\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      //  aui:icon
      ...
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"javascript:;\" class='add-content-item ");
      ...
      out.write("\t\t\t\t\t\t\t\t");
if (
 ListUtil.isNotEmpty(portletItems) ) {
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t<ul class=\"nav nav-equal-height nav-stacked\">\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<li class=\"lfr-archived-setup lfr-content-item\" role=\"presentation\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      //  aui:icon
