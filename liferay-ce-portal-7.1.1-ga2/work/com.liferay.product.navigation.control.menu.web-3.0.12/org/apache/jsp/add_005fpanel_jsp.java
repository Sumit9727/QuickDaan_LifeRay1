...
if (
 layout != null ) {
      ...
      out.write("\t\t\t");
if (
 !group.isControlPanel() && (hasLayoutUpdatePermission || (layoutTypePortlet.isCustomizable() && layoutTypePortlet.isCustomizedView() && hasLayoutCustomizePermission)) ) {
      out.write("\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t\t\t<div aria-multiselectable=\"true\" class=\"panel-group\" id=\"");
      if (_jspx_meth_portlet_namespace_1(_jspx_page_context))
        return;
      out.write("Accordion\" role=\"tablist\">\n");
      out.write("\t\t\t\t\t\t");
if (
 hasAddApplicationsPermission ) {
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<div class=\"add-application-panel panel\">\n");
...
if (
 hasAddContentPermission ) {
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<div class=\"add-content-panel panel\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"panel-header panel-heading\" id=\"");
      ...
      out.write("\t\t\t\t\t\t");
if (
 hasAddApplicationsPermission && hasAddContentPermission ) {
      out.write("\n");
      out.write("\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\t\t\t\t\t\t\t\tLiferay.Store('com.liferay.product.navigation.control.menu.web_addPanelTab', event.target.getAttribute('data-value'));\n");
        out.write("\t\t\t\t\t\t\t\t\t}\n");
        out.write("\t\t\t\t\t\t\t\t);\n");
        out.write("\t\t\t\t\t\t\t");
