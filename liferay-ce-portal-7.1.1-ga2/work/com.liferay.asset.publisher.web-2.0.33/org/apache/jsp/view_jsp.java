...
private static Log _log = LogFactoryUtil.getLog("com_liferay_asset_publisher_web.view_jsp");
  ...
  static {
    ...
    _jspx_dependants.add("/META-INF/liferay-site.tld");
...
if (
 !portletName.equals(AssetPublisherPortletKeys.HIGHEST_RATED_ASSETS) && !portletName.equals(AssetPublisherPortletKeys.MOST_VIEWED_ASSETS) && !portletName.equals(AssetPublisherPortletKeys.RECENT_CONTENT) && !portletName.equals(AssetPublisherPortletKeys.RELATED_ASSETS) && PortletPermissionUtil.contains(permissionChecker, 0, layout, portletDisplay.getId(), ActionKeys.SUBSCRIBE, false, false) && assetPublisherWebUtil.getEmailAssetEntryAddedEnabled(portletPreferences) ) {
      ...
      out.write("\t\t\t");
if (
 assetPublisherWebUtil.isSubscribed(themeDisplay.getCompanyId(), user.getUserId(), themeDisplay.getPlid(), portletDisplay.getId()) ) {
      out.write("\n");
      out.write("\t\t\t\t");
      //  portlet:actionURL
...
if (
 enableRSS ) {
      ...
      _jspx_th_liferay$1rss_rss_0.setParent(null);
...
request.setAttribute("view.jsp-viewInContext", assetPublisherDisplayContext.isAssetLinkBehaviorViewInPortlet());
      ...
      out.write('	');
if (
 assetPublisherDisplayContext.isSelectionStyleDynamic() ) {
      out.write("\n");
      out.write("\t\t");
      out.write('\n');
      out.write('\n');
...
if (
 assetEntryResults.isEmpty() ) {
      ...
      _jspx_th_liferay$1ddm_template$1renderer_1.setParent(null);
      ...
      if (_jspx_eval_liferay$1ddm_template$1renderer_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\t\t");
if (
 MapUtil.isEmpty(scopeAssetPublisherAddItemHolders) && !((assetCategoryId > 0) || Validator.isNotNull(assetTagName)) ) {
        out.write("\n");
        out.write("\n");
        out.write("\t\t\t");
...
if (
 !portletName.equals(AssetPublisherPortletKeys.RELATED_ASSETS) ) {
        out.write("\n");
        out.write("\t\t\t\t\t");
        if (_jspx_meth_liferay$1ui_message_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1ddm_template$1renderer_1, _jspx_page_context))
          return;
        out.write("\n");
        out.write("\t\t\t\t");
        out.write("\n");
        ...
        out.write("\n");
        out.write("\t\t\t\t\t");
        if (_jspx_meth_liferay$1ui_message_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1ddm_template$1renderer_1, _jspx_page_context))
          return;
        out.write("\n");
        out.write("\t\t\t\t");
        out.write("\n");
...
if (
 !assetEntries.isEmpty() ) {
      ...
      _jspx_th_liferay$1ddm_template$1renderer_2.setParent(null);
...
if (!ArrayUtil.contains(assetPublisherPortletInstanceConfiguration.displayStyles(), assetPublisherDisplayContext.getDisplayStyle())) {
	...
	for (String curDisplayStyle : assetPublisherPortletInstanceConfiguration.displayStyles()) {
      ...
      _jspx_th_liferay$1ddm_template$1renderer_3.setParent(null);
      ...
      if (_jspx_eval_liferay$1ddm_template$1renderer_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\t\t\t");
if (
 MapUtil.isEmpty(scopeAssetPublisherAddItemHolders) ) {
        out.write("\n");
        out.write("\n");
        out.write("\t\t\t\t");
...
if (
 !portletName.equals(AssetPublisherPortletKeys.RELATED_ASSETS) ) {
        out.write("\n");
        out.write("\t\t\t\t\t\t");
        if (_jspx_meth_liferay$1ui_message_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1ddm_template$1renderer_3, _jspx_page_context))
          return;
        out.write("\n");
        out.write("\t\t\t\t\t");
        out.write("\n");
        ...
        out.write("\n");
        out.write("\t\t\t\t\t\t");
        if (_jspx_meth_liferay$1ui_message_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1ddm_template$1renderer_3, _jspx_page_context))
          return;
        out.write("\n");
        out.write("\t\t\t\t\t");
        out.write("\n");
      ...
      out.write('\n');
if (
 !assetPublisherDisplayContext.isPaginationTypeNone() && (searchContainer.getTotal() > searchContainer.getResults().size()) ) {
      out.write('\n');
      out.write('	');
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1ddm_template$1renderer_1, PageContext _jspx_page_context)
          throws Throwable {
    ...
    _jspx_th_liferay$1ui_message_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ddm_template$1renderer_1);
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1ddm_template$1renderer_1, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ddm_template$1renderer_1);
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1ddm_template$1renderer_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ddm_template$1renderer_3);
  ...
  private boolean _jspx_meth_liferay$1ui_message_3(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1ddm_template$1renderer_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ddm_template$1renderer_3);
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\n");
        out.write("\tvar queryString = window.location.search.substring(1);\n");
        out.write("\n");
        out.write("\tvar queryParamObj = new A.QueryString.parse(queryString);\n");
        out.write("\n");
        out.write("\tvar assetEntryId = queryParamObj['");
