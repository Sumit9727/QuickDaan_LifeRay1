            ...
            if (_jspx_eval_aui_col_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              if (_jspx_eval_liferay$1frontend_fieldset$1group_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                if (_jspx_eval_liferay$1frontend_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  out.write("\t\t\t\t\t\t\t");
if (
 SiteNavigationMenuLocalServiceUtil.getSiteNavigationMenusCount(scopeGroupId) > 0 ) {
                  out.write("\n");
                  out.write("\t\t\t\t\t\t\t\t<div>\n");
                  out.write("\t\t\t\t\t\t\t\t\t");
                  //  aui:input
                  ...
                  out.write("\t\t\t\t\t\t\t\t\t\t\t");
if (
 siteNavigationMenuDisplayContext.getSiteNavigationMenuId() > 0 ) {
                  out.write("\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
                  ...
                  out.write("\n");
                  out.write("\t\t\t\t\t\t\t\t<div class=\"card card-horizontal taglib-horizontal-card\">\n");
                  out.write("\t\t\t\t\t\t\t\t\t<div class=\"card-row card-row-padded \">\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"card-col-field\">\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"sticker sticker-secondary sticker-static\">\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
                  if (_jspx_meth_aui_icon_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1frontend_fieldset_0, _jspx_page_context))
                    return;
                  out.write("\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
                  out.write("\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"card-col-content card-col-gutters\">\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t\t<span class=\"lfr-card-title-text truncate-text\" id=\"");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_portlet_namespace_9((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("resetPreview() {\n");
          out.write("\t\tvar selectDisplayDepth = form.fm('displayDepth');\n");
          out.write("\t\tvar selectDisplayStyle = form.fm('displayStyle');\n");
          out.write("\t\tvar selectExpandedLevels = form.fm('expandedLevels');\n");
          out.write("\t\tvar selectRootMenuItemLevel = form.fm('rootMenuItemLevel');\n");
          out.write("\t\tvar selectRootMenuItemType = form.fm('rootMenuItemType');\n");
          out.write("\t\tvar selectRootMenuItemId = form.fm('rootMenuItemId');\n");
          out.write("\t\tvar selectSiteNavigationMenuId = form.fm('siteNavigationMenuId');\n");
          out.write("\t\tvar selectSiteNavigationMenuType = form.fm('siteNavigationMenuType');\n");
          out.write("\n");
          out.write("\t\tvar data = {\n");
          out.write("\t\t\tdisplayStyle: selectDisplayStyle.val(),\n");
          out.write("\t\t\tpreview: true\n");
          out.write("\t\t};\n");
          out.write("\n");
          out.write("\t\tdata.displayDepth = selectDisplayDepth.val();\n");
          out.write("\t\tdata.expandedLevels = selectExpandedLevels.val();\n");
          out.write("\t\tdata.rootMenuItemLevel = selectRootMenuItemLevel.val();\n");
          out.write("\t\tdata.rootMenuItemType = selectRootMenuItemType.val();\n");
          out.write("\t\tdata.rootMenuItemId = selectRootMenuItemId.val();\n");
          out.write("\t\tdata.siteNavigationMenuId = selectSiteNavigationMenuId.val();\n");
          out.write("\t\tdata.siteNavigationMenuType = selectSiteNavigationMenuType.val();\n");
          out.write("\n");
          out.write("\t\tdata = Liferay.Util.ns('_");
          out.print( HtmlUtil.escapeJS(portletResource) );
          out.write("_', data);\n");
          out.write("\n");
          out.write("\t\tLiferay.Portlet.refresh(curPortletBoundaryId, data);\n");
          out.write("\t}\n");
          out.write("\n");
          out.write("\tvar chooseRootMenuItem = $('#");
          ...
          out.write("\n");
          out.write("\tchooseRootMenuItem.on(\n");
          out.write("\t\t'click',\n");
          out.write("\t\tfunction(event) {\n");
          out.write("\t\t\tevent.preventDefault();\n");
          out.write("\n");
          out.write("\t\t\tvar siteNavigationMenuId = $('#");
          ...
          out.write("'\n");
          out.write("\t\t\t\t},\n");
          out.write("\t\t\t\tfunction(selectedItem) {\n");
          out.write("\t\t\t\t\tif (selectedItem.id) {\n");
          out.write("\t\t\t\t\t\t$('#");
          ...
          out.write("\t\tfunction(currentValue, value) {\n");
          ...
          out.write("\t);\n");
          out.write("\n");
          out.write("\tvar selectSiteNavigationMenuType = $('#");
          ...
          out.write("\n");
          out.write("\tselectSiteNavigationMenuType.on(\n");
          out.write("\t\t'change',\n");
          out.write("\t\tfunction() {\n");
          out.write("\t\t\tvar siteNavigationMenuType = $('#");
          ...
          out.write("\n");
          out.write("\t\t\tsiteNavigationMenuType.val(selectSiteNavigationMenuType.val());\n");
          out.write("\t\t}\n");
          out.write("\t);\n");
          out.write("\n");
          out.write("\t$('.select-navigation').on(\n");
          out.write("\t\t'change',\n");
          out.write("\t\tfunction() {\n");
          out.write("\t\t\tvar chooseSiteNavigationMenu = $('#");
          ...
          out.write("\n");
          out.write("\t\t\tvar state = selectSiteNavigationMenuType.prop('disabled');\n");
          out.write("\n");
          out.write("\t\t\tchooseSiteNavigationMenu.prop('disabled', state);\n");
          out.write("\t\t\tchooseSiteNavigationMenu.toggleClass('disabled', state);\n");
          out.write("\n");
          out.write("\t\t\tselectSiteNavigationMenuType.prop('disabled', !state);\n");
          out.write("\n");
          out.write("\t\t\t$('#");
  ...
  private boolean _jspx_meth_aui_icon_1(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1frontend_fieldset_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  aui:icon
    ...
    _jspx_th_aui_icon_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_fieldset_0);
