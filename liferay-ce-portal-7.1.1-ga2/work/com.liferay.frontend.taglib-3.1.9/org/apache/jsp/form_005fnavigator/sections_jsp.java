...
if (
 Validator.isNotNull(focusField) ) {
            out.write("\n");
            out.write("\t\t\t\t\tfocusField = sectionContent.find('#");
            ...
            out.write("\n");
            out.write("\t\t\t\t\tfocusField = sectionContent.find('input:not([type=\"hidden\"]).field').first();\n");
            out.write("\t\t\t\t");
            out.write("\n");
            out.write("\t\t\t");
}
            ...
            out.write("\t\t\t\t\tvar hasFocusField = focusField.length;\n");
            out.write("\n");
            out.write("\t\t\t\t\tif (!sectionContent.hasClass('in')) {\n");
            out.write("\t\t\t\t\t\tif (hasFocusField) {\n");
            out.write("\t\t\t\t\t\t\tsectionContent.one(\n");
            ...
            out.write("\t\t\t\t\t\t}\n");
            out.write("\n");
            out.write("\t\t\t\t\t\tsectionContent.collapse('show');\n");
            out.write("\t\t\t\t\t}\n");
            out.write("\t\t\t\t\telse if (hasFocusField) {\n");
            out.write("\t\t\t\t\t\tLiferay.Util.focusFormField(focusField);\n");
            out.write("\t\t\t\t\t}\n");
            out.write("\t\t\t\t}\n");
            out.write("\t\t\t);\n");
