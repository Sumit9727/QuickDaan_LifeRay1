 ...
 showButtons ) {
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\t\tvar dom = metalDomSrcDom.default;\n");
          out.write("\t\t\tvar uri = metalUriSrcUri.default;\n");
          out.write("\n");
          out.write("\t\t\tvar redirectField = dom.toElement('input[name=\"");
          ...
          out.write("\t\t\t\tvar redirectURL = new uri(redirectField.value);\n");
          out.write("\n");
          out.write("\t\t\t\tredirectURL.setParameterValue(tabs1Param, event.id);\n");
          out.write("\n");
          ...
          out.write("\t\t\t\tvar currentURL = new uri(document.location.href);\n");
          out.write("\n");
          out.write("\t\t\t\tvar tabs1Value = currentURL.getParameterValue(tabs1Param);\n");
          out.write("\n");
