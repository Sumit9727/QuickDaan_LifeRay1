...
boolean fixed = GetterUtil.getBoolean(request.getAttribute("liferay-frontend:info-bar:fixed"));
      ...
      out.write("\t\t\t");
if (
 Validator.isNotNull(buttons) ) {
      out.write("\n");
      out.write("\t\t\t\t<div class=\"management-bar-header-right\">\n");
      out.write("\t\t\t\t\t");
      out.print( buttons );
      out.write("\n");
      out.write("\t\t\t\t</div>\n");
 ...
 fixed ) {
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\n");
        out.write("\t\tnew metalAffixSrcAffix.default(\n");
        out.write("\t\t\t{\n");
        out.write("\t\t\t\telement: '.info-bar-container',\n");
        out.write("\t\t\t\toffsetTop: 15\n");
        out.write("\t\t\t}\n");
        out.write("\t\t);\n");
        out.write("\t");
