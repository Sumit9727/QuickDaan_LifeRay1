...
boolean ldapExportEnabled = !(ldapImportConfiguration.importUserPasswordAutogenerated() && ldapImportEnabled) && ldapExportConfiguration.exportEnabled();
      ...
      out.write("\n");
if (
 ldapAuthEnabled && ldapServerConfigurations.isEmpty() ) {
      out.write("\n");
	...
	addServerURL.setParameter("redirect", authenticationURL);
      ...
      if (_jspx_eval_aui_fieldset_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\t");
if (
 !ldapServerConfigurations.isEmpty() ) {
        out.write("\n");
        out.write("\t\t<br /><br />\n");
        out.write("\n");
        out.write("\t\t<div class=\"ldap-servers searchcontainer-content\">\n");
        ...
        out.write("\t\t\t\t\t\t<th class=\"table-header\">\n");
        out.write("\t\t\t\t\t\t\t");
        if (_jspx_meth_liferay$1ui_message_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_fieldset_1, _jspx_page_context))
          return;
        out.write("\n");
        out.write("\t\t\t\t\t\t</th>\n");
        out.write("\t\t\t\t\t\t<th class=\"table-header\"></th>\n");
        out.write("\t\t\t\t\t</tr>\n");
        out.write("\t\t\t\t</thead>\n");
        out.write("\n");
        ...
        out.write("\t\t\t\t\t\t\t\t\t");
if (
 ldapServerConfigurations.size() > 1 ) {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t\t");
        //  liferay-ui:icon
        ...
        _jspx_th_portlet_renderURL_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_1);
        ...
        _jspx_th_liferay$1ui_icon_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_1);
        ...
        _jspx_th_portlet_actionURL_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_1);
        ...
        _jspx_th_liferay$1ui_icon$1delete_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_1);
...
if (
 ldapImportConfiguration.importUserPasswordAutogenerated() ) {
        ...
        _jspx_th_aui_input_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_2);
 ...
 ldapImportConfiguration.importUserPasswordAutogenerated() ) {
      ...
      if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\tvar ldapServer = AUI.$('.ldap-servers tr[data-ldapServerId=\"' + ldapServerId + '\"]');\n");
          out.write("\n");
          out.write("\t\tvar swapLdapServer = ldapServer[action]();\n");
          out.write("\n");
          out.write("\t\tif (swapLdapServer.length) {\n");
          out.write("\t\t\tldapServer[(action === 'next') ? 'before' : 'after'](swapLdapServer);\n");
          out.write("\t\t}\n");
          out.write("\n");
          out.write("\t\t");
          ...
          out.write("\t\tvar $ = AUI.$;\n");
          out.write("\n");
          out.write("\t\tvar ldapServerIds = $('.ldap-servers .table-data tr').map(\n");
          out.write("\t\t\tfunction(index, item) {\n");
          out.write("\t\t\t\treturn $(item).data('ldapserverid');\n");
          out.write("\t\t\t}\n");
          out.write("\t\t).get();\n");
          out.write("\n");
          out.write("\t\t$(document.");
  ...
  private boolean _jspx_meth_liferay$1ui_message_3(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_fieldset_1, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_1);
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\tvar $ = AUI.$;\n");
        out.write("\n");
        out.write("\t\t\tvar exportCheckbox = $('#");
        if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("ldapExportEnabled');\n");
        out.write("\t\t\tvar importCheckbox = $('#");
        if (_jspx_meth_portlet_namespace_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("ldapImportEnabled');\n");
        out.write("\n");
        out.write("\t\t\texportCheckbox.prop('disabled', importCheckbox.prop('checked'));\n");
        out.write("\t\t}\n");
        out.write("\t");
