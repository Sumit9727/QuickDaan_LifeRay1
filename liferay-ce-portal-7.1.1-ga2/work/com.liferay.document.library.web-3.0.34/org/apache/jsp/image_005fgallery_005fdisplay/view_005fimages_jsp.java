...
if (
 fileEntry != null ) {
            ...
            if (_jspx_eval_liferay$1ui_search$1container$1column$1text_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              do {
                out.write("\n");
                out.write("\t\t\t\t\t<div class=\"image-link preview\" ");
                ...
                out.write("\t\t\t\t\t\t\t");
if (
 Validator.isNull(imagePreviewURL) ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t\t\t");
...
embeddedPlayerURL.setWindowState(LiferayWindowState.POP_UP);
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\n");
          out.write("\tvar maxHeight = (viewportRegion.height);\n");
          out.write("\tvar maxWidth = (viewportRegion.width);\n");
          out.write("\n");
          out.write("\tvar playingMediaIndex = -1;\n");
          out.write("\n");
          out.write("\tvar imageViewer = new A.ImageViewer(\n");
          out.write("\t\t{\n");
          out.write("\t\t\tafter: {\n");
          out.write("\t\t\t\t");
if (
 dlPortletInstanceSettingsHelper.isShowActions() ) {
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\tvar thumbnailId = currentLink.attr('thumbnailId');\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tvar actions = instance._actions;\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tif (actions) {\n");
          out.write("\t\t\t\t\t\t\tvar defaultAction = A.one('#");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\t\tvar action = defaultAction.clone().show();\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\tactions.append(action);\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t");
}
          ...
          out.write("\t\t\ton: {\n");
          out.write("\t\t\t\t'currentIndexChange': function() {\n");
          out.write("\t\t\t\t\tif (playingMediaIndex != -1) {\n");
          out.write("\t\t\t\t\t\tLiferay.fire('");
          if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("ImageViewer:currentIndexChange');\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tplayingMediaIndex = -1;\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t},\n");
          out.write("\t\t\t\t'visibleChange': function(event) {\n");
          out.write("\t\t\t\t\tif (!event.newVal && playingMediaIndex != -1) {\n");
          out.write("\t\t\t\t\t\tLiferay.fire('");
          ...
          out.write("\t\t\t\t{\n");
          out.write("\t\t\t\t\tcfg: {\n");
          out.write("\t\t\t\t\t\t'providers.liferay': {\n");
          out.write("\t\t\t\t\t\t\tcontainer: '<iframe frameborder=\"0\" height=\"{height}\" scrolling=\"no\" src=\"");
          ...
          out.write("\t\t\t\t\t\t\tmatcher: /(.+)&mediaGallery=1/,\n");
          out.write("\t\t\t\t\t\t\tmediaRegex: /(.+)&mediaGallery=1/,\n");
          out.write("\t\t\t\t\t\t\toptions: A.merge(\n");
          out.write("\t\t\t\t\t\t\t\tA.MediaViewerPlugin.DEFAULT_OPTIONS,\n");
          out.write("\t\t\t\t\t\t\t\t{\n");
          out.write("\t\t\t\t\t\t\t\t\t'mp3PreviewURL': '',\n");
          out.write("\t\t\t\t\t\t\t\t\t'mp4PreviewURL': '',\n");
          out.write("\t\t\t\t\t\t\t\t\t'oggPreviewURL': '',\n");
          out.write("\t\t\t\t\t\t\t\t\t'ogvPreviewURL': '',\n");
          out.write("\t\t\t\t\t\t\t\t\t'thumbnailURL': ''\n");
          out.write("\t\t\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t\t\t)\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t},\n");
          out.write("\t\t\t\t\tfn: A.MediaViewerPlugin\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t],\n");
          out.write("\t\t\tzIndex: ++Liferay.zIndex.WINDOW\n");
          out.write("\t\t}\n");
          out.write("\t).render();\n");
          out.write("\n");
          ...
          out.write("\t\tfunction() {\n");
          out.write("\t\t\timageViewer.pause();\n");
          out.write("\n");
          out.write("\t\t\tplayingMediaIndex = this.get('currentIndex');\n");
          out.write("\t\t}\n");
          out.write("\t);\n");
          out.write("\n");
          out.write("\tLiferay.on(\n");
          ...
          out.write("\t);\n");
          out.write("\n");
          out.write("\tvar onClickLinksDefaultFn = imageViewer._onClickLinks;\n");
          out.write("\n");
          out.write("\timageViewer._onClickLinks = function(event) {\n");
          out.write("\t\tif (!event.target.ancestor('.dropdown')) {\n");
          out.write("\t\t\tonClickLinksDefaultFn.call(this, event);\n");
          out.write("\t\t}\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\timageViewer.set('links', '#");
