...
if (
 ...
 articleDisplay != null ) {
      out.write("\n");
      out.write("\t\t\t\t\t\t<div class=\"text-right user-tool-asset-addon-entries\">\n");
      out.write("\t\t\t\t\t\t\t");
...
if (
 (articleDisplay != null) && journalContentDisplayContext.hasViewPermission() ) {
      out.write("\n");
      out.write("\t<div class=\"content-metadata-asset-addon-entries\">\n");
      out.write("\t\t");
      //  liferay-asset:asset-addon-entry-display
      ...
      _jspx_th_liferay$1asset_asset$1addon$1entry$1display_1.setParent(null);
