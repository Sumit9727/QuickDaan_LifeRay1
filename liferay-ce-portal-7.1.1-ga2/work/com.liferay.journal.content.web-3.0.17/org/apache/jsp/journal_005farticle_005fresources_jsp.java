...
if (
 Validator.isNotNull(articleImageURL) ) {
      out.write("\n");
      out.write("\t\t\t\t<img alt=\"thumbnail\" class=\"aspect-ratio-item-center-middle aspect-ratio-item-fluid\" src=\"");
      ...
      out.write("\t\t\t\t\t<svg aria-hidden=\"true\" class=\"lexicon-icon lexicon-icon-web-content\">\n");
      ...
      out.write("\t\t\t\t<div class=\"card-title text-truncate\" title=\"");
      out.print( title );
      out.write("\">\n");
      out.write("\t\t\t\t\t");
      out.print( title );
