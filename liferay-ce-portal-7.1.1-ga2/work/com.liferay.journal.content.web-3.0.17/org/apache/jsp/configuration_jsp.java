...
public final class configuration_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/META-INF/liferay-journal.tld");
...
String redirect = ParamUtil.getString(request, "redirect");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("fm');\n");
          out.write("\n");
          out.write("\tvar articlePreview = A.one('#");
          if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("articlePreview');\n");
          out.write("\n");
          out.write("\tarticlePreview.delegate(\n");
          out.write("\t\t'click',\n");
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\t\tvar baseSelectWebContentURI = '");
          ...
          out.write("\t\t\t\t\t},\n");
          out.write("\t\t\t\t\teventName: 'selectContent',\n");
          out.write("\t\t\t\t\tid: 'selectContent',\n");
          out.write("\t\t\t\t\ttitle: '");
          if (_jspx_meth_liferay$1ui_message_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("',\n");
          out.write("\t\t\t\t\turi: baseSelectWebContentURI.replace(encodeURIComponent('[$ARTICLE_REFERER_ASSET_ENTRY_ID$]'), form.attr('");
          if (_jspx_meth_portlet_namespace_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("assetEntryId').val())\n");
          out.write("\t\t\t\t},\n");
          out.write("\t\t\t\tfunction(event) {\n");
          out.write("\t\t\t\t\tretrieveWebContent(event.assetclasspk);\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t);\n");
          out.write("\t\t},\n");
          out.write("\t\t'.web-content-selector'\n");
          out.write("\t);\n");
          out.write("\n");
          out.write("\tarticlePreview.delegate(\n");
          out.write("\t\t'click',\n");
          ...
          out.write("\t\t\tevent.preventDefault();\n");
          out.write("\n");
          out.write("\t\t\tretrieveWebContent(-1);\n");
          out.write("\t\t},\n");
          out.write("\t\t'.selector-button'\n");
          out.write("\t);\n");
          out.write("\n");
          out.write("\tfunction retrieveWebContent(assetClassPK) {\n");
          out.write("\t\tvar uri = '");
