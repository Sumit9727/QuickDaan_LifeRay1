...
name = HtmlUtil.escapeJS(name);
	...
	contentsLanguageId = LocaleUtil.toLanguageId(contentsLocale);
          ...
          out.write("\n");
          out.write("\t\tvar uiNode = Liferay.Util.getOpener() !== window.self ? document.querySelector('#main-content') : null;\n");
          out.write("\n");
          out.write("\t\teditorConfig = A.merge(\n");
          out.write("\t\t\t{\n");
          out.write("\t\t\t\ttitle: false,\n");
          out.write("\t\t\t\tuiNode: uiNode\n");
          out.write("\t\t\t},\n");
...
if (
 Validator.isNotNull(onInitMethod) ) {
          ...
          out.write("\t\t).render();\n");
          out.write("\n");
          out.write("\t\tCKEDITOR.dom.selection.prototype.selectElement = function(element) {\n");
          out.write("\t\t\tthis.isLocked = 0;\n");
          out.write("\n");
          out.write("\t\t\tvar range = new CKEDITOR.dom.range(this.root);\n");
          out.write("\n");
          out.write("\t\t\trange.setEndAfter(element);\n");
          out.write("\t\t\trange.setStartBefore(element);\n");
          out.write("\n");
          out.write("\t\t\tthis.selectRanges([range]);\n");
          out.write("\t\t};\n");
          out.write("\n");
          out.write("\t\t");
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\tLiferay.namespace('EDITORS').alloyEditor.addInstance();\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\twindow['");
          out.print( name );
          ...
          out.write("'] = null;\n");
          out.write("\n");
          out.write("\t\t\tLiferay.namespace('EDITORS').alloyEditor.removeInstance();\n");
          out.write("\t\t},\n");
          out.write("\n");
