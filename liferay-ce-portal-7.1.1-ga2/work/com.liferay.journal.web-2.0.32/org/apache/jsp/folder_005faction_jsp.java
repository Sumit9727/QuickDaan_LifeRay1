...
if (
 folder != null ) {
          ...
          out.write("\t\t\t");
if (
 JournalFolderPermission.contains(permissionChecker, folder, ActionKeys.UPDATE) ) {
          out.write("\n");
          out.write("\t\t\t\t");
          //  portlet:renderURL
          ...
          out.write("\t\t\t");
if (
 JournalFolderPermission.contains(permissionChecker, folder, ActionKeys.ADD_FOLDER) ) {
          out.write("\n");
          out.write("\t\t\t\t");
          //  portlet:renderURL
          ...
          out.write("\t\t\t");
if (
 workflowEnabled && JournalFolderPermission.contains(permissionChecker, scopeGroupId, JournalFolderConstants.DEFAULT_PARENT_FOLDER_ID, ActionKeys.UPDATE) ) {
          out.write("\n");
          out.write("\t\t\t\t");
          //  portlet:renderURL
          ...
          out.write("\t\t\t");
if (
 JournalPermission.contains(permissionChecker, scopeGroupId, ActionKeys.ADD_FOLDER) ) {
          out.write("\n");
          out.write("\t\t\t\t");
          //  portlet:renderURL
          ...
          _jspx_th_portlet_renderURL_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1menu_0);
...
if (
 hasPermissionsPermission ) {
          ...
          out.write("\t");
if (
 (folder != null) && JournalFolderPermission.contains(permissionChecker, folder, ActionKeys.DELETE) ) {
          out.write("\n");
          out.write("\n");
          out.write("\t\t");
	...
	Group group = themeDisplay.getScopeGroup();
          ...
          out.write("\t");
if (
 journalDisplayContext.isShowPublishFolderAction(folder) && !group.isLayout() ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
