...
DDMTemplate ddmTemplate = (DDMTemplate)request.getAttribute("edit_article.jsp-template");
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"article-structure\">\n");
      out.write("\t");
      ...
      out.write("\t\t\t");
if (
 DDMStructurePermission.contains(permissionChecker, ddmStructure, ActionKeys.UPDATE) ) {
      out.write("\n");
      out.write("\t\t\t\t");
      //  aui:a
...
if (
 classNameId == JournalArticleConstants.CLASSNAME_ID_DEFAULT ) {
      ...
      out.write("</div>\n");
      out.write("\n");
      out.write("<div class=\"article-template\">\n");
      out.write("\t");
      ...
      out.write("\t\t");
if (
 (ddmTemplate != null) && ddmTemplate.isSmallImage() ) {
      out.write("\n");
 ...
 (ddmTemplate != null) && DDMTemplatePermission.contains(permissionChecker, ddmTemplate, ActionKeys.UPDATE) ) {
	...
	if (!searchRestriction) {
		...
		searchRestriction = folderId != JournalFolderConstants.DEFAULT_PARENT_FOLDER_ID;
          ...
          out.write("\t\t\t\t\t\tddmStructureId = document.");
          ...
          out.write("\t\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\t\tif (ddmStructureId != event.ddmstructureid) {\n");
          ...
          out.write("\t\t\t\t\t\tddmTemplateId = document.");
          ...
          out.write("\t\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\t\tif (ddmTemplateId != event.ddmtemplateid) {\n");
          out.write("\t\t\t\t\t\tif (confirm('");
