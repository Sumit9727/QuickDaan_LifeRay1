...
if (
 group.isLayout() ) {
      ...
      if (_jspx_eval_liferay$1frontend_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\t\t\t\t\t\t\t");
if (
 Validator.isNull(editArticleDisplayPageDisplayContext.getDisplayPageName()) ) {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t<span class=\"text-muted\">");
        if (_jspx_meth_liferay$1ui_message_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1frontend_fieldset_0, _jspx_page_context))
          return;
        out.write("</span>\n");
        out.write("\t\t\t\t\t\t\t");
        out.write("\n");
        ...
        out.write("\t\t\t\t");
if (
 editArticleDisplayPageDisplayContext.isURLViewInContext() ) {
        out.write("\n");
        out.write("\n");
        out.write("\t\t\t\t\t");
        ...
        _jspx_th_aui_a_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_fieldset_0);
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t\t\tvar assetDisplayPageIdInput = $('#");
          if (_jspx_meth_portlet_namespace_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("assetDisplayPageIdInput');\n");
          out.write("\t\t\tvar displayPageContainer = $('#");
          if (_jspx_meth_portlet_namespace_4((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("displayPageContainer');\n");
          out.write("\t\t\tvar displayPageItemContainer = $('#");
          if (_jspx_meth_portlet_namespace_5((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("displayPageItemContainer');\n");
          out.write("\t\t\tvar displayPageItemRemove = $('#");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\tassetDisplayPageIdInput.val('');\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\tpagesContainerInput.val('');\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\tif (selectedItem) {\n");
          out.write("\t\t\t\t\t\t\t\t\t\tif (selectedItem.type === \"asset-display-page\") {\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\tassetDisplayPageIdInput.val(selectedItem.id);\n");
          out.write("\t\t\t\t\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t\t\t\t\t\telse {\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\tpagesContainerInput.val(selectedItem.id);\n");
          out.write("\t\t\t\t\t\t\t\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\t\tdisplayPageNameInput.html(selectedItem.name);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t\t\tdisplayPageItemRemove.removeClass('hide');\n");
          out.write("\t\t\t\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t\t\t},\n");
          ...
          out.write("\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\tdisplayPageItemRemove.on(\n");
          out.write("\t\t\t\t'click',\n");
          out.write("\t\t\t\tfunction(event) {\n");
          out.write("\t\t\t\t\tdisplayPageNameInput.html('");
          ...
          out.write("\t\t\t\t\tpagesContainerInput.val('');\n");
          out.write("\n");
          out.write("\t\t\t\t\tdisplayPageItemRemove.addClass('hide');\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\t$('#");
          ...
          out.write("\n");
          out.write("\t\t\t\t\tif (target && target.value === '");
          out.print( AssetDisplayPageConstants.TYPE_SPECIFIC );
          out.write("') {\n");
          out.write("\t\t\t\t\t\tdisplayPageContainer.removeClass('hide');\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t\telse {\n");
          out.write("\t\t\t\t\t\tdisplayPageContainer.addClass('hide');\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t);\n");
          out.write("\t\t");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1frontend_fieldset_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_fieldset_0);
