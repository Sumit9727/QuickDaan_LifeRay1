...
if (
 JournalArticlePermission.contains(permissionChecker, article, ActionKeys.UPDATE) ) {
          ...
          out.write("\t\t");
if (
 JournalArticlePermission.contains(permissionChecker, article, ActionKeys.SUBSCRIBE) ) {
          out.write("\n");
          out.write("\t\t\t");
          out.write("\n");
          out.write("\t\t\t\t");
if (
 JournalUtil.isSubscribedToArticle(article.getCompanyId(), scopeGroupId, themeDisplay.getUserId(), article.getResourcePrimKey()) ) {
          out.write("\n");
          out.write("\t\t\t\t\t");
          //  portlet:actionURL
          ...
          out.write("\t\t");
if (
 JournalFolderPermission.contains(permissionChecker, scopeGroupId, article.getFolderId(), ActionKeys.ADD_ARTICLE) ) {
          out.write("\n");
          out.write("\t\t\t");
          out.write("\n");
          out.write("\t\t\t\t");
if (
 journalWebConfiguration.journalArticleForceAutogenerateId() ) {
          out.write("\n");
          out.write("\t\t\t\t\t");
          //  portlet:actionURL
          ...
          _jspx_th_liferay$1ui_icon_7.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1menu_0);
          ...
          _jspx_th_portlet_renderURL_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1menu_0);
          ...
          _jspx_th_liferay$1ui_icon_8.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1menu_0);
          ...
          out.write("\t");
if (
 JournalArticlePermission.contains(permissionChecker, article, ActionKeys.EXPIRE) && article.hasApprovedVersion() ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
          ...
          _jspx_th_liferay$1ui_icon_9.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1menu_0);
          ...
          out.write("\t");
if (
 JournalArticlePermission.contains(permissionChecker, article, ActionKeys.DELETE) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
          ...
          _jspx_th_portlet_actionURL_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1menu_0);
	...
	Group group = themeDisplay.getScopeGroup();
          ...
          out.write("\t");
if (
 journalDisplayContext.isShowPublishArticleAction(article) && !group.isLayout() ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
          ...
          _jspx_th_portlet_actionURL_5.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1menu_0);
