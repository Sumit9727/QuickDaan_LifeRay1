...
public final class view_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    _jspx_dependants = new java.util.ArrayList<String>(17);
...
if (Validator.isNotNull(title)) {
	renderResponse.setTitle(journalDisplayContext.getFolderTitle());
      ...
      out.write("\t<div class=\"closed container-fluid-1280 sidenav-container sidenav-right\" id=\"");
...
if (
 !journalDisplayContext.isNavigationMine() && !journalDisplayContext.isNavigationRecent() ) {
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\t\t\t\t\t\t");
if (
 !journalDisplayContext.isSearch() || (!journalDisplayContext.hasResults() && !journalDisplayContext.hasCommentsResults() && !journalDisplayContext.hasVersionsResults()) ) {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t");
        //  liferay-util:include
        ...
        out.write("\t\t\t\t\t\t\t\t");
if (
 Objects.equals(journalDisplayContext.getTabs1(), "web-content") || (journalDisplayContext.hasResults() && Validator.isNull(journalDisplayContext.getTabs1())) ) {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t");
        //  liferay-util:include
 ...
 Objects.equals(journalDisplayContext.getTabs1(), "versions") || (journalDisplayContext.hasVersionsResults() && Validator.isNull(journalDisplayContext.getTabs1())) ) {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t");
        //  liferay-util:include
 ...
 Objects.equals(journalDisplayContext.getTabs1(), "comments") || (journalDisplayContext.hasCommentsResults() && Validator.isNull(journalDisplayContext.getTabs1())) ) {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t");
        //  liferay-util:include
        ...
        _jspx_th_liferay$1util_include_6.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_form_0);
        ...
        _jspx_th_liferay$1util_include_7.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_form_0);
