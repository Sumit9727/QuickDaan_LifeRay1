...
renderResponse.setTitle((formInstance == null) ? LanguageUtil.get(request, "new-form") : LanguageUtil.get(request, "edit-form"));
      ...
      out.write("\n");
      out.write("\n");
      out.write("\t<nav class=\"management-bar management-bar-light navbar navbar-expand-md toolbar-group-field\">\n");
      out.write("\t\t<div class=\"autosave-bar container toolbar\">\n");
      out.write("\t\t\t<div class=\"navbar-form navbar-form-autofit navbar-overlay toolbar-group-content\">\n");
      ...
      out.write("\t\t\t\t\t<button class=\"btn btn-secondary nav-btn nav-btn-monospaced publish-icon ");
      ...
      out.write("\t\t\t\t</li>\n");
      out.write("\t\t\t\t<li class=\"nav-item\">\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-primary lfr-ddm-add-field lfr-ddm-plus-button nav-btn nav-btn-monospaced\">\n");
      out.write("\t\t\t\t\t\t<svg class=\"lexicon-icon\">\n");
      out.write("\t\t\t\t\t\t\t<use xlink:href=\"");
      out.print( ddmFormAdminDisplayContext.getLexiconIconsPath() );
      out.write("plus\" />\n");
