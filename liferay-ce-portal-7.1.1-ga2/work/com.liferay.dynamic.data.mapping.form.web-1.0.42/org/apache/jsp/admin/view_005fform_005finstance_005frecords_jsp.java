...
boolean showCSVWarning = StringUtil.equals("enabled-with-warning", csvExport);
      ...
      if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\t\t\t\t\t\theader: [\n");
          out.write("\t\t\t\t\t\t\t\t{\n");
          out.write("\t\t\t\t\t\t\t\t\tcssClass: 'close',\n");
          out.write("\t\t\t\t\t\t\t\t\tdiscardDefaultButtonCssClasses: true,\n");
          out.write("\t\t\t\t\t\t\t\t\tlabelHTML: Liferay.Util.getLexiconIconTpl('times'),\n");
          out.write("\t\t\t\t\t\t\t\t\ton: {\n");
          out.write("\t\t\t\t\t\t\t\t\t\tclick: function() {\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\tdialog.hide();\n");
          out.write("\t\t\t\t\t\t\t\t\t\t}\n");
      ...
      if (_jspx_eval_aui_script_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar deleteRecords = function() {\n");
          ...
          out.write("\t\t'deleteRecords': deleteRecords\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tLiferay.componentReady('ddmFormInstanceRecordsManagementToolbar').then(\n");
