...
FormInstancePermissionCheckerHelper formInstancePermissionCheckerHelper = ddmFormAdminDisplayContext.getPermissionCheckerHelper();
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write('	');
if (
 formInstancePermissionCheckerHelper.isShowCopyURLIcon(formInstance) && ddmFormAdminDisplayContext.isFormPublished(formInstance) ) {
          out.write("\n");
          out.write("\t\t");
          //  liferay-ui:icon
          ...
          out.write("\t");
if (
 formInstancePermissionCheckerHelper.isShowViewEntriesIcon(formInstance) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
          ...
          out.write("\t");
if (
 formInstancePermissionCheckerHelper.isShowEditIcon(formInstance) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
          ...
          out.write("\t");
if (
 formInstancePermissionCheckerHelper.isShowCopyButton() ) {
          out.write("\n");
          out.write("\t\t");
          ...
          out.write("\t");
if (
 formInstancePermissionCheckerHelper.isShowExportIcon(formInstance) ) {
          out.write("\n");
          out.write("\t\t");
		...
		sb.append("');");
          ...
          out.write("\t");
if (
 formInstancePermissionCheckerHelper.isShowPermissionsIcon(formInstance) ) {
          out.write("\n");
          out.write("\t\t");
          ...
          out.write("\t");
if (
 formInstancePermissionCheckerHelper.isShowDeleteIcon(formInstance) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
