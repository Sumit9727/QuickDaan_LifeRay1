...
String modelResource = (String)row.getParameter("modelResource");
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write('	');
if (
 ExpandoColumnPermissionUtil.contains(permissionChecker, expandoColumn, ActionKeys.UPDATE) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
          ...
          out.write("\t");
if (
 ExpandoColumnPermissionUtil.contains(permissionChecker, expandoColumn, ActionKeys.PERMISSIONS) ) {
          out.write("\n");
          out.write("\t\t");
          ...
          out.write("\t");
if (
 ExpandoColumnPermissionUtil.contains(permissionChecker, expandoColumn, ActionKeys.DELETE) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
