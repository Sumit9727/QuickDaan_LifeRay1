...
public class CandidateRegistrationCacheModel implements CacheModel<CandidateRegistration>,
	...
	public CandidateRegistration toEntityModel() {
		...
		if (RESUME_TYPE == null) {
			candidateRegistrationImpl.setRESUME_TYPE("");
		}
		else {
			candidateRegistrationImpl.setRESUME_TYPE(RESUME_TYPE);
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		RESUME_TYPE = objectInput.readUTF();
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		if (RESUME_TYPE == null) {
			...
			objectOutput.writeUTF(RESUME_TYPE);
		}
