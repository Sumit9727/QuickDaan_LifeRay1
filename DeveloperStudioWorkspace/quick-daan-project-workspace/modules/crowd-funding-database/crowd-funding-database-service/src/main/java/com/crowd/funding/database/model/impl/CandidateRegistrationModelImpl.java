...
public class CandidateRegistrationModelImpl extends BaseModelImpl<CandidateRegistration>
	...
	public static CandidateRegistration toModel(
		...
		model.setRESUME_TYPE(soapModel.getRESUME_TYPE());
	...
	public Object clone() {
		...
		candidateRegistrationImpl.setRESUME_TYPE(getRESUME_TYPE());
	...
	public CacheModel<CandidateRegistration> toCacheModel() {
		...
		candidateRegistrationCacheModel.RESUME_TYPE = getRESUME_TYPE();

		String RESUME_TYPE = candidateRegistrationCacheModel.RESUME_TYPE;

		if ((RESUME_TYPE != null) && (RESUME_TYPE.length() == 0)) {
			candidateRegistrationCacheModel.RESUME_TYPE = null;
		}
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>RESUME_TYPE</column-name><column-value><![CDATA[");
		sb.append(getRESUME_TYPE());
		sb.append("]]></column-value></column>");
		sb.append(
