...
<portlet:renderURL var="redirectJSPURL" windowState="normal" >
	<portlet:param name="jspPage" value="/jsp/FundRequestWithdraw/ReleaseFundList.jsp" />
</portlet:renderURL>
...
$(document).ready(function() {
    $('#exampleReleaseFund').DataTable();
} );
</script>


<form >
	<table id="exampleReleaseFund" class="display" style="width:100%">
		<thead>
			<tr>
				<th>Project No.</th>
		...
		<tbody>
			...
			%>
				<portlet:renderURL var="ProjectDetailURL" windowState="normal" >
					...
					<portlet:param name="jspPage" value="/jsp/FundRequestWithdraw/AdminReleaseCampaignDetails.jsp" />
				</portlet:renderURL>
				<tr>
					<td><%= counter %></td>
