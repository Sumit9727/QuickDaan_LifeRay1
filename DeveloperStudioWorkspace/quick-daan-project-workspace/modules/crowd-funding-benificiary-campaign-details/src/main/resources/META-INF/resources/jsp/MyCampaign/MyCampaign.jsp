				 ...
				 <th>
				 	<liferay-ui:icon-menu>
					 	...
					 	<% if(projectObj.getSTATUS() == CrowdFundingBenificiaryDetailsPortletKeys.Project_STATUS_2){ 
					 		...
					 		if(projectObj.getREQUEST_STATUS() == CrowdFundingBenificiaryDetailsPortletKeys.Project_REQUESTED_STATUS_0 || projectObj.getREQUEST_STATUS() == CrowdFundingBenificiaryDetailsPortletKeys.Project_REQUESTED_STATUS_2 || projectObj.getREQUEST_STATUS() == CrowdFundingBenificiaryDetailsPortletKeys.Project_REQUESTED_STATUS_3 || projectObj.getREQUEST_STATUS() == CrowdFundingBenificiaryDetailsPortletKeys.Project_REQUESTED_STATUS_6){ %>
