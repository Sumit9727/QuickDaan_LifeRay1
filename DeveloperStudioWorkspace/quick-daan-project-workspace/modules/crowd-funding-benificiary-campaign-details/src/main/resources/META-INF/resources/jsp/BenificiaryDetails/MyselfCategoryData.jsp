...
<form action="${BenificiaryRelationURL}" method="post" enctype="multipart/form-data">
	...
	<div style=" margin-left:202px; margin-top:-139px;">
		<aui:input  name="image" type="file" accept="image/*" label="Display Photo  "  style="margin-right: -9px;">
	...
	<aui:input cssClass="borderForm" name="name:" label="Benificiary Name  "  readonly="true"  value="<%= userData.getFULL_NAME() %>"><aui:validator name="required" /></aui:input>
	...
	<aui:input name="yearsData" value="Month" type="radio" label="Month" checked="true"></aui:input>
	<aui:input name="yearsData" value="Year" type="radio" label="Year"></aui:input>
	
	<strong>If your age is less than 1 : </strong>
	<label class="switch1">
	...
	<aui:input  cssClass="borderForm" name="Gender" label="Benificiary Gender  "  readonly="true" value="<%= userData.getGENDER() %>" ></aui:input>
	...
	<div style="margin-left: 235px;"><aui:button type="submit"style="background-color:#0077A2;color:white;border-radius: 100px;width: 100px;" value="Next" />
