...
/**
 * The persistence utility for the student details service. This utility wraps {@link com.external.database.connection.demo.service.persistence.impl.StudentDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class StudentDetailsUtil {
	...
	*/
	public static void cacheResult(StudentDetails studentDetails) {
	...
	*/
	public static void cacheResult(List<StudentDetails> studentDetailses) {
	...
	*/
	public static StudentDetails create(long studentId) {
	...
	*/
	public static StudentDetails remove(long studentId)
		throws com.external.database.connection.demo.exception.NoSuchStudentDetailsException {
		return getPersistence().remove(studentId);
	}

	public static StudentDetails updateImpl(StudentDetails studentDetails) {
	...
	* @throws NoSuchStudentDetailsException if a student details with the primary key could not be found
	*/
	public static StudentDetails findByPrimaryKey(long studentId)
		throws com.external.database.connection.demo.exception.NoSuchStudentDetailsException {
	...
	*/
	public static StudentDetails fetchByPrimaryKey(long studentId) {
		return getPersistence().fetchByPrimaryKey(studentId);
	}

	public static java.util.Map<java.io.Serializable, StudentDetails> fetchByPrimaryKeys(
	...
	*/
	public static List<StudentDetails> findAll() {
	...
	*/
	public static List<StudentDetails> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<StudentDetailsPersistence, StudentDetailsPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(StudentDetailsPersistence.class);

		ServiceTracker<StudentDetailsPersistence, StudentDetailsPersistence> serviceTracker =
			new ServiceTracker<StudentDetailsPersistence, StudentDetailsPersistence>(bundle.getBundleContext(),
				StudentDetailsPersistence.class, null);
