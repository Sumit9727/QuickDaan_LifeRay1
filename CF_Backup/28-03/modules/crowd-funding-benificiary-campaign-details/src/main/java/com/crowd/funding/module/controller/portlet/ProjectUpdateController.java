				...
				if(projectFeesRegistration != null) {
					for(ProjectFeesRegistration feesObj : projectFeesRegistration) {
						if(feesObj.getEND_AMOUNT() == 0) {
							...
							fundReleaseRegistration.setPROCESSING_FEES(dynamicCategoryDetails.getPROCESSING_FEES());
							fundReleaseRegistration.setPROJECT_FEES(dynamicCategoryDetails.getPROJECT_FEES());
							fundReleaseRegistration.setPAYMENT_GATEWAY_CHARGES(dynamicCategoryDetails.getPAYMENT_GATEWAY_CHARGES());
							fundReleaseRegistration.setOTHER_CHARGES(dynamicCategoryDetails.getOTHER_CHARGES());
						}
					}
				}
