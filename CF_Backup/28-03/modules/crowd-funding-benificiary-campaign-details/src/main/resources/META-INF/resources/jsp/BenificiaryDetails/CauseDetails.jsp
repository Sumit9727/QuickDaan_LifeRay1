...
<div class="inline5"><aui:input name="btn" label="Sanitation and Hygiene" type="radio" value="SanitationAndHygiene" onclick="myFunction()"></aui:input></div>
<br>
...
<br>
<div class="inline7"><aui:input name="btn" label="Children Welfare" type="radio" value="ChildrenWelfare" onclick="myFunction()"></aui:input></div>
<br>
<br>
