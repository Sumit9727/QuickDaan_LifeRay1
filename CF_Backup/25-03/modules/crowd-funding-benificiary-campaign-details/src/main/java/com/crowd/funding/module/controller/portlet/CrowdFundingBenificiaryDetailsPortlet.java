	...
	public void ProjectRegistrationDetails(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		try {
			...
			String documentName;
			 ...
			 DynamicFeesRegistration dynamicFeesCategoryObj = DynamicFeesRegistrationLocalServiceUtil.getDynamicFeesRegistration(101);
			 ...
			 String mailSubject = "Quick Daan - Campaign Registaration";
			    String mailBody = "Dear " + userDetailsObj.getFULL_NAME() + ", \n\nYour campaign for " +
			    		title +" sucessfully posted on Quick Daan portal." +"\n\n\nThank You For Visiting Crowd Funding.";
