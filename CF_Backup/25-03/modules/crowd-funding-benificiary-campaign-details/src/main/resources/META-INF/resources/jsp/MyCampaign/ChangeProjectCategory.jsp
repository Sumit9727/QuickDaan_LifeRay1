	...
	<tr>
	    ...
	    <td>
	    	 <div id="categoryValue" >
			 	<input name="<portlet:namespace/>categoryName" id="<portlet:namespace/>categoryName"/>	
			 	<input name="<portlet:namespace/>processingFees" id="<portlet:namespace/>processingFees"/>	
			 	<input name="<portlet:namespace/>ProjectFees" id="<portlet:namespace/>ProjectFees"/>	
			 	<input name="<portlet:namespace/>gatewayCharges" id="<portlet:namespace/>gatewayCharges"/>	
			 </div>
	    </td>
	  </tr>
