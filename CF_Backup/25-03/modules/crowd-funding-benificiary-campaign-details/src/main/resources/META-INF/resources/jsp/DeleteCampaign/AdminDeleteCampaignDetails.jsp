...
<% if(projectRegistration.getSTATUS()==CrowdFundingBenificiaryDetailsPortletKeys.Project_STATUS_8){ %>
	<aui:button type="delete" value="Delete" onClick="${deleteCampaignURL}" />
<% } %>
